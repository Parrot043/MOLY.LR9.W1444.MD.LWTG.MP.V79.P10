...
#define CC_IRQ_VERSION              0x20150105
#define CC_IRQ_SCHED_WAIT_TIMEOUT   (5 * 1000 * 1000)    //- 5s
...
typedef enum cc_irq_sys_op_e {
    CC_IRQ_SYS_OP_CTRL = 1,
    CC_IRQ_SYS_OP_MSG,
    CC_IRQ_SYS_OP_MISC,
    CC_IRQ_SYS_OP_MAX
} cc_irq_sys_op_t;
...
typedef enum cc_irq_sys_pkt_type_e {
    CC_IRQ_SYS_PKT_TYPE_INIT_HS = 0,
    CC_IRQ_SYS_PKT_TYPE_EXCEP,
    CC_IRQ_SYS_PKT_TYPE_PING,
    CC_IRQ_SYS_PKT_TYPE_PING_ACK,
    CC_IRQ_SYS_PKT_MAX
} cc_irq_sys_pkt_type_t;

typedef enum cc_irq_sys_peer_excep_reason_e {
    /* start of exception */
    CC_IRQ_SYS_PEER_TRIGGER_EXCEP = 0,
    /* start of no response */
    CC_IRQ_SYS_PEER_NO_RESPONSE_TX = 0x101,
    CC_IRQ_SYS_PEER_NO_RESPONSE_SYNC,
    CC_IRQ_SYS_PEER_EXCEP_MAX
} cc_irq_sys_peer_excep_reason_t;
...
extern void cc_sys_comm_init_phase2();
