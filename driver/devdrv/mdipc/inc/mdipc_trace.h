 ...
 * removed!
 * removed!
 * Add CC IRQ User Msg to receive power off notification.
 *
 * removed!
 * removed!
 * CC IRQ Sync Mechanism.
 *
 * removed!
 * removed!
 * Fix build error of modis and CC IRQ rx driver bug.
 *
 ****************************************************************************/
#ifndef __MDIPC_TRACE_H__
#define __MDIPC_TRACE_H__

#if defined(__CC_IRQ_EXIST__) && defined(__MTK_TARGET__)
...
BEGIN_TRACE_MAP(MOD_LISR2HISR_CC_IRQ_MD2MD1_SYS)
    ...
    TRC_MSG(MDIPC_SYS_PING_TX, "[MDIPC] Send Status Ping Log")
    TRC_MSG(MDIPC_SYS_PING_RX, "[MDIPC] Receive Status Ping Log")
    TRC_MSG(MDIPC_SYS_EPOF_SYNC, "[MDIPC] Receive EPOF Sync Packet")    
