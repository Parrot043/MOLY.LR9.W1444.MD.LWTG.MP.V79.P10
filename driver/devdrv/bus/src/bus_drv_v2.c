...
#define MD_GLOBAL_CON2				(volatile kal_uint32 *)(BASE_MADDR_MDCONFIG + 0x0460)
...
{
#if defined(MT6595) || defined(MT6752) || defined(MT6735)
...
void Bus_Init(void)
{
#if defined(MT6752) || defined(MT6595) || defined(MT6735)
...
#if defined(MT6735)
	//this enable sw protect for MDHW
	//Enable bit0 to walkaround ALPS01877802, L1dma hangs in some situation
	//Experiment 3 days is ok after enable this walkaround
	//drawback is all l1dam transaction will be more 1T(bus T) because of this feature (AO domain)
	//[0] : md peri-sys 
	//[1] : modemsys  (md3g2dma)
	//[2] : axi2mcu  
	//[3] : ltel2todma 
