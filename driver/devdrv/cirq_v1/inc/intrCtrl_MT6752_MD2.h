...
#define IRQ_CCIF0_CODE            (9)
#define IRQ_CCIF1_CODE            (10)
#define IRQ_MD_PCCIF0_CODE        (11)
#define IRQ_MD_PCCIF1_CODE        (12)
#define IRQ_MD_PCCIF2_CODE        (13)
#define IRQ_MD_PCCIF3_CODE        (14)
...
#define IRQ36_CODE          IRQ_CCIF0_CODE
#define IRQ37_CODE          IRQ_CCIF1_CODE
#define IRQ38_CODE          IRQ_SW_LISR37_CODE
#define IRQ39_CODE          IRQ_SW_LISR38_CODE
#define IRQ3A_CODE          IRQ_MD_PCCIF0_CODE
#define IRQ3B_CODE          IRQ_MD_PCCIF1_CODE
#define IRQ3C_CODE          IRQ_CTI_CODE
#define IRQ3D_CODE          IRQ_SW_LISR39_CODE
#define IRQ3E_CODE          IRQ_MD_PCCIF2_CODE
#define IRQ3F_CODE          IRQ_MD_PCCIF3_CODE
...
enum Irq_Code_Def_Enum
{
    ...
    Enum_IRQ_AST_DA_CODE  =0x13,    /* CINT_3 */
    Enum_IRQ_CINT_4_CODE  =0x14,
    Enum_IRQ_CINT_5_CODE  =0x15,
    Enum_IRQ_CINT_6_CODE  =0x16,
    Enum_IRQ_CINT_7_CODE  =0x17,
    Enum_IRQ_HIFDMA_CODE  =0x18,    /* HIF_1_CODE */
    Enum_IRQ_TL1_SW_CODE  =0x19,    /* SW_LISR_1 */
    Enum_IRQ_HIF_SW_CODE  =0x1A,    /* SW_LISR_2 */
#else  /* defined(__AST_TL1_TDD__) */
    Enum_IRQ_CINT_0_CODE  =0x10,
    Enum_IRQ_CINT_1_CODE  =0x11,
    Enum_IRQ_CINT_2_CODE  =0x12,
