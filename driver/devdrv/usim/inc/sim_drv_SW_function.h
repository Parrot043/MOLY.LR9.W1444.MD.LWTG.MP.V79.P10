...
{\
kal_uint32 t1 = ust_get_current_time(), t2 = 0;\
while(1)\
{\
t2 = ust_get_current_time();\
if(ust_get_duration(t1, t2)>1) break;\
}\
}\
...
#define SIM_Active()	SIM_SetBits((SIM0_BASE_ADDR_MTK + SIM_CTRL_MTK), 0x0001)
#define SIM_Deactive()	SIM_ClearBits((SIM0_BASE_ADDR_MTK + SIM_CTRL_MTK), 0x0001)
