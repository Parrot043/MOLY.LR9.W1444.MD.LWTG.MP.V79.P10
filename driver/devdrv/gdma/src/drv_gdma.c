...
kal_bool drv_gdma_set_config(gdma_cfg_t *gdmaCfg_p)
{
	...
	switch (gdmaCfg_p->gdma_mod)
	{
		...
		case GDMA_MOD_BASIC:
			...
			DRV_WriteReg32(GDMA_FDCR(chId), ((gdmaCfg_p->gdma_mod_basic_tx_size << 16) | FDMA_BST_BUS(gdmaCfg_p->gdma_bus_width.src_bus_width, gdmaCfg_p->gdma_bus_width.dst_bus_width))); //set tx size and bst/bus width
