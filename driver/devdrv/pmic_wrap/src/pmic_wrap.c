...
#elif defined(DRV_PMIC_WRAP_6752_REG) || defined(DRV_PMIC_WRAP_6735_REG)
#define PMIC_WRAP_TIMEOUT               320 // APB Bus Latency
#endif
...
#if defined(MT6325) || defined(MT6328) || defined(MT6331) || defined(MT6332) || defined(MT6336)
    return (x != 0x03);
#endif
...
kal_uint32 DrvPWRAP_Init(void)
{
...
#if defined(DRV_PMIC_WRAP_6735_REG)
    ...
    //###############################
    PMIC_WRAP_DRV_WriteReg32(INFRA_GLOBALCON_RST0, 0x80); // Write 1 set
    PMIC_WRAP_DRV_WriteReg32(INFRA_GLOBALCON_RST1, 0x80); // Write 1 clr

    //###############################
    // Set SPI_CK_freq = 26MHz
    //###############################
    PMIC_WRAP_DRV_WriteReg32(CLK_CFG_4_CLR, 0x70000); // 26MHz [18:16]
...
#endif // End of #if defined(DRV_PMIC_WRAP_6735_REG)
...
////////////////////////////////////////////////////////////////////////////////
    ...
    // Enable DCM
    //###############################
#if defined(DRV_PMIC_WRAP_6595_REG) || defined(DRV_PMIC_WRAP_6752_REG) || defined(DRV_PMIC_WRAP_6735_REG)
...
#elif  defined(DRV_PMIC_WRAP_6735_REG)
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_HIPRIO_ARB_EN, 0x20); // HIPRIO_ARB enable for each source. (Set WACS2 highest priority)
#else
...
//    sub_return = DrvPWRAP_InitRegClk(PMIC_WRAP_REG_CLOCK_36MHZ); // 0:safe mode, 1:18MHz, 2:36MHz
    ...
    sub_return = DrvPWRAP_InitRegClk(PMIC_WRAP_REG_CLOCK_36MHZ); // 0:safe mode, 1:18MHz, 2:36MHz
#elif defined(DRV_PMIC_WRAP_V2)
#if defined(DRV_PMIC_WRAP_6752_REG) || defined(DRV_PMIC_WRAP_6735_REG)
    // 0:safe mode, 1:18MHz
...
#endif
#if defined(MT6328)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6328_DEW_WRITE_TEST, MT6328_DEW_WRITE_TEST_VALUE, &rdata); // Write Test
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6328_DEW_WRITE_TEST, 0x00, &rdata);
  
    if(rdata != MT6328_DEW_WRITE_TEST_VALUE)  {
        /* TERR="Error: [WriteTest] fail, rdata=%x, exp=0xa55a", rdata*/
        ASSERT(0);        
        return PMIC_WRAP_WRITE_TEST_FAIL;
    }
    ...
    // PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CRC_EN, 0x01); // Enable CRC calculation circuit
#endif // End of #if defined(MT6325) || defined(MT6336)
    ...
    //###############################
    DrvPWRAP_WACS2_NoChk(1, MT6328_DEW_CRC_EN, 0x1, &rdata);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SIG_ADR, MT6328_DEW_CRC_VAL);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_STAUPD_GRPEN, 0x35);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CRC_EN , 0x1);

    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_ADC_CMD_ADDR, MT6328_AUXADC_RQST1_SET);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_PWRAP_ADC_CMD, 0x0100);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR_LATEST, MT6328_AUXADC_ADC32);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR_WP, MT6328_AUXADC_MDBG_1);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR0, MT6328_AUXADC_BUF0);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR1, MT6328_AUXADC_BUF1);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR2, MT6328_AUXADC_BUF2);  
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR3, MT6328_AUXADC_BUF3);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR4, MT6328_AUXADC_BUF4);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR5, MT6328_AUXADC_BUF5);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR6, MT6328_AUXADC_BUF6);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR7, MT6328_AUXADC_BUF7);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR8, MT6328_AUXADC_BUF8);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR9, MT6328_AUXADC_BUF9);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR10, MT6328_AUXADC_BUF10);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR11, MT6328_AUXADC_BUF11);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR12, MT6328_AUXADC_BUF12);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR13, MT6328_AUXADC_BUF13);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR14, MT6328_AUXADC_BUF14);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR15, MT6328_AUXADC_BUF15);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR16, MT6328_AUXADC_BUF16);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR17, MT6328_AUXADC_BUF17);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR18, MT6328_AUXADC_BUF18);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR19, MT6328_AUXADC_BUF19);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR20, MT6328_AUXADC_BUF20);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR21, MT6328_AUXADC_BUF21);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR22, MT6328_AUXADC_BUF22);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR23, MT6328_AUXADC_BUF23);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR24, MT6328_AUXADC_BUF24);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR25, MT6328_AUXADC_BUF25);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR26, MT6328_AUXADC_BUF26);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR27, MT6328_AUXADC_BUF27);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR28, MT6328_AUXADC_BUF28);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR29, MT6328_AUXADC_BUF29);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR30, MT6328_AUXADC_BUF30);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_MD_ADC_RDATA_ADDR31, MT6328_AUXADC_BUF31);
...
#if defined(DRV_PMIC_WRAP_6735_REG)    
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_WDT_SRC_EN, 0xFFFFFBFF); // Watch dog timer source enable. (ALL)
#else
...
#if defined(DRV_PMIC_WRAP_6735_REG)
    // For C2K SW
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_INIT_DONE3, 0x01); // Initialization is finished.
#endif
...
#endif
#if defined(MT6328)    
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6328_DEW_DIO_EN, dio_en, &rdata); // Enable dual I/O mode for SPI slave.
#endif
#if defined(MT6331)    
...
#endif
#if defined(MT6328)    
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6328_DEW_READ_TEST, 0x00, &rdata);
    if(rdata != MT6328_DEW_READ_TEST_VALUE)
    {
        ASSERT(0);        
        /* TERR="Error: [DrvPWRAP_InitDio][Read Test] fail, dio_en = %x, READ_TEST rdata=%x, exp=0x5aa5", dio_en, rdata */
        return PMIC_WRAP_READ_TEST_FAIL;
...
#endif
#if defined(MT6328)
    sub_return = DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6328_DEW_DIO_EN, dio_en & 0x1, &rdata); // Disable / Enable dual I/O mode for SPI slave.
  
    if(sub_return != 0)  {
        /* TERR="Error: [DrvPWRAP_SwitchDio][Set MT6328_DEW_DIO_EN] DrvPWRAP_WACS2 fail, return=%x, exp=0x0", sub_return*/
        ASSERT(0);        
        return PMIC_WRAP_SWITCH_DIO_FAIL;    
    }
#endif
...
#endif
#if defined(MT6328)    
    sub_return = DrvPWRAP_WACS2(PMIC_WRAP_READ, MT6328_DEW_READ_TEST, 0, &rdata);
    if((sub_return != 0) || (rdata != MT6328_DEW_READ_TEST_VALUE)){
        /* TERR="Error: [DrvPWRAP_SwitchDio][Read Test] DrvPWRAP_WACS2() fail, dio_en = %x, return=%x, exp=0, rdata=%x, exp=0x5aa5", dio_en, sub_return, rdata */
        ASSERT(0);        
        return PMIC_WRAP_READ_TEST_FAIL;
    }
...
#endif
#if defined(MT6328)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6328_DEW_CIPHER_SWRST,   0x01,  &rdata); // Enabl CIPHER Soft Reset
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6328_DEW_CIPHER_SWRST,   0x00,  &rdata); // Disble CIPHER Soft Reset
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6328_DEW_CIPHER_KEY_SEL, 0x01,  &rdata); // All keys are hard-wired
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6328_DEW_CIPHER_IV_SEL,  0x02,  &rdata); // Set 0 to choose manual initial vector, otherwise, choose other Hard-wired initial vectors.
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6328_DEW_CIPHER_EN,   0x01,  &rdata); // CIPHER Engine Enable
#endif 
#if defined(MT6331)
...
/* under construction !*/
    ...
    do
    {
        DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6328_DEW_CIPHER_RDY, 0x00, &rdata); // Wait until CIPHER Data Ready (Data should be ready before enable CIPHER_MODE)
        #if 0 // NEED TO CHECK       
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
/* under construction !*/
    ...
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6328_DEW_CIPHER_MODE, 0x01, &rdata); // CIPHER Mode Enable
 #endif
 #if defined(MT6331)
    do
    {
...
#endif
#if defined(MT6328)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6328_DEW_CIPHER_EN, 0x00, &rdata); // CIPHER Engine Disable
#endif
#if defined(MT6331)
...
#endif
#if defined(MT6328)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6328_DEW_CIPHER_MODE, 0x00, &rdata); // CIPHER MODE Disable
#endif  
#if defined(MT6331)
...
{
#if defined(MT6320) || defined(MT6323) || defined(MT6325) || defined(MT6328)
    kal_uint32 arb_en_backup;
    kal_uint32 rdata;
    ...
    {  
        ...
        if(rdata == MT6325_DEW_READ_TEST_VALUE)
#elif defined(MT6328)
        DrvPWRAP_WACS2_NoChk(PMIC_WRAP_READ, MT6328_DEW_READ_TEST, 0, &rdata);
        if(rdata == MT6328_DEW_READ_TEST_VALUE)
#endif
        {
...
kal_uint32 DrvPWRAP_ManAccess(kal_uint32 write, kal_uint32 adr, kal_uint32 wdata, kal_uint32 *rdata )
{
    ...
    if((adr   & ~(0xffff)) != 0)  return PMIC_WRAP_INVALID_ADDR; // Address should no larger than 0xFFFF
    if((wdata & ~(0xffff)) != 0)  return PMIC_WRAP_INVALID_WDATA; // Write DATA should be no larger than 0xFFFF  
#if defined(MT6331) || defined(MT6332) || defined(MT6325) || defined(MT6328)
    ...
    man_wdata = adr >> 1;
    DrvPWRAP_Man(OP_WR,  OP_OUTD, (man_wdata & 0xff), &man_rdata);
#elif defined(MT6331) || defined(MT6332) || defined(MT6325) || defined(MT6328)
    ...
    if(write == PMIC_WRAP_WRITE)
    {
        ...
        man_wdata = wdata >> 8;
        DrvPWRAP_Man(OP_WR,  OP_OUTD, (man_wdata & 0xff), &man_rdata);      
#elif defined(MT6323) || defined(MT6331) || defined(MT6332) || defined(MT6325) || defined(MT6328)
        man_wdata = wdata >> 8;
        DrvPWRAP_Man(OP_WR,  OP_OUTD, (man_wdata & 0xff), &man_rdata);
        man_wdata = wdata;
        DrvPWRAP_Man(OP_WR,  OP_OUTD, (man_wdata & 0xff), &man_rdata);
...
#endif
#if defined(MT6328)
    DrvPWRAP_WACS2(PMIC_WRAP_WRITE, MT6328_DEW_CRC_SWRST, 0x01, &rdata); // Set 1 to reset CRC calculation circuit.
#endif
#if defined(MT6331)
...
//        wdata = rdata & ~(0x8000); // 26Mhz
...
#endif
#if defined(MT6328)
    DrvPWRAP_WACS2_NoChk(PMIC_WRAP_WRITE, MT6328_DEW_RDDMY_NO, 0x08, &rdata);
    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_RDDMY, 0x88);
#endif
...
#if defined(MT6325) || defined(MT6328)
    if(regck_sel == PMIC_WRAP_REG_CLOCK_18MHZ) // 18Mhz
    { 
        PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CSHEXT_READ, 0x0); // Extend CS high time to be at least (1+CSHEXT_READ[3:0])T of SPI CLK  
#if defined(MT6328)        
        PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CSHEXT_WRITE, 0x33); // Extend CS high time to be at least (1+CSHEXT_WRITE[3:0])T of SPI CLK.
#else        
        PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CSHEXT_WRITE, 0x6); // Extend CS high time to be at least (1+CSHEXT_WRITE[3:0])T of SPI CLK.        
#endif        
        PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CSLEXT_START, 0x0); // Extend CS low time after CSL command to be at least (1.5+CSLEXT_START[3:0])T of SPI CLK
    ...
    {
#if defined(MT6328)          
        PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CSHEXT_WRITE, 0xFF); // Extend CS high time to be at least (1+CSHEXT_WRITE[3:0])T of SPI CLK.
        PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CSHEXT_READ, 0xFF); // Extend CS high time to be at least (1+CSHEXT_READ[3:0])T of SPI CLK
#else        
        PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CSHEXT_WRITE, 0x0F); // Extend CS high time to be at least (1+CSHEXT_WRITE[3:0])T of SPI CLK.
        PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_CSHEXT_READ, 0x0F); // Extend CS high time to be at least (1+CSHEXT_READ[3:0])T of SPI CLK
#endif        
...
kal_uint32 DrvPWRAP_Read_Test(kal_bool NoChk)
{
    ...
    {
        DrvPWRAP_WACS2(PMIC_WRAP_READ, MT6328_DEW_READ_TEST, 0x00, &rdata);        
    }
