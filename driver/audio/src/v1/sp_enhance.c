...
#elif defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571) || defined(MT6595) || defined(MT6752) || defined(MT6735)
const unsigned short Speech_Common_Para[12] = 
{ 
...
uint16 spe_table[SPH_MODE_UNDEFINED] = {
   ...
   0, 0, 0, 0, 0, 0, 0, 0, 
#elif defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571) || defined(MT6290) || defined(MT6595) || defined(MT6752) || defined(MT6735)
   #if 1 //TDDNC_SUPPORT
	  	#if defined(__DUAL_MIC_SUPPORT__) || defined(__SMART_PHONE_MODEM__)//in FD216, DMNR's running depends on AP control
		  /* SPH_MODE_NORMAL */    SPE_AEC_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_DMNR_FLAG + SPE_AGC_FLAG + SPH_ENH_MASK_SIDETONE + SPH_ENH_MASK_NOTCH_FILTER,
		#else
      ...
      /* SPH_MODE_LOUDSPK */     SPE_EES_FLAG + SPE_UL_NR_FLAG + SPE_DL_NR_FLAG + SPE_TDDNC_FLAG + SPE_DMNR_FLAG + SPE_AGC_FLAG + SPH_ENH_MASK_NOTCH_FILTER, // TDDNC v.s. DMNR is excluded
      #else
