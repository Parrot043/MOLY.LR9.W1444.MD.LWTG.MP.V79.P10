...
#ifndef _DPRAM_6752_MD2_H_
#define _DPRAM_6752_MD2_H_
...
#define Sph_DL_Cur_Vol                            DP_SPEECH_EXPAND_BASE + 0x003 /* 0x3f60 */
#define SPH_ATTACK_GAIN_DL_NB                     DP_SPEECH_EXPAND_BASE + 0x004 /* 0x3f61 */
#define SPH_RELEASE_GAIN_DL_NB                    DP_SPEECH_EXPAND_BASE + 0x005 /* 0x3f62 */
#define SPH_ATTACK_GAIN_DL_WB                     DP_SPEECH_EXPAND_BASE + 0x006 /* 0x3f63 */
#define SPH_RELEASE_GAIN_DL_WB                    DP_SPEECH_EXPAND_BASE + 0x007 /* 0x3f64 */
...
#define MT6752_MD2_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6752_MD2_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6752_MD2_SHERIF_SIZE)
