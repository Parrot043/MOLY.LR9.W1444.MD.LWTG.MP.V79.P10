...
#ifndef _DPRAM_6290_H_
#define _DPRAM_6290_H_
...
#define SPH_DM_ADDR_BAND_FLAG                     DP_SPEECH_RESERVED_BASE + 0x012 /* 0x3ef1 */
#define SPH_WARN_MSG_UL                           DP_SPEECH_RESERVED_BASE + 0x013 /* 0x3ef2 */
#define SPH_WARN_MSG_DL                           DP_SPEECH_RESERVED_BASE + 0x014 /* 0x3ef3 */
#define SPH_ENH_DYNAMIC_SWITCH                    DP_SPEECH_RESERVED_BASE + 0x015 /* 0x3ef4 */
#define SPH_ENH_DEBUG_ADDR                        DP_SPEECH_RESERVED_BASE + 0x016 /* 0x3ef5 */
#define SPH_EXTCOD_PEX_CTRL                       DP_SPEECH_RESERVED_BASE + 0x017 /* 0x3ef6 */
#define SPH_EXTCOD_PEX_LEN                        DP_SPEECH_RESERVED_BASE + 0x018 /* 0x3ef7 */
...
#define AUDIO_PP_ReserveA2                        DP2_AUDIO_PP_CTRL_BASE + 0x005 /* 0x3f2d */
#define AUDIO_PP_ReserveA3                        DP2_AUDIO_PP_CTRL_BASE + 0x006 /* 0x3f2e */
#define AUDIO_PP_ReserveA4                        DP2_AUDIO_PP_CTRL_BASE + 0x007 /* 0x3f2f */
#define AUDIO_PP_ReserveA5                        DP2_AUDIO_PP_CTRL_BASE + 0x008 /* 0x3f30 */
...
#define AUDIO_PP_ReserveC2                        DP2_AUDIO_PP_CTRL_BASE + 0x012 /* 0x3f3a */
...
#define DP_AUDIO_RAMPDOWN_ENABLE                  DP2_EXTRA_APPLICATION_FILED_BASE + 0x001 /* 0x3f3e */
...
#define DP_AUDIO_ASP_EXTRA2_LEN_ADDR              DP2_EXTRA_APPLICATION_FILED_BASE + 0x004 /* 0x3f41 */
...
#define DP_SPEECH_EXPAND_BASE                     DP2_AUDIO_RESERVED_BASE + 0x002 /* 0x3f48 */

#define SPH_2G_SMR_CE_LOG_SE_CNTR_1               DP_SPEECH_EXPAND_BASE + 0x000 /* 0x3f48 */
#define SPH_2G_SMR_CE_LOG_SE_CNTR_2               DP_SPEECH_EXPAND_BASE + 0x001 /* 0x3f49 */
#define SPH_2G_SMR_CE_LOG_SE_CNTR_3               DP_SPEECH_EXPAND_BASE + 0x002 /* 0x3f4a */
#define SPH_VOLTE_JBM_OUT_SN                      DP_SPEECH_EXPAND_BASE + 0x003 /* 0x3f4b */
#define SPH_UL_FRM_ALIGN_SN                       DP_SPEECH_EXPAND_BASE + 0x004 /* 0x3f4c */

#define SPH_ENH_INTERNAL_PAR_BASE                 DP_SPEECH_EXPAND_BASE + 0x005 /* 0x3f4d */

#define SPH_ENH_INTERNAL_PAR_ADDR                 SPH_ENH_INTERNAL_PAR_BASE + 0x000 /* 0x3f4d */

#define DP_SPEECH_EXPAND2_BASE                    SPH_ENH_INTERNAL_PAR_BASE + 0x010 /* 0x3f5d */

#define DP2_AGC2_CTRL                             DP_SPEECH_EXPAND2_BASE + 0x000 /* 0x3f5d */

#define DP2_UNDEFINEDD_BASE                       DP_SPEECH_EXPAND2_BASE + 0x00a /* 0x3f67 */
...
#define MT6290_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6290_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6290_SHERIF_SIZE)
