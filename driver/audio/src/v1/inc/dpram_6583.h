...
#ifndef _DPRAM_6583_H_
#define _DPRAM_6583_H_
...
#define SPH_DM_ADDR_EMP_BUF                       DP2_SP_AUDIO_INTERFACE_CTRL_BASE + 0x00e /* 0x3d83 */
...
#define SPH_DM_ADDR_EPL_UL_PRE_PTR                DP2_SP_8kPCM_CTRL_BASE + 0x006 /* 0x3d98 */
#define SPH_DM_ADDR_EPL_UL_PRE_BUF                DP2_SP_8kPCM_CTRL_BASE + 0x006 /* 0x3d98 */
#define SPH_DM_ADDR_EPL_UL_POS_PTR                DP2_SP_8kPCM_CTRL_BASE + 0x007 /* 0x3d99 */
#define SPH_DM_ADDR_EPL_UL_POS_BUF                DP2_SP_8kPCM_CTRL_BASE + 0x007 /* 0x3d99 */
#define SPH_DM_ADDR_EPL_DL_PRE_PTR                DP2_SP_8kPCM_CTRL_BASE + 0x008 /* 0x3d9a */
#define SPH_DM_ADDR_EPL_DL_PRE_BUF                DP2_SP_8kPCM_CTRL_BASE + 0x008 /* 0x3d9a */
#define SPH_DM_ADDR_EPL_DL_POS_PTR                DP2_SP_8kPCM_CTRL_BASE + 0x009 /* 0x3d9b */
...
#define SPH_DM_ADDR_BGS_PTR                       DP2_SP_8kPCM_CTRL_BASE + 0x011 /* 0x3da3 */
#define SPH_DM_ADDR_BGS_BUF                       DP2_SP_8kPCM_CTRL_BASE + 0x011 /* 0x3da3 */
...
#define SPH_DM_ADDR_PNW_UL1_PTR                   DP2_SP_CTM_BASE + 0x000 /* 0x3e28 */
#define SPH_DM_ADDR_PNW_UL1_BUF                   DP2_SP_CTM_BASE + 0x000 /* 0x3e28 */
#define SPH_DM_ADDR_PNW_UL2_PTR                   DP2_SP_CTM_BASE + 0x001 /* 0x3e29 */
#define SPH_DM_ADDR_PNW_UL2_BUF                   DP2_SP_CTM_BASE + 0x001 /* 0x3e29 */
#define SPH_DM_ADDR_PNW_DL1_PTR                   DP2_SP_CTM_BASE + 0x002 /* 0x3e2a */
#define SPH_DM_ADDR_PNW_DL1_BUF                   DP2_SP_CTM_BASE + 0x002 /* 0x3e2a */
#define SPH_DM_ADDR_PNW_DL2_PTR                   DP2_SP_CTM_BASE + 0x003 /* 0x3e2b */
...
#define SPH_DM_ADDR_DACA_UL_PTR                   DP_SPEECH_RESERVED_BASE + 0x007 /* 0x3ee6 */
#define SPH_DM_ADDR_DACA_UL_BUF                   DP_SPEECH_RESERVED_BASE + 0x007 /* 0x3ee6 */
#define SPH_DM_ADDR_DACA_DL_PTR                   DP_SPEECH_RESERVED_BASE + 0x008 /* 0x3ee7 */
...
#define SPH_SW_TRANSC_SD_CNTR                     DP_SPEECH_RESERVED_BASE + 0x00a /* 0x3ee9 */
#define SPH_SW_TRANSC_TAF_CNTR                    DP_SPEECH_RESERVED_BASE + 0x00b /* 0x3eea */
#define SPH_APP_MODE                              DP_SPEECH_RESERVED_BASE + 0x00c /* 0x3eeb */
...
#define DP_MARGIN_PCM_W                           DP2_AUDIO_CTRL_FIELD_BASE + 0x003 /* 0x3ef6 */
...
#define DP2_WAV_CTRL_FIELD                        DP2_WAV_CTRL_FIELD_BASE + 0x000 /* 0x3f01 */
#define DP_ASP_WAV_BASE_CTRL                      DP2_WAV_CTRL_FIELD_BASE + 0x000 /* 0x3f01 */
#define DP_ASP_WAV_BASE_DATA                      DP2_WAV_CTRL_FIELD_BASE + 0x001 /* 0x3f02 */
#define DP2_WAV_R_IDX                             DP2_WAV_CTRL_FIELD_BASE + 0x002 /* 0x3f03 */
...
#define AUDIO_PP_3D_type                          DP2_AUDIO_PP_CTRL_BASE + 0x001 /* 0x3f24 */
...
#define D2_SBC_control                            DP2_AUDIO_PP_CTRL_BASE + 0x005 /* 0x3f28 */
#define D2_SBC_DSP_W_PTR                          DP2_AUDIO_PP_CTRL_BASE + 0x006 /* 0x3f29 */
#define D2_SBC_MCU_R_PTR                          DP2_AUDIO_PP_CTRL_BASE + 0x007 /* 0x3f2a */
#define D2_SBC_parameter                          DP2_AUDIO_PP_CTRL_BASE + 0x008 /* 0x3f2b */
#define D2_SBC_Base_address                       DP2_AUDIO_PP_CTRL_BASE + 0x009 /* 0x3f2c */
#define D2_SBC_buffer_length                      DP2_AUDIO_PP_CTRL_BASE + 0x00a /* 0x3f2d */
#define D2_Audio_spectrum_output                  DP2_AUDIO_PP_CTRL_BASE + 0x00b /* 0x3f2e */
#define AUDIO_PP_ReserveB1                        DP2_AUDIO_PP_CTRL_BASE + 0x00c /* 0x3f2f */
...
#define DP_AUDIO_ASP_EXTRA1_BUFLEN_ADDR           DP2_EXTRA_APPLICATION_FILED_BASE + 0x002 /* 0x3f3a */
#define DP_AUDIO_ASP_EXTRA2_ADDR                  DP2_EXTRA_APPLICATION_FILED_BASE + 0x003 /* 0x3f3b */
...
#define DP2_UNDEFINEDD_BASE                       DP2_AUDIO_RESERVED_BASE + 0x002 /* 0x3f43 */


#define SHERIF_SIZE                               1347


// The statement checks whether generates SHERIF size exceeds limitation
#define MT6583_MD1_SHERIF_SIZE (1536 - 32)
#if (SHERIF_SIZE > MT6583_MD1_SHERIF_SIZE)
    ¡§SHERIF SIZE exceeds limitation !! This line makes assembler stop¡¨
#endif

#undef SHERIF_SIZE
#define SHERIF_SIZE (MT6583_MD1_SHERIF_SIZE)
