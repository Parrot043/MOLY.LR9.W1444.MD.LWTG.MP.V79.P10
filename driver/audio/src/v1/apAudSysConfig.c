...
#define AFE_SGEN_CON0                   (AP_AUDSYS_base + 0x01F0)
#define AFE_TOP_CON0                    (AP_AUDSYS_base + 0x0200)
#define AFE_GAIN1_CON0                  (AP_AUDSYS_base + 0x0410)

#define AFE_GAIN1_CONN                  (AP_AUDSYS_base + 0x0420)
...
void PMIC_AudioConfig(void)
{
	...
	// 0x0CEC	0x0000	AUDDEC_ANA_CON8
    // Enable audio globe bias  (default on)
    setVal.offset = ((0<<31) | 0x0CEC);
    setVal.value  = (0x0000);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   
   // 0x028A   0x0001  [0] RG_CLKSQ_EN_AUD = 1'b1
   // Enable CLKSQ 26MHz
	getVal.offset = ((0<<31) | 0x028A);
	DclPMU_Control(handle, MISC_GET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&getVal);
	setVal.offset = ((0<<31) | 0x028A);
	setVal.value  = (getVal.value | 0x0001);
	DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);


	// 0x0CE8   0x0005  AUDDEC_ANA_CON6
    // Enable audio ADC CLKGEN
    setVal.offset = ((0<<31) | 0x0CE8);
    setVal.value  = (0x0005);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

    // 0x0CF4   0x0000  AUDENC_ANA_CON3
    // ADC_CLK form CLKGEN (13MHz) 
    setVal.offset = ((0<<31) | 0x0CF4);
    setVal.value  = (0x0000);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

    // 0x0CE8   0x0005  AUDDEC_ANA_CON6
    // [8] RG_LCLD0_ENC_EN_VA28 ,enable for LCLD0_ENC
    setVal.offset = ((0<<31) | 0x0CE8);
    setVal.value  = (0x0105);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	// 0x0CEA  0x0006  AUDDEC_ANA_CON7
    setVal.offset = ((0<<31) | 0x0CEA);
    setVal.value  = (0x0006);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

#if defined(MT6735_EVB)
   //ACC mode
	// 0x0CFA  0x0555  AUDENC_ANA_CON6
    setVal.offset = ((0<<31) | 0x0CFA);
    setVal.value  = (0x0555);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	// 0x0CF6  0x0800  AUDENC_ANA_CON4
    setVal.offset = ((0<<31) | 0x0CF6);
    setVal.value  = (0x0800);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	// 0x0D00  0x0201  AUDENC_ANA_CON9
    setVal.offset = ((0<<31) | 0x0D00);
    setVal.value  = (0x0201);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	
	// 0x0CEE  0x0041  AUDENC_ANA_CON0
    setVal.offset = ((0<<31) | 0x0CEE);
    setVal.value  = (0x0041);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	
	// 0x0CF0  0x00C1  AUDENC_ANA_CON1
    setVal.offset = ((0<<31) | 0x0CF0);
    setVal.value  = (0x00C1);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	// 0x0D02  0x0003  AUDENC_ANA_CON15
    setVal.offset = ((0<<31) | 0x0D02);
    setVal.value  = (0x0003);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	// 0x0D02  0x0033  AUDENC_ANA_CON15
    setVal.offset = ((0<<31) | 0x0D02);
    setVal.value  = (0x0033);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	
	// 0x0CF4  0x0800  AUDENC_ANA_CON3
    setVal.offset = ((0<<31) | 0x0CF4);
    setVal.value  = (0x0800);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	// 0x0CEE  0x0541  AUDENC_ANA_CON0
    setVal.offset = ((0<<31) | 0x0CEE);
    setVal.value  = (0x0541);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

		
	// 0x0CF0  0x05C1  AUDENC_ANA_CON1
    setVal.offset = ((0<<31) | 0x0CF0);
    setVal.value  = (0x05C1);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
#else //#if defined(MT6735_EVB)
   //DCC mode
   kal_prompt_trace(MOD_L1SP, "Denali phone use DCC mode");
   // 0x028C   0x0003  [15:0] TOP_CLKSQ_SET = 16'b0000000000000011
   // Turn on 26MHz source clock
   getVal.offset = ((0<<31) | 0x028C);
   DclPMU_Control(handle, MISC_GET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&getVal);
   setVal.offset = ((0<<31) | 0x028C);
   setVal.value  = (getVal.value | 0x0003);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x023C   0x9EFC  [15:0] 
   // AUD_CK power down bit[14] = 0, Power on
   getVal.offset = ((0<<31) | 0x023C);
   DclPMU_Control(handle, MISC_GET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&getVal);
   setVal.offset = ((0<<31) | 0x023C);
   setVal.value  = (getVal.value & 0xBFFF); // 0xDEFC -> 0x9EFC
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x2090  0x2062  AFE_DCCLK_CFG0
   setVal.offset = ((0<<31) | 0x2090);
   setVal.value  = (0x2062);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
   ...
   // 0x2090  0x2060 AFE_DCCLK_CFG0
   setVal.offset = ((0<<31) | 0x2090);
   setVal.value  = (0x2060);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x2090  0x2061 AFE_DCCLK_CFG0
   setVal.offset = ((0<<31) | 0x2090);
   setVal.value  = (0x2061);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x2092  0x1105 AFE_DCCLK_CFG1
   setVal.offset = ((0<<31) | 0x2092);
   setVal.value  = (0x1105);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
   ...
   // 0x0D00  0x0207  AUDENC_ANA_CON9
   //setVal.offset = ((0<<31) | 0x0D00);
   //setVal.value  = (0x0207);
   //DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x0CF0  0x0004  AUDENC_ANA_CON1
   setVal.offset = ((0<<31) | 0x0CF0);
   setVal.value  = (0x0004);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x0CEE  0x0004  AUDENC_ANA_CON0
   setVal.offset = ((0<<31) | 0x0CEE);
   setVal.value  = (0x0004);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x0CEE  0x0045  AUDENC_ANA_CON0
   setVal.offset = ((0<<31) | 0x0CEE);
   setVal.value  = (0x0045);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x0CF0  0x00C5  AUDENC_ANA_CON1
   setVal.offset = ((0<<31) | 0x0CF0);
   setVal.value  = (0x00C5);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
   ...
   // 0x0CF0  0x00C7  AUDENC_ANA_CON1
   setVal.offset = ((0<<31) | 0x0CF0);
   setVal.value  = (0x00C7);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x0CEE  0x0047  AUDENC_ANA_CON0
   setVal.offset = ((0<<31) | 0x0CEE);
   setVal.value  = (0x0047);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
   ...
   // 0x0CEE  0x0547  AUDENC_ANA_CON0
   setVal.offset = ((0<<31) | 0x0CEE);
   setVal.value  = (0x0547);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x0CF0  0x05C7  AUDENC_ANA_CON1
   setVal.offset = ((0<<31) | 0x0CF0);
   setVal.value  = (0x05C7);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
   ...
   // 0x0CF0  0x05C3  AUDENC_ANA_CON1
   setVal.offset = ((0<<31) | 0x0CF0);
   setVal.value  = (0x05C3);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

   // 0x0CEE  0x0543  AUDENC_ANA_CON0
   setVal.offset = ((0<<31) | 0x0CEE);
   setVal.value  = (0x0543);
   DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
#endif //#if defined(MT6735_EVB)


	// 0x0240	0x7000	TOP_CKPDN_CON0
	// on or off?
	getVal.offset = ((0<<31) | 0x0240);
	DclPMU_Control(handle, MISC_GET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&getVal);
	setVal.offset = ((0<<31) | 0x0240);
	setVal.value  = (getVal.value & 0x7000);//(0x86FC);//(0xCEFC);
	DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
...
//==================audio DL power on peocedure======================//
//==================here set digital part============================//
   // 0x028A   0x0001  [0] TOP_CLKSQ = 1'b1
   // Enable CLKSQ 26MHz
	getVal.offset = ((0<<31) | 0x028A);
	DclPMU_Control(handle, MISC_GET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&getVal);
	setVal.offset = ((0<<31) | 0x028A);
...
#if defined(MT6735_EVB)
    //ACC mode
	// 0x028C   0x0001  [15:0] TOP_CLKSQ_SET = 16'b0000000000000001
    // Turn on 26MHz source clock
    getVal.offset = ((0<<31) | 0x028C);
    DclPMU_Control(handle, MISC_GET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&getVal);
    setVal.offset = ((0<<31) | 0x028C);
...
#else //#if defined(MT6735_EVB)
    //DCC mode
    // 0x028C   0x0003  [15:0] TOP_CLKSQ_SET = 16'b0000000000000001
    // Turn on 26MHz source clock
    getVal.offset = ((0<<31) | 0x028C);
    DclPMU_Control(handle, MISC_GET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&getVal);
    setVal.offset = ((0<<31) | 0x028C);
   ...
   // 0x0240  0x7000  [15:0] TOP_CKPDN_CON0_CLR 
   // Turn on AUDNCP_CLKDIV engine clock. Turn on AUD 26M.
    getVal.offset = ((0<<31) | 0x0240);
    DclPMU_Control(handle, MISC_GET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&getVal);
    setVal.offset = ((0<<31) | 0x0240);
    setVal.value  = (getVal.value | 0x7000); 
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

    // delay 250us
    AFE_DELAY(250);
	// 0x2014	0xC000	AUDIO_TOP_CON0
	//					[15] fifo_auto_rst_ctl = 1'b0
	//					[14] afe_ck_div_rst_ctl = 1'b0
	//					 [7] pdn_afe_ctl = 1'b0
	//					 [6] pdn_dac_ctl = 1'b0
...
#if  APAUDSYS_DVT_32K // 32k
	setVal.value = (0x6330);
#elif  APAUDSYS_DVT_8K // 8k
	setVal.value = (0x0330);
#else // 16k
	setVal.value = (0x3330);
#endif
...
//==================here set analog part============================//
	...
	// 0x028A   0x0001  TOP_CLKSQ [0] RG_CLKSQ_EN_AUD = 1'b1
    // Enable CLKSQ 26MHz
	getVal.offset = ((0<<31) | 0x028A);
	DclPMU_Control(handle, MISC_GET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&getVal);
	setVal.offset = ((0<<31) | 0x028A);
    ...
    // 0x0D0C   0x0003  AUDNCP_CLKDIV_CON4
    setVal.offset = ((0<<31) | 0x0D0C);
    setVal.value  = (0x0003);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	
	// 0x0D06	0x0001	AUDNCP_CLKDIV_CON1
	setVal.offset = ((0<<31) | 0x0D06);
	setVal.value  = (0x0001);
	DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	// 0x0D08	0x002B	AUDNCP_CLKDIV_CON2
	setVal.offset = ((0<<31) | 0x0D08);
	setVal.value  = (0x002B);
	DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	// 0x0D04	0x0001	AUDNCP_CLKDIV_CON0
	setVal.offset = ((0<<31) | 0x0D04);
	setVal.value  = (0x0001);
	DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);	

	// 0x0D0C	0x0000	AUDNCP_CLKDIV_CON4
	setVal.offset = ((0<<31) | 0x0D0C);
	setVal.value  = (0x0000);
	DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);	

	// 0x0D0A	0x0000	AUDNCP_CLKDIV_CON3
    ...
    AFE_DELAY(100);
	// PMIC VIO18 
	val.chip_name = PMIC_6328;
	DclPMU_Control(handle, MISC_GET_HW_VERSION, (DCL_CTRL_DATA_T *)&val);
	//if(val.version == PMIC_ECO_E1)
	if( (val.version == PMIC_ECO_E1) && (0 == vio18_setting) )
	{
		// 0x0A80	0x0C00	
		setVal.offset = ((0<<31) | 0x0A80);
		setVal.value  = (0x0C00);
		DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
	
	}
	// 0x0CE8	0x0945	AUDDEC_ANA_CON6
	//					[11] RG_HCLDO_REMOTE_SENSE_VA18 = 1'b1
	//					 [6] RG_HCLDO_EN_VA18 = 1'b1
	// Enable cap-less HC LDO (1.5V)
	setVal.offset = ((0<<31) | 0x0CE8);
    ...
    // 0x0CDC   0xE080  AUDDEC_ANA_CON0
    //                   [15] RG_AUDHPRSCDISABLE_VAUDP15 = 1'b1
    //                   [14] RG_AUDHPLSCDISABLE_VAUDP15 = 1'b1
    //                   [13] RG_AUDHSSCDISABLE_VAUDP15 = 1'b1 
    //                  [8:7] RG_AUDHSMUXINPUTSEL_VAUDP15 = 2'b01
    // Disable headphone, voice and short-ckt protection. HP MUX is opened, voice MUX is set mute.
    setVal.offset = ((0<<31) | 0x0CDC);
    setVal.value  = (0xE080);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

    // 0x0CE8   0x29C4  AUDDEC_ANA_CON6
    // Enable audio ADC CLKGEN
    setVal.offset = ((0<<31) | 0x0CE8);
    setVal.value  = (0x29C4);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

	// 0x0CE4   0x0400  AUDDEC_ANA_CON4
    //                  [15:8] RG_ABIDEC_RESERVED_VAUDP15 = 8'b00000100
    // Enable HS drivers bias circuit
    setVal.offset = ((0<<31) | 0x0CE4);
    setVal.value  = (0x0400);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);

    // 0x0CE6   0x5490  AUDDEC_ANA_CON5
    // HP/HS IBIS&dr BIAS CURRENT OPTIMIZATION
    setVal.offset = ((0<<31) | 0x0CE6);
    setVal.value  = (0x5490);
    DclPMU_Control(handle, MISC_SET_REGISTER_VALUE, (DCL_CTRL_DATA_T *)&setVal);
