...
/**
	@prSmpMsg:
	@comeFrom: 0 for trigger from CCCI_HISR, 1 for trigger from AUDL. 2 for trigger from HISR(you can add more in the future). 3 for init function
*/
...
void SpcIO_MsgQueuePut_SPC_ID_SPEECH_CUSTOM_DATA_REQUEST(void)
{
#ifndef SPH_CHIP_BACK_PHONECALL_USE
	SpcIO_MsgQueuePut(SPC_ID_SPEECH_CUSTOM_DATA_REQUEST, 0, 0, 3);
#endif //#ifndef SPH_CHIP_BACK_PHONECALL_USE
}
