...
#if (defined(MT6595) || defined(MT6752) || defined(MT6735)) && (MDAFE_DVT_CASE1 || APAUDSYS_DVT_32K)
	afe.voice8kMode = 2;
#elif (defined(MT6595) || defined(MT6752) || defined(MT6735)) && (MDAFE_DVT_CASE3 || APAUDSYS_DVT_8K) // 8k
	afe.voice8kMode = 0;
#else
