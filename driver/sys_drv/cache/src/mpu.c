...
void MPU_Init(void)
{
...
#if defined(EMI_MPU_ENABLE)
    {
        ...
        EMI_MPU_Set_Region_APC(EMI_MPU_REGION_CP, 2, EMI_MPU_NOACCESS);
        ...
        EMI_MPU_Set_Region_APC(EMI_MPU_REGION_MP, 2, EMI_MPU_NOACCESS);
        EMI_MPU_Set_Region_APC(EMI_MPU_REGION_MP, 3, EMI_MPU_NOACCESS);
        EMI_MPU_Set_Region_Address(EMI_MPU_REGION_MP, ROM_Base+ROM_Length, ROM_Base+ROM_Length+RAM_Length);
        // Set magic key to notify AP
        /**((volatile unsigned *)(ROM_Base+ROM_Length+RAM_Length)) = 0x09260926;*/
        /*cp15_clean_dcache_single(ROM_Base+ROM_Length+RAM_Length);*/
#else
        EMI_MPU_Set_Region_APC(EMI_MPU_REGION_CP, 0, EMI_MPU_SR_NSR);
        EMI_MPU_Set_Region_APC(EMI_MPU_REGION_CP, 1, EMI_MPU_SR_NSR);
