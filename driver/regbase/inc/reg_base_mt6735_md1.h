...
#ifndef __REG_BASE_MT6735_H__
#define __REG_BASE_MT6735_H__


/* Copy from reg_base_mt6752_MD1.h */
...
/*AP GPIO*/
#define GPIO_base                   (0xA0211000)
#define BASE_MADDR_U2MAC            (0xA1200000)
#define BASE_ADDR_U2PHY             (0xA1210000)


/********************************************
 * MT6735 AP Peripheral Register Base
 ********************************************/
// APB Module cksys
#define CKSYS_BASE (0xA0210000)
// APB Module infracfg_ao
#define INFRACFG_AO_BASE (0xA0000000)
// APB Module toprgu
#define TOPRGU_BASE (0xA0212000)
// APB Module pmic_wrap
#define PWRAP_BASE (0xA0001000)
// APB Module efusec
#define EFUSEC_BASE (0xA0206000)
// APB Module ccif
#define MD_CCIF0_BASE (0xA020B000)
// APB Module pccif
#define PCCIF_MD1_base (0xA021C000)
// APB Module pccif
#define PCCIF_MD2_base (0xA021D000)
// APB Module perisys_iommu
#define PERISYS_IOMMU_BASE (0xA0205000)
// APB Module audiosys
...
// INFRA_cldma_pdn_ap
#define BASE_MADDR_APCLDMAIN        (0xA021A000)
#define BASE_MADDR_APCLDMAOUT       (0xA021A200)
#define BASE_MADDR_APCLDMAMISC      (0xA021A400)
// INFRA_cldma_pdn_md
#define BASE_MADDR_MDCLDMAIN        (0xA021B000)
#define BASE_MADDR_MDCLDMAOUT       (0xA021B200)
#define BASE_MADDR_MDCLDMAMISC      (0xA021B400)


//INFRAAO_cldma_ao_top_ap
#define BASE_MADDR_APCLDMAIN_AO         (0xA000A800)
#define BASE_MADDR_APCLDMAOUT_AO        (0xA000AA00)
#define BASE_MADDR_APCLDMAMISC_AO       (0xA000AC00)
//INFRAAO_cldma_ao_top_md
#define BASE_MADDR_MDCLDMAIN_AO         (0xA000B800)
#define BASE_MADDR_MDCLDMAOUT_AO        (0xA000BA00)
#define BASE_MADDR_MDCLDMAMISC_AO       (0xA000BC00)


#endif /* end of __REG_BASE_MT6735_H__ */
