...
/*DFS Compile Option for EL1C & Modem_Topsm*/
#if defined(MT6735)
#define __LR9_LTE_DVFS__
#endif

#if defined(MT6290) || defined(MT6291)
typedef enum
{
    /*Spare register 0~9 */
    SPARE0_DORMANT_RECOVER_ADDR = 0,
    SPARE1_USB_FW_DL,
    SPARE2_USB_FW_DL,
    SPARE3_USB_FW_DL,
    SPARE4,
    SPARE5_OSTD_PATCH_DBG_SWITCH,
    SPARE6_RSV,
    SPARE7_RSV,
    SPARE8_RSV,
    SPARE9_RSV,
...
/******************************************************************************
*    Function : RM_SPARE_REG_RW
* Description : Read/Write spare register
*   Parameter : RM_SPARE_IDX:index
*               pData:R/W data
*               bRead: True for read
*   Return    : None
******************************************************************************/
void RM_SPARE_REG_RW(RM_SPARE_IDX idx, kal_uint32 *pData, kal_bool bRead);
#endif
...
#if defined(__LR9_LTE_DVFS__)
void MODEM4G_TOPSM_DVFS_ClockScaleDown( void );
void MODEM4G_TOPSM_DVFS_ClockScaleUp( void );
#endif
