...
#if defined(MT6290) || defined(MT6595) || (defined(MT6752) && defined(__MD1__)) || (defined(MT6735) && defined(__MD1__)) 
...
#define LPWR_SLIM
#if defined(MT6290) || defined(MT6595) || defined(MT6735)
#define SIM_LOCK_SRCCLK_FOR_NONE_STOP_CLK_CARD
#endif
#endif

#ifdef __SIM_DRV_SWITCH_MT6306__
#undef __ABNORMAL_CARD__ 
#else
#if defined(MT6595) || (defined(MT6752) && defined(__MD1__)) || (defined(MT6735) && defined(__MD1__)) 
#define __ABNORMAL_CARD__ 1
#endif
#endif 

#if (defined(MT6735))
#define __DRV_SIM_LP_MODE__ 1
#endif
