...
#else	
			dhl_print(TRACE_INFO, DHL_USER_FLAG_NONE, MOD_SIM_DRV, "[SIM]:sim interface inversed!!");
#endif
...
#else	
		 dhl_print(TRACE_INFO, DHL_USER_FLAG_NONE, MOD_SIM_DRV, "another SIM card found!!");
#endif
...
#else	
		 dhl_print(TRACE_INFO, DHL_USER_FLAG_NONE, MOD_SIM_DRV, "another SIM card not found!!");
#endif
    }
