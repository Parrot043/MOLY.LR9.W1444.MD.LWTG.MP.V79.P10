...
/*MT6169*/ {
/*MT6169*/    char segment_tx=3, LUT_num_tx=9, offset_tx=13; // LUT method related parameters
/*MT6169*/    signed short TXDCO_LUT[9]={4153, 3177, 2390, 1746, 1212, 765, 387, 63, -215};  // TXDCO LUT
