...
#if IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#define TX_CON1                  ((APBADDR)(BFE_base+0x0404))       /* This register is for control of TX power and mode switching timing*/
      #if IS_CHIP_MT6250
      #elif IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#define RX_NBFIR_COEF(n)         ((APBADDR)(BFE_base+0x0840+(n)*4))
#define RX_FIR_COEF(n)           ((APBADDR)(BFE_base+0x0870+(n)*4))
      #if IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
      #else
...
#define W_IMMDT_REG              RX_W_FRC
      #elif IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#define ETDAC_CONA               ((APBADDR)(ABB_MIXEDSYS_base+0x528))        /* ETDAC Control Register A                      */
   #elif IS_LTE_CHIP_MT6595_AND_LATTER_VERSION
...
#if IS_CHIP_MT6268T || IS_CHIP_MT6268 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#define GSM2FRC_IMM              ((APBADDR)(TDMA_base+0x030C))          /* MT6276_E1 and MT6573 E1&E2 do NOT have this register */
   #endif
#endif
#if IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_SOC_CHIP || IS_CHIP_MT6236 || IS_CHIP_MT6276_S01 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#define BPI_EN2                  ((APBADDR)   (BPI_base+/*0x0084*/0x00B8))/* BPI event enable register                   */
   #elif IS_CHIP_MT6268T || IS_CHIP_MT6268H || IS_CHIP_MT6268 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#define BPI_MASK                 ((APBADDRBPI)(BPI_base+/*0x0080*/0x00B8))/* Mask for GSM Bus shared output              */
      #if IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION || IS_CHIP_MT6268H || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#define AFC_UMTS_CON             ((APBADDR32)(AFC_base+0x0018))         /* UMTS AFC Control Register                     */
         #elif IS_LTE_CHIP_MT6290_AND_LATTER_VERSION
...
#define APC_OFS(n)               ((APBADDR)(APC_base+0x0018+((n)*32)))  /* Rampdown Profile #n                           */
   #if IS_CHIP_SER_AND_LATTER(CHIP_ID_MT6276) || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
/*MT6516*/ #define PDN_CON_BSI              0x0008
   ...
   #if IS_CHIP_MT6276 || IS_CHIP_MT6575 || IS_CHIP_MT6573 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#if IS_LTE_CHIP_MT6595_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#else
...
#elif IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#elif IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
#elif IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#define DSPCLK_CON               ((APBADDR)(MD2GCONFG_base+0x040))      /* DSP Clock Control Register                    */
