...
#if IS_2G_TAS_FOR_C2K_ONOFF_SUPPORT
...
#if IS_2G_TAS_FOR_C2K_ONOFF_SUPPORT
   #ifdef MML1_TAS_FOR_C2K_2GCS_PREFER_EN
      #if MML1_TAS_FOR_C2K_2GCS_PREFER_EN
         #if (((L1D_TAS_PIN1)!=(L1D_TAS_PIN_NULL))&&(((L1D_TAS_PIN1)<(BPI_MIN_SHARE_PIN_NUMBER))||((L1D_TAS_PIN1)>(BPI_MAX_SHARE_PIN_NUMBER))))
#error "Please check the L1D_TAS_PIN1 setting at l1d_custom_rf.h , it out of range of BPI share pin"   
         #endif
         #if (((L1D_TAS_PIN2)!=(L1D_TAS_PIN_NULL))&&(((L1D_TAS_PIN2)<(BPI_MIN_SHARE_PIN_NUMBER))||((L1D_TAS_PIN2)>(BPI_MAX_SHARE_PIN_NUMBER))))
#error "Please check the L1D_TAS_PIN2 setting at l1d_custom_rf.h , it out of range of BPI share pin"   
         #endif
         #if (((L1D_TAS_PIN3)!=(L1D_TAS_PIN_NULL))&&(((L1D_TAS_PIN3)<(BPI_MIN_SHARE_PIN_NUMBER))||((L1D_TAS_PIN3)>(BPI_MAX_SHARE_PIN_NUMBER))))
#error "Please check the L1D_TAS_PIN3 setting at l1d_custom_rf.h , it out of range of BPI share pin"   
         #endif
      #endif   
   #endif
#endif
...
#if IS_DYNAMIC_GAINTABLE_SWITCH_SUPPORT
   #ifndef  SWITCH_GAINTABLE_IDX
   #define  SWITCH_GAINTABLE_IDX         0
   #endif
#endif
...
#if IS_DYNAMIC_GAINTABLE_SWITCH_SUPPORT
int RX_gaintable_idx = SWITCH_GAINTABLE_IDX;
#endif
...
/*MT6229,L1D_TEST~*/     /*-------------------------------------*/
/*MT6229,L1D_TEST~*/ };
      #elif IS_CHIP_MT6256 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
...
CONST short TQ_TxSampleOffsetEPSK   = QB_TX_SAMPLE_OFFSET_EPSK;
   ...
   #if IS_CHIP_MT6256 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6583_MD2 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2 || IS_EDGE_SAIC_CHIP_MT6270A_AND_LATTER_VERSION
