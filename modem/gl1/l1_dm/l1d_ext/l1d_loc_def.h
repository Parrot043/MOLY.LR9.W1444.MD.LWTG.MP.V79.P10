...
#define IS_DCXO_ENABLE                             0
   #endif
#elif IS_SOC_CHIP || IS_MT6162_6163_DCXO_SUPPORT || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
#define IS_AFC_EVENT_ENABLE                        0
#define IS_DCXO_ENABLE                             1
#else
#define IS_AFC_EVENT_ENABLE                        1
...
#if IS_DCXO_ENABLE
   #if IS_SOC_CHIP || IS_MT6162_6163_DCXO_SUPPORT || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
