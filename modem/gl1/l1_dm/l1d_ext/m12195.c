...
#define TAS_BPI_MASK       (L1_TAS_Custom_PData.pdata_tas_mask)
#define GET_TAS_BPI        ((l1d_rf.tas_ant_sel>=1)?L1_TAS_Custom_PData.pdata_band_tas[l1d_rf.band][(l1d_rf.tas_ant_sel-1)]:0)
#else
#define TAS_BPI_MASK       (0x0)
#define GET_TAS_BPI        (0x0)
#endif
void  L1D_RF_SetPData_PR( void )
{
   ...
   HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi );   _reg+=BPI_REG_IDX;   _d16p++;
   HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi );   _reg+=BPI_REG_IDX;   _d16p++;
#if IS_EDGE_CHIP_MT6229_AND_LATTER_VERSION
   HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi );
#else
   HW_WRITE( _reg, *_d16p );
#endif
#if IS_EDGE_CHIP_MT6229_AND_LATTER_VERSION
...
void  L1D_RF_SetPData_PT( void )
{
   ...
   HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi );   _reg+=2;   _d16p++;
   HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi );   _reg+=2;   _d16p++;
   HW_WRITE( _reg, *_d16p );
...
/*MT6218~*/ }
   ...
   {
      HW_WRITE( _reg, (((*_d16p)&(~TAS_BPI_MASK))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
      HW_WRITE( _reg, (((*_d16p)&(~TAS_BPI_MASK))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
      HW_WRITE( _reg, (((*_d16p)&(~TAS_BPI_MASK))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
   ...
   {
      HW_WRITE( _reg, (((*_d16p)&(~TAS_BPI_MASK))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
      HW_WRITE( _reg, (((*_d16p)&(~TAS_BPI_MASK))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
      HW_WRITE( _reg, (((*_d16p)&(~TAS_BPI_MASK))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;   _d16p++;
...
/*MT6218~*/ HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi);   _reg+=2;   _d16p++;
/*MT6218~*/ HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi);
...
/*MT6229~*/ HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi);   _reg+=2;   _d16p++;
/*MT6229~*/ HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi);
#endif
}
...
/*MT6229~*//*EGPRS*/       {
/*MT6229~*//*EGPRS*/          /*Set M1*/ HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi);   _reg+=BPI_REG_IDX;   _d16p++;
/*MT6229~*//*EGPRS*/          /*Set M2*/ HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi);   _reg+=BPI_REG_IDX;   _d16p++;
/*MT6229~*//*EGPRS*/          /*Set M3*/ HW_WRITE( _reg, ((*_d16p)&(~TAS_BPI_MASK))|tas_bpi);
/*MT6229~*//*EGPRS*/       }
/*MT6229~*//*EGPRS*/       //no change
/*MT6229~*//*EGPRS*/       else
/*MT6229~*//*EGPRS*/       {  HW_WRITE( _reg, (((_d16p2)&(~TAS_BPI_MASK))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;
/*MT6229~*//*EGPRS*/          HW_WRITE( _reg, (((_d16p2)&(~TAS_BPI_MASK))|(pdata_8psk)|tas_bpi) );   _reg+=BPI_REG_IDX;
/*MT6229~*//*EGPRS*/          HW_WRITE( _reg, (((_d16p2)&(~TAS_BPI_MASK))|(pdata_8psk)|tas_bpi) );
/*MT6229~*//*EGPRS*/       }
/*MT6229~*//*EGPRS*/    }
...
/*MT6229~*//*EGPRS*/       //no change
/*MT6229~*//*EGPRS*/       else
/*MT6229~*//*EGPRS*/       {  HW_WRITE( _reg, (((_d16p2)&(~TAS_BPI_MASK))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;
/*MT6229~*//*EGPRS*/          HW_WRITE( _reg, (((_d16p2)&(~TAS_BPI_MASK))|(pdata_gmsk)|tas_bpi) );   _reg+=BPI_REG_IDX;
/*MT6229~*//*EGPRS*/          HW_WRITE( _reg, (((_d16p2)&(~TAS_BPI_MASK))|(pdata_gmsk)|tas_bpi) );
/*MT6229~*//*EGPRS*/       }
/*MT6229~*//*EGPRS*/    }
/*MT6229~*//*EGPRS*/
/*MT6229~*//*EGPRS*/ }
...
/*MT6169*/    unsigned long  ctrl_fpm_div        = SCTRL_RESERVED, fpm_div = 0x0FAFF750;
...
/*MT6169*/    unsigned short afc_data;
/*MT6169*/
/*MT6169*/    SETUP_SR1();
/*MT6169*/
/*MT6169*/    switch( RXD )
...
/*MT6169*/    }
/*MT6169*/
/*MT6169*/    afc_data = (L1D_RF_Check_DCXO_LPM()&0x1FFF);
/*MT6169*/
/*MT6169*/ #if IS_BSI_AFC_ACTIVE_SWITCH
/*MT6169*/    ctrl_dcxo = l1d_rf2.is_bsi_afc_active ? (SCTRL_AFCDAC|event_idx) : SCTRL_RESERVED;
/*MT6169*/ #endif
/*MT6169*/ #if IS_DUAL_LOOP_AFC_CONTROL_SUPPORT && IS_32K_CRYSTAL_REMOVAL_SUPPORT
/*MT6169*/    ctrl_fpm_div = (l1d_rf.is_lock_dcxo && l1d_rf.dcxo_frac_fpm!=0) ? (SCTRL_AFCDAC|event_idx) : SCTRL_RESERVED;
/*MT6169*/    fpm_div      = (0x0FAFF750 & (~0x00000FFF)) | (l1d_rf.dcxo_frac_fpm & 0xFFF);
/*MT6169*/ #endif
/*MT6169*/
/*MT6169*/    if( ( MT6169_2G_CHIP_VER == MT6169_E3 ) )
/*MT6169*/    {
...
/*MT6169*/                        ctrl_dcxo,                              SDATA_AFCDAC|((afc_data&0x1FFF)<<7),                /* CW254: AFC DAC                           */
/*MT6169*/                        SCTRL_RXCAL_MODE|event_idx,             SDATA_RXCAL_MODE|SDATA_BAND_SEL[l1d_rf.band],       /* CW1  : 2G RX Cal Mode | Band             */
/*MT6169*/                        ctrl_fpm_div,                           BSI_CW( 0xFA, fpm_div ),                            /* CW250 : 32K FPM Divider */
