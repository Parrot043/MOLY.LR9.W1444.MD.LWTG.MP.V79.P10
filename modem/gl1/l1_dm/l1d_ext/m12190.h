...
#define GEN_MASK_BITS(M,L)          ((BIT_POS((M)+1-(L))-1)<<(L))
#define GEN_CLEAR_BITS(M,L)         (~((BIT_POS((M)+1-(L))-1)<<(L)))
#define CLEAR_BITS(V,M,L)           (V&GEN_CLEAR_BITS(M,L))
#define SET_BITS(V,U,M,L)           ((V&GEN_CLEAR_BITS(M,L))|((U<<L)&GEN_MASK_BITS(M,L)))
...
/*    BSI codeword marco                                                         */
/*===============================================================================*/
#if IS_CHIP_MT6256 || IS_CHIP_MT6251 || IS_CHIP_MT6255 || IS_CHIP_MT6250 || IS_CHIP_MT6280 || IS_CHIP_MT6583_MD1 || IS_CHIP_MT6572 || IS_LTE_CHIP_MT6290_AND_LATTER_VERSION || IS_CHIP_MT6752_MD2
