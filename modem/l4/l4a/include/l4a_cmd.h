...
extern kal_bool l4a_nw_exe_cops_req(kal_uint8 src_id, kal_uint8 opcode, kal_uint8 * oper, kal_uint8 rat); //FastCampOn 20081104

extern kal_bool l4a_sms_exe_post_command_req(
                    kal_uint8 src_id,
                    kal_uint8 fo,
                    kal_uint8 ct,
                    kal_uint8 mn,
...
extern kal_bool l4a_sms_exe_delete_msg_req(
                    kal_uint8 src_id,
                    kal_uint8 del_flag,
                    kal_uint16 index,
...
extern kal_bool l4a_sms_send_from_storage_req(
                    kal_uint8 src_id,
                    kal_uint16 index,
...
extern kal_bool l4a_sms_set_status_req(
                    kal_uint8 src_id,
                    kal_uint8 new_status,
                    kal_uint16 index,
		      kal_uint8 source_id);

extern kal_bool l4a_sms_exe_read_msg_req(kal_uint8 src_id, kal_uint16 index, kal_bool change_status,kal_uint8 source_id);

extern kal_bool l4a_sms_exe_post_msg_req(
                    kal_uint8 src_id,
                    kal_uint8 profile,
...
extern kal_bool l4a_sms_exe_write_msg_req(
                    kal_uint8 src_id,
                    kal_uint8 profile,
                    kal_uint8 status,
                    l4c_number_struct dest,
...
extern kal_bool l4a_sms_exe_abort_req(kal_uint8 src_id,kal_uint8  source_id, kal_uint8 seq_num); 
extern kal_bool l4a_sms_copy_msg_req(kal_uint8 src_id, kal_uint8 action, kal_uint8 dst_storage, kal_uint16 src_index,kal_uint8 source_id);	
extern kal_bool l4a_sms_get_preferred_mem_req(kal_uint8 src_id, smsal_prefer_storage_struct *info); 
extern kal_bool l4a_sms_reg_port_num_req(
                    kal_uint8 src_id,
                    kal_bool enable,
                    kal_uint32 port_num,
                    kal_uint16 mod_id,
...
extern kal_bool l4a_sms_exe_send_smma_req(kal_uint8 src_id,kal_uint8  source_id);
extern kal_bool l4a_sms_exe_set_msg_waiting_req(kal_uint8 src_id,kal_uint8  source_id,kal_uint8  line_no,kal_uint8  waiting_num,kal_uint8  ind_type);
...
#endif
extern void l4a_eq_read_nvram_lrsp (l4c_result_struct result, kal_uint16 file_idx, kal_uint16 length, kal_uint16 para, kal_uint8 *data);
...
extern void l4a_sms_exe_read_raw_data_lrsp(kal_uint8  result,
											kal_uint16 cause,
											kal_uint16 index,
											kal_uint8  status,
	                              					       kal_uint8  storage_type,
...
extern void l4a_ps_gprs_status_update_lind(l4c_gprs_status_enum status, kal_uint8 cell_support_egprs, kal_uint8 data_speed_support, kal_uint8 data_bearer_capability); //hspa_mmi_h2
...
extern void l4a_rsat_open_channel_lind(
    kal_uint8 cmd_detail[5],
    kal_bool is_icon_available,
    sat_icon_struct icon_info,    
    kal_uint8 bearer,
...
extern void l4a_rsat_close_channel_lind(
    kal_uint8	cmd_detail[5],
    kal_uint8	ch_id,
    kal_bool	is_icon_available,
    sat_icon_struct	icon_info,
...
extern void l4a_rsat_send_data_lind(
    kal_uint8 cmd_detail[5],
    kal_uint8	ch_id,
    kal_uint8	ch_type,
    kal_bool	is_icon_available,
...
extern void l4a_rsat_recv_data_lind(
    kal_uint8	cmd_detail[5],
    kal_uint8	ch_id,
    kal_uint8	ch_type,
    kal_bool	is_icon_available,
...
extern void l4a_rsat_ch_status_lind(
    kal_uint8	cmd_detail[5],
    kal_uint8 ch_id
    	);
...
extern kal_bool l4a_cc_exe_send_dtmf_req(kal_uint8 src_id, kal_uint8 digit,kal_uint8 call_id);
#if defined(__NONE_USED_L4MMI_MESSAGE__)
...
extern void l4a_eq_keypad_detect_lind(kal_uint8 func_type);
...
extern void l4c_mms_read_msg_path_wind(kal_uint32  msgId);
#endif //__L4A_CMD_H__
#endif //__MOD_L4A__
