...
BEGIN_TRACE_MAP(MOD_SMSAL)
   ...
   TRC_MSG(FUNC_GET_PLMN, "SMSAL: smsal_get_hplmn_id()")
   ...
   TRC_MSG(INFO_PLMN_ID,"SMSAL: PLMN ID = %d")
   ...
   TRC_MSG(INFO_GET_CUSTOM_SMSC, "SMSAL:Finding the SC Addr from Custom Function")
   TRC_MSG(INFO_GET_CUSTOM_SMSC_ERROR, "NO SC ADDR with this PLMN")
