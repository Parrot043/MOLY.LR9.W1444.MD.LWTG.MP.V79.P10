...
extern kal_bool l4c_pws_proc_warning_msg_in_hplmn(void);

extern kal_bool l4c_pws_proc_warning_msg_in_vplmn(void);

extern kal_bool l4c_pws_ignore_warning_msg(void);
