...
#define DT_CHECK_MSG_QUEUE_FRQ    20 /* record copy/move action check message queue frequency */
...
typedef enum
{
   ...
   DT_ERR_DT_ABORT,/*16 ex: DT guard timer expiry will abort upload action*/
   DT_ERR_WRITE_FILE_FAILURE,/*17 */ 
   DT_ERR_INVALID_INDEX = 21/*21*/
} dt_err_id_enum;
...
typedef enum
{
   DT_STATE_UART_OWNER_ATCI,
   DT_STATE_UART_OWNER_ATCI2,
   DT_STATE_UART_OWNER_DT,
   DT_STATE_PLUGOUT,
   DT_STATE_NONE
} dt_state_enum;
