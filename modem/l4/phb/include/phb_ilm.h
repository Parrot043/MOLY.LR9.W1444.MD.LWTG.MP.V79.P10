...
#error "phb_control_block.h should be included"
    ...
    extern void phb_send_ilm(module_type dest_id, kal_uint16 msg_id, void *local_param_ptr, void *peer_buf_ptr);
    
#if defined(__SGLTE__)
    extern void phb_send_ilm2(module_type src_id, module_type dest_id, kal_uint16 msg_id, void *local_param_ptr, void *peer_buf_ptr);
#endif
