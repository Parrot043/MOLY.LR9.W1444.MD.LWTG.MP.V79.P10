...
/*****************************************************************************
* FUNCTION
*  l4crac_set_switch_modem_cause
* DESCRIPTION
*  set plmn_id_rat_info & switch_cause to NWSEL
*
* PARAMETERS
*  none
*
...
*  none
*****************************************************************************/
kal_bool l4crac_set_switch_modem_cause(kal_uint8 cause, plmn_id_rat_info_struct plmn_info);
