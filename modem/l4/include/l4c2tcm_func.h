...
kal_bool l4ctcm_get_binding_channel(kal_uint8 cid, kal_uint32 *binding_channel);
...
/* +CGPADDR (No set) */
kal_bool l4ctcm_get_nw_applied_pdp_addr(kal_uint8 cid, kal_uint8 *length, kal_uint8 *addr, kal_bool c2k_irat_ongoing);
...
extern void l4ctcm_get_pdn_info(pdn_info_struct *pdn_info, kal_uint8 cid);
