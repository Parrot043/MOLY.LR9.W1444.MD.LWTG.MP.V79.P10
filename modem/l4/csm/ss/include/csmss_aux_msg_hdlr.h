...
void csmss_send_ilm(module_type dest_id, kal_uint16 msg_id, void *local_para,
                    void *peer_buff);
...
//extern kal_bool csmss_is_smu_sim_replaced(kal_uint8 simInterface);
...
extern kal_bool csmss_is_smu_sim_replaced(void);
...
kal_uint8 l4c_get_csmss_g_ss_id(void);

#define CSMSS_MO_INVOKE_ID 0
...
USSD_DCS->octs[0] = csmss_g_ussd_dcs;
