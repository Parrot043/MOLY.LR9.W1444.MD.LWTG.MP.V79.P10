...
extern void rac_send_duplex_mode_change_req(module_type dest);
extern void rac_send_duplex_mode_change_cnf(kal_bool result, l4c_source_id_enum src_id);
...
//Tim
extern void rac_gmss_send_attach_req(local_para_struct *local_para_ptr, domain_id_enum requested_service);
extern void rac_gmss_send_detach_req(kal_bool is_poweroff);
...
/* MOLY00083802 rac_hardware_support_band_filter is replaced by mrs_uas_hardware_support_band_filter */
...
/*****************************************************************************
 * FUNCTION
 *  rac_send_em_abnormal_no_service_msg
 *
 * DESCRIPTION
 *  send MSG_ID_EM_ABNORMAL_EVENT_RAC_NO_SERVICE_IND for EM log
 *
 * PARAMETERS
 *  none
 *
 ...
 *
 *****************************************************************************/
void rac_send_em_abnormal_no_service_msg();
