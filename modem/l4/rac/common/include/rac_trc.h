...
TRC_MSG(RAC_TRC_rac_send_em_abnormal_no_service_msg, "[RAC] rac_send_em_abnormal_no_service_msg()")
...
TRC_MSG(RAC_GET_SERVICE_DOMAIN, "[RAC] rac_ug_get_service_domain from auto_attach: %Mkal_bool, mobile_class: %Mms_mobile_class_enum, search_type: %Mmm_user_search_type_enum, tmp_requested_service: %Mdomain_id_enum")
...
TRC_MSG(RAC_DISABLE_INTEGRITY_CHECK_SETTING, "[RAC] is_disable_integrity_check: %Mkal_bool")
...
TRC_MSG(RAC_IRAT_SYNC_CS_PS, "[RAC] Set %Mdomain_id_enum to UNKNOWN")

TRC_MSG(RAC_SIM_REPLACED_CLEAN_EPSLOCI_NSC_TIN, "[RAC] SIM%d replaced! Clean EPS LOCI/NSC/TIN in the NVRAM")
TRC_MSG(RAC_CHANGE_USAGE_SETTING_BY_SIM, "[RAC] Change usage setting by sim to %Mue_usage_setting_enum")
...
TRC_MSG(RAC_TRC_UNEXPECTED_REPORTED_RAT_MODE, "[RAC] unexpected reported RAT mode: %d")
#ifdef __LTE_RAT__
...
/*--------------------TRACE_ERROR Class--------------------*/
TRC_MSG(RAC_TRC_ERROR_ACTION_CONFLICT,"[RAC]ori: %Mrac_action_enum, new: %Mrac_action_enum")
