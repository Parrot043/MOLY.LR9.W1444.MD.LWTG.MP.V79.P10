...
typedef enum
{
    ...
    RAC_CALLBACK_PS_PREVIOUS_STATE = 2,
    RAC_CALLBACK_TYPE_MAX_NUM
} rac_call_back_type_enum;

typedef enum
{
    RAC_AP_PROJECT_TYPE_NOT_SPECIFIED = 0,
    RAC_AP_PROJECT_TYPE_BASIC = 1,
    RAC_AP_PROJECT_TYPE_BSP = 2,
    RAC_AP_PROJECT_TYPE_TURNKEY = 3
