...
ERfTestRfId EPHY_RF_GetRfId( void )
{
#if IS_EL1_RF_MT6169
   return ERF_TEST_RFID_MT6169;
#else
   return ERF_TEST_RFID_NULL;
#endif
}
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */

ERfTestAfcType EPHY_RF_GetCrystalType( void )
{
#ifdef AFC_VCXO
   return ERF_TEST_AFC_TYPE_VCXO;
#else
   return ERF_TEST_AFC_TYPE_TCVCXO;
#endif
}
/* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ */

kal_uint32 EPHY_RF_GetCrystalCapIdRange( void )
{
#ifdef AFC_VCXO
   return LTE_CRYSTAL_CAPID_RANGE;
#else
   return 0;
#endif
}
