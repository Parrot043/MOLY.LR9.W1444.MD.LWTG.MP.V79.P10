...
extern kal_bool is_rac_tcm_cmd_conflict(kal_uint8 src_id, kal_uint16 action);

extern kal_bool is_smu_cmd_conflict(kal_uint8 src_id, kal_uint16 action);

extern l4c_gprs_cmd_conflict_cause_enum is_tcm_cmd_conflict(kal_uint8 cid, kal_uint8 src_id, kal_uint16 action);

extern l4c_gprs_cmd_conflict_cause_enum is_tcm_cmd_conflict_basic(kal_uint8 cid, kal_uint8 src_id, kal_uint16 action); //maui_01895693, mtk02285
...
extern void l4c_cc_set_ims_call_exist(vdm_voice_status_enum status);
extern kal_bool l4c_cc_check_ims_call_exist(kal_uint8 src_id);
#endif
...
extern sim_interface_enum l4c_internal_get_actual_nvram_rec_id(sim_interface_enum sim_ps_id);
#endif
