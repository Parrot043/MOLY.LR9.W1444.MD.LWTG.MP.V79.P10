...
extern void l4c_ut_check_l4c_context_info(kal_uint8 src_id, kal_uint8 cid, l4c_action_enum tcm_current_action, l4c_action_enum context_current_action);
...
extern void tst_inject_string_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr, module_type src_mod_id);
