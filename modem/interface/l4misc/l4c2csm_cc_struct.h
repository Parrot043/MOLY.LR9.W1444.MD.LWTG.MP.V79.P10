...
typedef enum
{
   ...
   SRVCC_ECC_CATEGORY_GAS = 0x0020,
   SRVCC_ECC_CATEGORY_ANIMAL = 0x0040,
   SRVCC_ECC_CATEGORY_PHYSICIAN = 0x0080,   
   SRVCC_ECC_CATEGORY_POISON = 0X0100,
...
typedef struct {
    ...
    kal_uint8 srvcc_number[MAX_CC_ADDR_LEN];
    kal_bool srvcc_alpha_present;
    kal_uint8 srvcc_alpha[MAX_PS_NAME_SIZE + 1]; // MAX_PS_NAME_SIZE: 42
