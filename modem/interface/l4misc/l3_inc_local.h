...
typedef struct {
    plmn_id_struct plmn_id;
    kal_uint8 plmn_id_source;// 0: PLMN SEARCH PROC; 1: CELL RESELECTION PROC ; 255:INVALID PROC;
    kal_uint8 rat;  /* rat_enum */
} plmn_id_rat_info_struct;

typedef struct {
    kal_uint8          plmn_count;
    plmn_id_rat_info_struct plmn_id_rat[RAC_MAX_NUM_LISTED_PLMNS];
} rac_plmn_id_rat_info_struct;
