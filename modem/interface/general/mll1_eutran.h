...
#if defined (__SRVCC_CDRX_ENHANCEMENT__)
/*****************************************************************************
* STRUCT
*   el1_ll1_auto_gap_available_ind_struct
*
* DESCRIPTIONS
*   EL1 sends this message to inform LL1 that the auto_gap is available
* PARAMETERS
*   LOCAL_PARA_HDR
*   is_for_srvcc - indicate if start the srvcc enhancement process.
*   note: the auto gap available process will run as normal, did not be affected by the value of is_for_srvcc.
*****************************************************************************/
typedef struct
{
   LOCAL_PARA_HDR
   kal_bool    is_for_srvcc;
}el1_ll1_auto_gap_available_ind_struct;
#endif /*__SRVCC_CDRX_ENHANCEMENT__*/
/*****************************************************************************
* STRUCT
