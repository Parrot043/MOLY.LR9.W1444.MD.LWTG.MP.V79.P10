...
#define    RF_SETTING_BY_NVRAM   KAL_FALSE
#else
#define    RF_SETTING_BY_NVRAM   KAL_TRUE
#endif

#if IS_MML1_DRDI_REMAP_ENABLE
kal_bool    USE_MML1_DRDI_ReMap = KAL_TRUE;
#else
...
kal_uint16 ul1custom_total_real_set_nums = UL1CUSTOM_TOTAL_REAL_SET_NUMS;
