...
#include "L1Trc.h"
	...
	#define CCCI_RELOAD_GPD_TRACE(v1, v2, v3, v4) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_4_word(0x041B | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define CCCI_ULBUFF_CB_DATA_TRACE(v1, v2, v3, v4, v5) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_5_word(0x061B | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	...
	#define CCCI_DATA_DUMP_TRACE(v1, v2, v3, v4, v5, v6, v7) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_7_word(0x071B | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7));\
	} while(0)
#else
	...
	#define CCCI_IMS_DATA_DUMP_TRACE(v1, v2, v3, v4, v5, v6) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_6_word(0x081B | ((short)(v1) << 16), (long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6));\
	} while(0)
#else
	...
	#define CCCI_IMS_UL_LATENCY(v1, v2, v3, v4, v5, v6) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_6_word(0x091B | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4), (long)(v5), (long)(v6));\
	} while(0)
#else
	...
	#define CCCI_IMS_DL_LATENCY(v1, v2, v3, v4, v5) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x40)!=0 )\
			l2trc_send_5_word(0x0A1B | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4), (long)(v5));\
	} while(0)
#else
	...
	#define CCCI_FS_DATA_DUMP_TRACE(v1, v2, v3, v4, v5, v6, v7) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[1]&0x80)!=0 )\
			l2trc_send_7_word(0x0B1B | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7));\
	} while(0)
#else
	...
	#define CCCI_DEBUG_ADD_SEQ_TRACE(v1, v2, v3, v4, v5) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[2]&0x01)!=0 )\
			l2trc_send_5_word(0x0C1B | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	...
	#define CCCI_DEBUG_CHECK_SEQ_TRACE(v1, v2, v3, v4, v5) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[2]&0x01)!=0 )\
			l2trc_send_5_word(0x0D1B | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	...
	#define HLT_OVER_BOUND_TRACE(v1, v2, v3, v4, v5, v6) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[2]&0x02)!=0 )\
			l2trc_send_6_word(0x0E1B | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6));\
	} while(0)
#else
	...
	#define HLT_OVER_BOUND_AVG_TRACE(v1, v2, v3, v4, v5, v6, v7) do {\
		if(HIF_SRV_Trace_Filter[0]==1 && (HIF_SRV_Trace_Filter[2]&0x02)!=0 )\
			l2trc_send_7_word(0x0F1B | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v7));\
	} while(0)
#else
...
#define ChkL1ClsFltr_HIF_SRV_HLT()	(ChkL1ModFltr_HIF_SRV()&&((HIF_SRV_Trace_Filter[2]&0x02)!=0))
