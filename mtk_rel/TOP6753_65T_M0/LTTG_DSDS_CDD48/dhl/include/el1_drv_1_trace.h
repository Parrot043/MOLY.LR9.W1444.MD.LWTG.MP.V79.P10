...
#define DRV_DSP_ACT_String(v1)  (unsigned char)(v1+121)
#define DRV_Caller_String(v1)  (unsigned char)(v1+124)
#define DRV_Presch_MId_String(v1)  (unsigned char)(v1+131)
#define DRV_Param_Type_String(v1)  (unsigned char)(v1+140)
#define DRV_Phy_Track_String(v1)  (unsigned char)(v1+159)
#define DRV_BW_String(v1)  (unsigned char)(v1+163)
#define DRV_MIB_TYPE_String(v1)  (unsigned char)(v1+171)
#define DRV_RS_String(v1)  (unsigned char)(v1+175)
#define DRV_RNTI_String0(v1)  (unsigned char)(v1+191)
#define DRV_RNTI_String1(v1)  (unsigned char)(v1+207)
#define DRV_RNTI_String2(v1)  (unsigned char)(v1+215)
#define DRV_RECAL_Str(v1)  (unsigned char)(v1+223)
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_SET_AFC_ACQ_MODE() do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6D04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_SET_AFC_ACQ_MODE()
#endif
#define DRV_LOG_SET_AFC_ACQ_MODE_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6D04, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_MD_HST_FLAG(v1, v2, v3, v4, v5) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x6E04, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)));\
	} while(0)
#else
	#define DRV_LOG_MD_HST_FLAG(v1, v2, v3, v4, v5)
#endif
#define DRV_LOG_MD_HST_FLAG_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x6E04, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_GET_HST_MD_STATUS(v1, v2, v3) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x6F04, (short)(v1)), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define DRV_LOG_GET_HST_MD_STATUS(v1, v2, v3)
#endif
#define DRV_LOG_GET_HST_MD_STATUS_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x6F04, (short)(v1)), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_32K_REK_INTERVAL(v1, v2, v3, v4, v5) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x7004, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define DRV_LOG_32K_REK_INTERVAL(v1, v2, v3, v4, v5)
#endif
#define DRV_LOG_32K_REK_INTERVAL_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x7004, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define DRV_LOG_LPM_SOURCE(v1) do {\
		if(EL1_DRV_1_Trace_Filter[0]==1 && (EL1_DRV_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7104, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DRV_LOG_LPM_SOURCE(v1)
#endif
#define DRV_LOG_LPM_SOURCE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x7104, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
void L1TRC_Send_DRV_LOG_SET_AFC_ACQ_MODE(void);
void L1TRC_Send_DRV_LOG_MD_HST_FLAG(short v1, short v2, short v3, short v4, short v5);
void L1TRC_Send_DRV_LOG_GET_HST_MD_STATUS(short v1, unsigned long v2, unsigned long v3);
...
void L1TRC_Send_DRV_LOG_LPM_SOURCE(unsigned char v1);
...
#define ChkL1MsgFltr_DRV_LOG_SET_AFC_ACQ_MODE()	ChkL1ClsFltr_EL1_DRV_1_drv_var_trace()
#define ChkL1MsgFltr_DRV_LOG_MD_HST_FLAG()	ChkL1ClsFltr_EL1_DRV_1_drv_var_trace_2()
#define ChkL1MsgFltr_DRV_LOG_GET_HST_MD_STATUS()	ChkL1ClsFltr_EL1_DRV_1_drv_var_trace()
#define ChkL1MsgFltr_DRV_LOG_32K_REK_INTERVAL()	ChkL1ClsFltr_EL1_DRV_1_drv_var_trace()
#define ChkL1MsgFltr_DRV_LOG_LPM_SOURCE()	ChkL1ClsFltr_EL1_DRV_1_drv_var_trace_2()
