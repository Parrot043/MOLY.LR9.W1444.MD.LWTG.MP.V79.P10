...
#define PHS_Param_Log_Type_String(v1)  (unsigned char)(v1+180)
#define PHS_Track_Mode_String(v1)  (unsigned char)(v1+185)
#define PHS_Mac_Drx_State_String(v1)  (unsigned char)(v1+190)
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SRVCC_QUERY_RTN(v1, v2) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x6201, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_SRVCC_QUERY_RTN(v1, v2)
#endif
#define PHS_LOG_SRVCC_QUERY_RTN_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x6201, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SRVCC_RNTI_RTN() do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6301, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_SRVCC_RNTI_RTN()
#endif
#define PHS_LOG_SRVCC_RNTI_RTN_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6301, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SRVCC_AUTO_TX_GAP(v1) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6401, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define PHS_LOG_SRVCC_AUTO_TX_GAP(v1)
#endif
#define PHS_LOG_SRVCC_AUTO_TX_GAP_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x6401, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SRVCC_RXTX_RTN() do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6501, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_SRVCC_RXTX_RTN()
#endif
#define PHS_LOG_SRVCC_RXTX_RTN_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6501, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SRVCC_SHORT_GAP() do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6601, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_SRVCC_SHORT_GAP()
#endif
#define PHS_LOG_SRVCC_SHORT_GAP_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6601, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_TR32K_PERIOD(v1) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x6701, (unsigned short)(v1)));\
	} while(0)
#else
	#define PHS_LOG_TR32K_PERIOD(v1)
#endif
#define PHS_LOG_TR32K_PERIOD_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x6701, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_TR32K_DRX_PERIOD(v1) do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x6801, (unsigned short)(v1)));\
	} while(0)
#else
	#define PHS_LOG_TR32K_DRX_PERIOD(v1)
#endif
#define PHS_LOG_TR32K_DRX_PERIOD_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x6801, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SRV_CS_RPT() do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6901, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_SRV_CS_RPT()
#endif
#define PHS_LOG_SRV_CS_RPT_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6901, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_CLASSIFY() do {\
		if(EL1_PHS_1_Trace_Filter[0]==1 && (EL1_PHS_1_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6A01, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_CLASSIFY()
#endif
#define PHS_LOG_CLASSIFY_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x6A01, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
void L1TRC_Send_PHS_LOG_SRVCC_QUERY_RTN(unsigned char v1, unsigned short v2);
void L1TRC_Send_PHS_LOG_SRVCC_RNTI_RTN(void);
void L1TRC_Send_PHS_LOG_SRVCC_AUTO_TX_GAP(unsigned long v1);
void L1TRC_Send_PHS_LOG_SRVCC_RXTX_RTN(void);
void L1TRC_Send_PHS_LOG_SRVCC_SHORT_GAP(void);
void L1TRC_Send_PHS_LOG_TR32K_PERIOD(unsigned short v1);
void L1TRC_Send_PHS_LOG_TR32K_DRX_PERIOD(unsigned short v1);
void L1TRC_Send_PHS_LOG_SRV_CS_RPT(void);
...
#define ChkL1MsgFltr_PHS_LOG_SRVCC_QUERY_RTN()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_SRVCC_RNTI_RTN()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_SRVCC_AUTO_TX_GAP()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_SRVCC_RXTX_RTN()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_SRVCC_SHORT_GAP()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_TR32K_PERIOD()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace_2()
#define ChkL1MsgFltr_PHS_LOG_TR32K_DRX_PERIOD()	ChkL1ClsFltr_EL1_PHS_1_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_SRV_CS_RPT()	ChkL1ClsFltr_EL1_PHS_1_phs_flow_trace()
