...
#define DCXO_DIV_LPM_CNT_UPDATE_NOFLTR(v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x022F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
	...
	#define DCXO_DIV_LPM_CNT_END(v1, v2, v3, v4, v5, v6, v7) do {\
		if(DCXO_DIV_1_Trace_Filter[0]==1 && (DCXO_DIV_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_7_DATA(TRC_MERGE_2S(0x032F, (short)(v7)), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6));\
	} while(0)
#else
	#define DCXO_DIV_LPM_CNT_END(v1, v2, v3, v4, v5, v6, v7)
#endif
#define DCXO_DIV_LPM_CNT_END_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_7_DATA(TRC_MERGE_2S(0x032F, (short)(v7)), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6))
...
#define DCXO_DIV_PCM_CNT_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x072F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
	...
	#define DCXO_DIV_DBG_Check(v1, v2) do {\
		if(DCXO_DIV_1_Trace_Filter[0]==1 && (DCXO_DIV_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x082F, (unsigned short)(v1)), (long)(v2));\
	} while(0)
#else
	#define DCXO_DIV_DBG_Check(v1, v2)
#endif
#define DCXO_DIV_DBG_Check_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x082F, (unsigned short)(v1)), (long)(v2))

#if defined(L1_CATCHER)
	#define DCXO_DIV_DBG_LOG(v1, v2, v3) do {\
		if(DCXO_DIV_1_Trace_Filter[0]==1 && (DCXO_DIV_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x092F, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define DCXO_DIV_DBG_LOG(v1, v2, v3)
#endif
#define DCXO_DIV_DBG_LOG_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x092F, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3))
	...
	#define DCXO_DIV_DBG_ENTER_26MHz_FPM(v1, v2, v3) do {\
		if(DCXO_DIV_1_Trace_Filter[0]==1 && (DCXO_DIV_1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0A2F, (short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define DCXO_DIV_DBG_ENTER_26MHz_FPM(v1, v2, v3)
#endif
#define DCXO_DIV_DBG_ENTER_26MHz_FPM_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0A2F, (short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
