...
#include "L1Trc.h"
	...
	#define ERT_ILM_OUT_2(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0612 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define ERT_ILM_EL1_DRV_IN(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0712 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	#define ERT_ILM_EL1_DRV_IN(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define ERT_ILM_EL1_DRV_OUT(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0812 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	#define ERT_ILM_EL1_DRV_OUT(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define ERT_ILM_PDCCH_IND_IN(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0912 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	#define ERT_ILM_PDCCH_IND_IN(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define ERT_ILM_PDCCH_IND_OUT(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0A12 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	#define ERT_ILM_PDCCH_IND_OUT(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define ERT_ILM_TX_REQ_IN(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0B12 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	#define ERT_ILM_TX_REQ_IN(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define ERT_ILM_TX_REQ_OUT(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0C12 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	#define ERT_ILM_TX_REQ_OUT(v1, v2)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define ENTER_DSP_TIMER_HISR_IN(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0D12 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ENTER_DSP_TIMER_HISR_IN_2(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0E12 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define POLL_CYCLES(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0F12 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ENTER_DSP_TIMER_HISR_OUT(v1, v2, v3, v4) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_4_word(0x1012 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ENTER_DSP_TIMER_HISR_OUT_2(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_3_word(0x1112 | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define PROTECT(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x1212 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_PROCESS_EPSB_DL_CYCLES(v1, v2, v3) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_3_word(0x1312 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define LTM_PROCESS_UL_SDU(v1, v2, v3, v4) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_4_word(0x1412 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define LTM_RCV_UL(v1, v2) do {\
		if(EDATA_PATH_DETAIL_Trace_Filter[0]==1 && (EDATA_PATH_DETAIL_Trace_Filter[1]&0x04)!=0 )\
			l2trc_send_2_word(0x1512 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
...
void L1TRC_Send_ERT_ILM_EL1_DRV_IN(unsigned short v1, unsigned long v2);
void L1TRC_Send_ERT_ILM_EL1_DRV_OUT(unsigned short v1, unsigned long v2);
void L1TRC_Send_ERT_ILM_PDCCH_IND_IN(unsigned short v1, unsigned long v2);
void L1TRC_Send_ERT_ILM_PDCCH_IND_OUT(unsigned short v1, unsigned long v2);
void L1TRC_Send_ERT_ILM_TX_REQ_IN(unsigned short v1, unsigned long v2);
void L1TRC_Send_ERT_ILM_TX_REQ_OUT(unsigned short v1, unsigned long v2);
...
#define ChkL1MsgFltr_ERT_ILM_EL1_DRV_IN()	ChkL1ClsFltr_EDATA_PATH_DETAIL_EDYN_DFT()
#define ChkL1MsgFltr_ERT_ILM_EL1_DRV_OUT()	ChkL1ClsFltr_EDATA_PATH_DETAIL_EDYN_DFT()
#define ChkL1MsgFltr_ERT_ILM_PDCCH_IND_IN()	ChkL1ClsFltr_EDATA_PATH_DETAIL_EDYN_DFT()
#define ChkL1MsgFltr_ERT_ILM_PDCCH_IND_OUT()	ChkL1ClsFltr_EDATA_PATH_DETAIL_EDYN_DFT()
#define ChkL1MsgFltr_ERT_ILM_TX_REQ_IN()	ChkL1ClsFltr_EDATA_PATH_DETAIL_EDYN_DFT()
#define ChkL1MsgFltr_ERT_ILM_TX_REQ_OUT()	ChkL1ClsFltr_EDATA_PATH_DETAIL_EDYN_DFT()
