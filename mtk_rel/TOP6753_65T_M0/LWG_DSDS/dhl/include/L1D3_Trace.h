...
#include "L1Trc.h"
	...
	#define XO_TRACE_VTuneCrt7AREA(v1, v2, v3, v4) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0049, (short)(v3)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v2), (long)(v4));\
	} while(0)
#else
	#define XO_TRACE_VTuneCrt7AREA(v1, v2, v3, v4)
#endif
#define XO_TRACE_VTuneCrt7AREA_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0049, (short)(v3)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v2), (long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define XO_TRACE_FreqCrtUpdate(v1, v2) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0149, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define XO_TRACE_FreqCrtUpdate(v1, v2)
#endif
#define XO_TRACE_FreqCrtUpdate_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0149, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define XO_TRACE_ReadTempADC(v1, v2) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0249, (short)(v1)), (long)(v2));\
	} while(0)
#else
	#define XO_TRACE_ReadTempADC(v1, v2)
#endif
#define XO_TRACE_ReadTempADC_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0249, (short)(v1)), (long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define XO_TRACE_CmpTempPhi(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0349, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1));\
	} while(0)
#else
	#define XO_TRACE_CmpTempPhi(v1)
#endif
#define XO_TRACE_CmpTempPhi_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0349, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define XO_TRACE_Phi2Dac(v1, v2) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0449, (short)(v2)), (long)(v1));\
	} while(0)
#else
	#define XO_TRACE_Phi2Dac(v1, v2)
#endif
#define XO_TRACE_Phi2Dac_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0449, (short)(v2)), (long)(v1))

#if defined(L1_CATCHER)
	#define CH_afc_dbg(v1, v2, v3, v4) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0549, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3), (long)(v4));\
	} while(0)
#else
	#define CH_afc_dbg(v1, v2, v3, v4)
#endif
#define CH_afc_dbg_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0549, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3), (long)(v4))

#if defined(L1_CATCHER)
	#define CH_afc_dbg2(v1, v2, v3, v4) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0649, (short)(v2)), (long)(v1), (long)(v3), (long)(v4));\
	} while(0)
#else
	#define CH_afc_dbg2(v1, v2, v3, v4)
#endif
#define CH_afc_dbg2_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0649, (short)(v2)), (long)(v1), (long)(v3), (long)(v4))

#if defined(L1_CATCHER)
	#define CH_afc_dbg3(v1, v2, v3, v4) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0749, (short)(v1)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v2), (long)(v3));\
	} while(0)
#else
	#define CH_afc_dbg3(v1, v2, v3, v4)
#endif
#define CH_afc_dbg3_NOFLTR(v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0749, (short)(v1)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v2), (long)(v3))

#if defined(L1_CATCHER)
	#define CH_afc_dbg4(v1, v2, v3, v4, v5) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0849, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)));\
	} while(0)
#else
	#define CH_afc_dbg4(v1, v2, v3, v4, v5)
#endif
#define CH_afc_dbg4_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0849, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)))

#if defined(L1_CATCHER)
	#define CH_afc_dbg5(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0949, (short)(v1)));\
	} while(0)
#else
	#define CH_afc_dbg5(v1)
#endif
#define CH_afc_dbg5_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0949, (short)(v1)))

#if defined(L1_CATCHER)
	#define L1D_Trc_DUAL_AFC_L1C_ask(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A49, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trc_DUAL_AFC_L1C_ask(v1)
#endif
#define L1D_Trc_DUAL_AFC_L1C_ask_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A49, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_DUAL_AFC_DAC_Sharing(v1, v2) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B49, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trc_DUAL_AFC_DAC_Sharing(v1, v2)
#endif
#define L1D_Trc_DUAL_AFC_DAC_Sharing_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B49, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_DUAL_AFC_MODE(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C49, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trc_DUAL_AFC_MODE(v1)
#endif
#define L1D_Trc_DUAL_AFC_MODE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C49, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trace_TM_Sync_State(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D49, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trace_TM_Sync_State(v1)
#endif
#define L1D_Trace_TM_Sync_State_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D49, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_TDDM_FCCH_1(v1, v2, v3, v4, v5) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0E49, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), (long)(v4), (long)(v5));\
	} while(0)
#else
	#define L1D_TDDM_FCCH_1(v1, v2, v3, v4, v5)
#endif
#define L1D_TDDM_FCCH_1_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0E49, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), (long)(v4), (long)(v5))

#if defined(L1_CATCHER)
	#define L1D_TDDM_FB(v1, v2, v3) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0F49, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)));\
	} while(0)
#else
	#define L1D_TDDM_FB(v1, v2, v3)
#endif
#define L1D_TDDM_FB_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0F49, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))

#if defined(L1_CATCHER)
	#define L1D_TDDM_SetGap(v1, v2, v3, v4) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1049, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_TDDM_SetGap(v1, v2, v3, v4)
#endif
#define L1D_TDDM_SetGap_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1049, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_TDDM_FBM_SHORT(v1, v2, v3, v4, v5, v6) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x1149, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_TDDM_FBM_SHORT(v1, v2, v3, v4, v5, v6)
#endif
#define L1D_TDDM_FBM_SHORT_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x1149, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_TDDM_SBM(v1, v2, v3, v4) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1249, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_TDDM_SBM(v1, v2, v3, v4)
#endif
#define L1D_TDDM_SBM_NOFLTR(v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1249, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_TDDM_PM(v1, v2, v3) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1349, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_TDDM_PM(v1, v2, v3)
#endif
#define L1D_TDDM_PM_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1349, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_MM_STATE(v1, v2) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1449, (unsigned char)(v1), (unsigned char)(v2)));\
	} while(0)
#else
	#define L1D_MM_STATE(v1, v2)
#endif
#define L1D_MM_STATE_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1449, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER)
	#define L1D_TDDM_AFC_CON(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x1549, (short)(v1)));\
	} while(0)
#else
	#define L1D_TDDM_AFC_CON(v1)
#endif
#define L1D_TDDM_AFC_CON_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1549, (short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1D_Trc_RepeatedACCH(v1, v2, v3, v4, v5, v6) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[1]&0x80)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1649, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), (unsigned char)(v5), (char)(v6)));\
	} while(0)
#else
	#define L1D_Trc_RepeatedACCH(v1, v2, v3, v4, v5, v6)
#endif
#define L1D_Trc_RepeatedACCH_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1649, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), (unsigned char)(v5), (char)(v6)))

#if defined(L1_CATCHER)
	#define L1D_TRC_DEBUG(v1, v2, v3) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1749, (unsigned short)(v1)), (long)(v2), (long)(v3));\
	} while(0)
#else
	#define L1D_TRC_DEBUG(v1, v2, v3)
#endif
#define L1D_TRC_DEBUG_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1749, (unsigned short)(v1)), (long)(v2), (long)(v3))

#if defined(L1_CATCHER)
	#define L1D_TRC_DEBUG_2(v1, v2, v3) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1849, (unsigned short)(v1)), (long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define L1D_TRC_DEBUG_2(v1, v2, v3)
#endif
#define L1D_TRC_DEBUG_2_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1849, (unsigned short)(v1)), (long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER)
	#define L1TST_TRC_DEBUG(v1, v2, v3, v4, v5) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x40)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_2S(0x1949, (unsigned short)(v1)), (long)(v2), (long)(v3), (long)(v4), (long)(v5));\
	} while(0)
#else
	#define L1TST_TRC_DEBUG(v1, v2, v3, v4, v5)
#endif
#define L1TST_TRC_DEBUG_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_2S(0x1949, (unsigned short)(v1)), (long)(v2), (long)(v3), (long)(v4), (long)(v5))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1D_DTS_TRACE_MACHINE(v1, v2, v3) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1A49, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)));\
	} while(0)
#else
	#define L1D_DTS_TRACE_MACHINE(v1, v2, v3)
#endif
#define L1D_DTS_TRACE_MACHINE_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1A49, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))

#if defined(L1_CATCHER)
	#define L1D_TRC_NonSync_HO_Event(v1, v2) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[2]&0x80)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1B49, (unsigned char)(v1), (char)(v2)));\
	} while(0)
#else
	#define L1D_TRC_NonSync_HO_Event(v1, v2)
#endif
#define L1D_TRC_NonSync_HO_Event_NOFLTR(v1, v2) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1B49, (unsigned char)(v1), (char)(v2)))

#if defined(L1_CATCHER)
	#define L1D_Trc_WGG_Event(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1C49, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trc_WGG_Event(v1)
#endif
#define L1D_Trc_WGG_Event_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1C49, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_WGG_ConsumePMQueue(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x1D49, (short)(v1)));\
	} while(0)
#else
	#define L1D_Trc_WGG_ConsumePMQueue(v1)
#endif
#define L1D_Trc_WGG_ConsumePMQueue_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1D49, (short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1D_Trc_WCAL_RESULT(v1, v2, v3) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1E49, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trc_WCAL_RESULT(v1, v2, v3)
#endif
#define L1D_Trc_WCAL_RESULT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1E49, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1D_Trc_HRD_POWER_RESULT(v1, v2, v3) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1F49, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)));\
	} while(0)
#else
	#define L1D_Trc_HRD_POWER_RESULT(v1, v2, v3)
#endif
#define L1D_Trc_HRD_POWER_RESULT_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1F49, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1D_Trc_HRD_RESULT(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2049, (char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trc_HRD_RESULT(v1)
#endif
#define L1D_Trc_HRD_RESULT_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2049, (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_VAMOS_RESULT(v1, v2, v3, v4, v5) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x2149, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_1S2C((short)(v5), (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trc_VAMOS_RESULT(v1, v2, v3, v4, v5)
#endif
#define L1D_Trc_VAMOS_RESULT_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2149, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_1S2C((short)(v5), (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_BLK_RESULT(v1) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x2249, (short)(v1)));\
	} while(0)
#else
	#define L1D_Trc_BLK_RESULT(v1)
#endif
#define L1D_Trc_BLK_RESULT_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2249, (short)(v1)))

#if defined(L1_CATCHER)
	#define L1D_Trc_DLIF_SWITCH_IF(v1, v2) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2349, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trc_DLIF_SWITCH_IF(v1, v2)
#endif
#define L1D_Trc_DLIF_SWITCH_IF_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2349, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_DLIF_PEER_IF(v1, v2, v3, v4, v5, v6) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x2449, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define L1D_Trc_DLIF_PEER_IF(v1, v2, v3, v4, v5, v6)
#endif
#define L1D_Trc_DLIF_PEER_IF_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x2449, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_DLIF_RETURN_IF(v1, v2, v3, v4, v5, v6, v7) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x2549, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v6), (short)(v7)));\
	} while(0)
#else
	#define L1D_Trc_DLIF_RETURN_IF(v1, v2, v3, v4, v5, v6, v7)
#endif
#define L1D_Trc_DLIF_RETURN_IF_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_4_DATA(TRC_MERGE_2S(0x2549, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v6), (short)(v7)))

#if defined(L1_CATCHER)
	#define L1D_TAS_TRC(v1, v2, v3, v4, v5, v6, v7) do {\
		if(L1D_3RD_Trace_Filter[0]==1 && (L1D_3RD_Trace_Filter[3]&0x40)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x2649, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)));\
	} while(0)
#else
	#define L1D_TAS_TRC(v1, v2, v3, v4, v5, v6, v7)
#endif
#define L1D_TAS_TRC_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_4_DATA(TRC_MERGE_2S(0x2649, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)))
...
void L1TRC_Send_L1TST_TRC_DEBUG(unsigned short v1, long v2, long v3, long v4, long v5);
