...
#include "L1Trc.h"
	...
	#define L2_DRV_WARN(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x0041 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2_DRV_INFO_2(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0141 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2_DRV_INFO_3(v1, v2, v3) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0241 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define L2_DRV_INFO(v1, v2, v3, v4) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x0341 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define L2_DRV_ERR_3(v1, v2, v3) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0441 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define L2_DRV_ERR_4(v1, v2, v3, v4) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x0541 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define L2_SHOW_ERR_REG(v1, v2, v3) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x0641 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define L2_EVT_NOT_SUPPORT(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0741 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define L2_LMAC_INIT_FAIL(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x0841 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2_LMAC_RAR_CB_FAIL(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x0941 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2_LMAC_EAR_CB_FAIL(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x0A41 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2_LMAC_UL_EVT_CB_FAIL(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0B41 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2_LMAC_DL_EVT_CB_FAIL(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0C41 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2_LMAC_UL_ERR_CB_FAIL(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0D41 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2_LMAC_DL_ERR_CB_FAIL(v1, v2, v3, v4) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x0E41 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define L2_LMAC_UL_ERR(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x0F41 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2_LMAC_DL_ERR(v1, v2, v3, v4) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x1041 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define L2_LMAC_DL_ERR3_DUMP(v1, v2) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x1141 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2_LMAC_GENERAL_ERR(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x1241 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2_LMAC_UL_UNDERRUN_WARN(v1) do {\
		if(L2_LTE_COPRO_DRV_Trace_Filter[0]==1 && (L2_LTE_COPRO_DRV_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x1341 | ((short)(v1) << 16));\
	} while(0)
#else
