...
#if defined(L1_CATCHER)
	#define UL1I_TRC_CTCH_Delay(v1, v2) do {\
		if(UL1C_PRI2_Trace_Filter[0]==1 && (UL1C_PRI2_Trace_Filter[4]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x9F39, (short)(v1)), (long)(v2));\
	} while(0)
#else
	#define UL1I_TRC_CTCH_Delay(v1, v2)
#endif
#define UL1I_TRC_CTCH_Delay_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x9F39, (short)(v1)), (long)(v2))
...
void L1TRC_Send_UL1I_TRC_CTCH_Delay(short v1, long v2);
