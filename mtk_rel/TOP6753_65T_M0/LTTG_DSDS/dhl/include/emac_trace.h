...
#include "L1Trc.h"
	...
	#define EMAC_LOG_DL_DISCARD_TC_RNTI(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6A0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_SPS_ACT(v1, v2, v3, v4) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x6B0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_SPS_REL(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6C0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_SPS_UPDATE(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x6D0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_SPS_REQ(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x6E0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_CTRL_DATA(v1, v2, v3, v4) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x6F0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_DROP_DL_DATA(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x700D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_DROP_RAR(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x710D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_INIT(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x740D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_MONITOR(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x750D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_DL_INA_TIMER_START(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x770D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_ON_TIMER_START(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x780D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_INA_TMR_STOP(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x7D0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_RTT_TMR_START(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x7E0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_RTT_TMR_STOP(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x7F0D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_SHORT_TMR_EXP(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x810D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_RETX_TMR_STOP(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x830D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_ON_LENGTH(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x840D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_SET_CYCLE_TYPE(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x850D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_SLEEP(v1, v2, v3, v4) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0x860D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_NEXT_PST_TIME(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x880D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_MOD_WAKE_TIME(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x890D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CMD(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x8D0D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CLR_RA_FLAG(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x900D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_ACTIVE_SATATUS(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x910D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_TX_ACTIVE_STATUS(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x920D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_UL_BUF(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x940D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_SEND_CYC_NTF(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x950D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_INVALID_PDCCH(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x960D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_CHANGE_TO_LONG_CYCLE(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x9A0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_UPDATE_SRS_CQI_ADMIN(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0x9B0D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_START(v1, v2, v3, v4) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x9C0D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_ASSIGN_IN_SLEEP(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0x9D0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_PDCCH(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0x9F0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EMAC_LOG_RA_PROBING_REQUEST_COLLISION(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xA20D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	#define EMAC_LOG_RA_PROBING_REQUEST_COLLISION(v1)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EMAC_LOG_RA_RA_ONGOING(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xA30D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_POT_MSG3(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xA40D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_GROUPB(v1, v2, v3, v4) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0xA60D | ((short)(v1) << 16), (long)(v2), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_MSG3_SZ(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xA70D | ((unsigned short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_ASSIGN_RAPID(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xA80D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_GROUP_A_RAPID(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xA90D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_GROUP_B_RAPID(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xAA0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_PRACH_INFO(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xAB0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_STATE(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xAD0D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_COMP(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xAE0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_WND(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xAF0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RAR_RCV(v1, v2, v3, v4) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0xB00D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RAR_GRANT(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xB10D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RAR_OUT_WND(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xB20D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RAR_END_EXP(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xB40D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_PDCCH_RESTART(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xB50D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_BACKOFF(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xB70D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_UL_CCCH_REQ(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xB80D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_CR_TMR_EXP(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xBA0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_UEID_FAIL(v1, v2, v3, v4) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_4_word(0xBB0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EMAC_LOG_RA_TC_CONTAIN_NO_UEID(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xBC0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	#define EMAC_LOG_RA_TC_CONTAIN_NO_UEID(v1)
#endif
	...
	#define EMAC_LOG_RA_RAR_MATCH(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xBE0D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_MSG3_HARQ(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xC00D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RCV_PDCCH(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xC40D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_CHK_DL_CTRL(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xC50D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_CE_CR_SUCCESS(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xC60D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_ABORT(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xC80D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_CFG_RESTART(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xCA0D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_PREAMBLE_COL_TX(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xCC0D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RAR_STATE_ERROR(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xCD0D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_MSG3_FLUSH_WARNING(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xCE0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_PDCCH_COL_UL(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xD10D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_GAP_WARNING(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xD20D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_MSG3_FORCE_CLOSE(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xD30D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_TC_RNTI_DL_WARNING(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xD50D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_TCRNTI_DATA_ERROR(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xD70D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_CCCH_ERROR(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xD80D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RA_ERROR(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xD90D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_UL_CRNTI_CHK_SUS(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xDA0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_NEW_UL_CRNTI_CHK_SUS(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xDB0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_DL_RNTI_CHK_SUS(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xDC0D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_SAVE_MSG3_BUFF(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xDD0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RAR_INT_IN_WRONG_STATE(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xDE0D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RAR_INT_BEROFE_PDCCH_IND(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xDF0D | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_TA_TIMEOUT(v1, v2, v3, v4) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xE00D | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)((char)(v4))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_TA_STOP_CR_TIMER(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xE10D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_TA_CLR_RAR_UL_GRANT(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xE20D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_SMALL_RAR_GRANT(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xE30D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_LMAC_ERR_0(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xE40D | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_LMAC_ERR_1(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xE50D | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_UL_LMAC_ERR_0(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xE60D | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_UL_LMAC_ERR_1(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xE70D | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EMAC_LOG_LMAC_SUBHDR_NUM_ERR(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xE80D | ((short)(v1) << 16));\
	} while(0)
#else
	#define EMAC_LOG_LMAC_SUBHDR_NUM_ERR(v1)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define EMAC_LOG_MAC_CE_LEN_ERROR(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xE90D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DRX_START_PAST_ON(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xEA0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_IDC_IGNORE_TDM_CH_MODE(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xEE0D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_IDC_IGNORE_TDM_HO_RA(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xEF0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_IDC_STOP_SR(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xF00D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_IDC_FORCE_LEAVE_TDM(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xF30D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_IDC_CANCEL_BSR(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xF40D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define EMAC_LOG_ERR_RA_GROUP_A_ERR(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xF50D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_SPS_IN_DRX(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xF70D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_ERR_SPS_GRANT_ERR(v1, v2) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_2_word(0xF80D | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_DL_CCCH_NO_GPD(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xFA0D | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RX_NO_SRB_GPD(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xFB0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define EMAC_LOG_RA_RAR_GRANT_INCONSIST(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xFC0D | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define EMAC_LOG_IDC_PUSCH_TX_REQ(v1, v2, v3) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_3_word(0xFD0D | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define EMAC_LOG_IDC_NULL_TX_REQ(v1) do {\
		if(EMAC_Trace_Filter[0]==1 && (EMAC_Trace_Filter[1]&0x01)!=0 )\
			l2trc_send_1_word(0xFE0D | ((unsigned short)(v1) << 16));\
	} while(0)
#else
...
void L1TRC_Send_EMAC_LOG_RA_PROBING_REQUEST_COLLISION(unsigned short v1);
...
void L1TRC_Send_EMAC_LOG_RA_TC_CONTAIN_NO_UEID(unsigned short v1);
...
void L1TRC_Send_EMAC_LOG_LMAC_SUBHDR_NUM_ERR(short v1);
...
#define ChkL1MsgFltr_EMAC_LOG_TA_OUT_RANGE()	ChkL1ClsFltr_EMAC_EMAC_INFO()
...
#define ChkL1MsgFltr_EMAC_LOG_RA_PROBING_REQUEST()	ChkL1ClsFltr_EMAC_EMAC_INFO()
#define ChkL1MsgFltr_EMAC_LOG_RA_PROBING_REQUEST_COLLISION()	ChkL1ClsFltr_EMAC_EMAC_INFO()
...
#define ChkL1MsgFltr_EMAC_LOG_RA_TC_CONTAIN_NO_UEID()	ChkL1ClsFltr_EMAC_EMAC_INFO()
...
#define ChkL1MsgFltr_EMAC_LOG_LMAC_SUBHDR_NUM_ERR()	ChkL1ClsFltr_EMAC_EMAC_INFO()
