...
#define PHS_Disallow_Sleep_String(v1)  (unsigned char)(v1+97)
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_MB_PBCH_RETRIGGER(v1) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1102, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_MB_PBCH_RETRIGGER(v1)
#endif
#define PHS_LOG_MB_PBCH_RETRIGGER_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1102, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#endif
#define PHS_LOG_SPECIAL_CMD_ADD_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1202, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_WAIT_NBR_BCCH() do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x80)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1302, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_WAIT_NBR_BCCH()
#endif
#define PHS_LOG_WAIT_NBR_BCCH_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1302, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_FINAL_EXE_TIME_DBG(v1, v2) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1402, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_FINAL_EXE_TIME_DBG(v1, v2)
#endif
#define PHS_LOG_FINAL_EXE_TIME_DBG_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1402, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_DISCON_NBR_SI_GET(v1, v2, v3, v4, v5) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1502, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)));\
	} while(0)
#else
	#define PHS_LOG_DISCON_NBR_SI_GET(v1, v2, v3, v4, v5)
#endif
#define PHS_LOG_DISCON_NBR_SI_GET_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1502, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_REDUCE_MEAS_EXE_TIME(v1, v2, v3, v4) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1602, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define PHS_LOG_REDUCE_MEAS_EXE_TIME(v1, v2, v3, v4)
#endif
#define PHS_LOG_REDUCE_MEAS_EXE_TIME_NOFLTR(v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1602, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_EVT_CHG_TYPE(v1) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1702, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_EVT_CHG_TYPE(v1)
#endif
#define PHS_LOG_EVT_CHG_TYPE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1702, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_GET_NXT_NBR_TIMER(v1, v2, v3, v4, v5, v6, v7) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_6_DATA(TRC_MERGE_2S(0x1802, (unsigned short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	#define PHS_LOG_GET_NXT_NBR_TIMER(v1, v2, v3, v4, v5, v6, v7)
#endif
#define PHS_LOG_GET_NXT_NBR_TIMER_NOFLTR(v1, v2, v3, v4, v5, v6, v7) TRC_SEND_6_DATA(TRC_MERGE_2S(0x1802, (unsigned short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_NXT_NBR_TIMER_TO(v1, v2, v3) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1902, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)));\
	} while(0)
#else
	#define PHS_LOG_NXT_NBR_TIMER_TO(v1, v2, v3)
#endif
#define PHS_LOG_NXT_NBR_TIMER_TO_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1902, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_GET_FINAL_NBR_BCCH(v1, v2, v3, v4, v5, v6) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x1A02, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_1S2C((unsigned short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_GET_FINAL_NBR_BCCH(v1, v2, v3, v4, v5, v6)
#endif
#define PHS_LOG_GET_FINAL_NBR_BCCH_NOFLTR(v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x1A02, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_1S2C((unsigned short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_RESET_NBR_TIMER(v1, v2, v3) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1B02, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)));\
	} while(0)
#else
	#define PHS_LOG_RESET_NBR_TIMER(v1, v2, v3)
#endif
#define PHS_LOG_RESET_NBR_TIMER_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1B02, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
...
#endif
#define PHS_LOG_NBR_END_UNFREEZE_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1C02, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_FINAL_NBR_BCCH_STRT(v1, v2) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1D02, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_FINAL_NBR_BCCH_STRT(v1, v2)
#endif
#define PHS_LOG_FINAL_NBR_BCCH_STRT_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1D02, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_STB_NBR_TIMER_TO(v1, v2, v3, v4, v5) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x80)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1E02, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	#define PHS_LOG_STB_NBR_TIMER_TO(v1, v2, v3, v4, v5)
#endif
#define PHS_LOG_STB_NBR_TIMER_TO_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1E02, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_NXT_WAKEUP_TIME(v1, v2, v3) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x80)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1F02, (unsigned char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define PHS_LOG_NXT_WAKEUP_TIME(v1, v2, v3)
#endif
#define PHS_LOG_NXT_WAKEUP_TIME_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1F02, (unsigned char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_GAP_DRX_TRACK_LEN(v1, v2, v3) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2002, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)));\
	} while(0)
#else
	#define PHS_LOG_GAP_DRX_TRACK_LEN(v1, v2, v3)
#endif
#define PHS_LOG_GAP_DRX_TRACK_LEN_NOFLTR(v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2002, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_SKIP_DRX_SLP_IND(v1, v2) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x2102, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define PHS_LOG_SKIP_DRX_SLP_IND(v1, v2)
#endif
#define PHS_LOG_SKIP_DRX_SLP_IND_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x2102, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_NEW_DRX_TRACK_STRT(v1, v2, v3) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x2202, (unsigned short)(v3)), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define PHS_LOG_NEW_DRX_TRACK_STRT(v1, v2, v3)
#endif
#define PHS_LOG_NEW_DRX_TRACK_STRT_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2202, (unsigned short)(v3)), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_TRACK_MODE_CRITERIA(v1, v2, v3, v4) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2302, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_TRACK_MODE_CRITERIA(v1, v2, v3, v4)
#endif
#define PHS_LOG_TRACK_MODE_CRITERIA_NOFLTR(v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2302, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_FWS_ERR_RPT(v1, v2) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x2402, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2));\
	} while(0)
#else
	#define PHS_LOG_FWS_ERR_RPT(v1, v2)
#endif
#define PHS_LOG_FWS_ERR_RPT_NOFLTR(v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x2402, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_RX_WAKEUP(v1, v2, v3) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x2502, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	#define PHS_LOG_RX_WAKEUP(v1, v2, v3)
#endif
#define PHS_LOG_RX_WAKEUP_NOFLTR(v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x2502, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_RX_LAST_TRACK_TIME(v1, v2, v3) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x80)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x2602, (unsigned char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
	} while(0)
#else
	#define PHS_LOG_RX_LAST_TRACK_TIME(v1, v2, v3)
#endif
#define PHS_LOG_RX_LAST_TRACK_TIME_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x2602, (unsigned char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_MB_PBCH_PARAM(v1, v2) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2702, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_MB_PBCH_PARAM(v1, v2)
#endif
#define PHS_LOG_MB_PBCH_PARAM_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2702, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_AUTO_GAP_ST(v1) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2802, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_AUTO_GAP_ST(v1)
#endif
#define PHS_LOG_AUTO_GAP_ST_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2802, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_AUTO_GAP_LEN_FROM_AP(v1) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2902, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
	} while(0)
#else
	#define PHS_LOG_AUTO_GAP_LEN_FROM_AP(v1)
#endif
#define PHS_LOG_AUTO_GAP_LEN_FROM_AP_NOFLTR(v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2902, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_PHY_DVFS(v1, v2) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x2A02, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_PHY_DVFS(v1, v2)
#endif
#define PHS_LOG_PHY_DVFS_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2A02, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define PHS_LOG_NON_SLEEP_CAUSE(v1) do {\
		if(EL1_PHS_2_Trace_Filter[0]==1 && (EL1_PHS_2_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2B02, (unsigned char)(v1), TRC_BOXSTER_PAD));\
	} while(0)
#else
	#define PHS_LOG_NON_SLEEP_CAUSE(v1)
#endif
#define PHS_LOG_NON_SLEEP_CAUSE_NOFLTR(v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2B02, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
void L1TRC_Send_PHS_LOG_MB_PBCH_RETRIGGER(unsigned char v1);
...
void L1TRC_Send_PHS_LOG_MB_PBCH_PARAM(unsigned short v1, unsigned short v2);
void L1TRC_Send_PHS_LOG_AUTO_GAP_ST(unsigned char v1);
void L1TRC_Send_PHS_LOG_AUTO_GAP_LEN_FROM_AP(unsigned long v1);
void L1TRC_Send_PHS_LOG_PHY_DVFS(unsigned char v1, unsigned short v2);
void L1TRC_Send_PHS_LOG_NON_SLEEP_CAUSE(unsigned char v1);
...
#define ChkL1MsgFltr_PHS_LOG_MB_PBCH_RETRIGGER()	ChkL1ClsFltr_EL1_PHS_2_phs_flow_trace()
...
#define ChkL1MsgFltr_PHS_LOG_RX_LAST_TRACK_TIME()	ChkL1ClsFltr_EL1_PHS_2_phs_flow_trace_2()
#define ChkL1MsgFltr_PHS_LOG_MB_PBCH_PARAM()	ChkL1ClsFltr_EL1_PHS_2_phs_var_trace()
...
#define ChkL1MsgFltr_PHS_LOG_PHY_DVFS()	ChkL1ClsFltr_EL1_PHS_2_phs_var_trace()
#define ChkL1MsgFltr_PHS_LOG_NON_SLEEP_CAUSE()	ChkL1ClsFltr_EL1_PHS_2_phs_flow_trace()
