...
#include "L1Trc.h"
	...
	#define RAL_LOG_DL_EPDCP_CNT_2_IPID(v1, v2, v3) do {\
		if(RAL_DETAIL_Trace_Filter[0]==1 && (RAL_DETAIL_Trace_Filter[1]&0x08)!=0 )\
...
#define ChkL1ClsFltr_RAL_DETAIL_RAL_IPID()	(ChkL1ModFltr_RAL_DETAIL()&&((RAL_DETAIL_Trace_Filter[1]&0x08)!=0))
...
#define ChkL1MsgFltr_RAL_LOG_DL_EPDCP_CNT_2_IPID()	ChkL1ClsFltr_RAL_DETAIL_RAL_IPID()
