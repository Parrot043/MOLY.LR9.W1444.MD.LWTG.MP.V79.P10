...
#include "L1Trc.h"
	...
	#define ENTER_DSP_TIMER_LISR_2(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0411 | ((unsigned short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define DSP_EVENT_LISR(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x0611 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define LTM_RESET_EPSB(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x0711 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define LTM_CONSTRUCT_UL_SDU(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x0811 | ((unsigned short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define LTM_UL_TCP_ACK_COPY_FAIL(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x0911 | ((short)(v1) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define LTM_QUEUE_UL_SDU(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_3_word(0x0A11 | ((short)(v1) << 16), (unsigned long)(v2), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define LTM_PROCESS_EPSB_UL_Q(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x0B11 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define LTM_PROCESS_EPSB_DL(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_4_word(0x0C11 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define LTM_ROLLBACK(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x0D11 | ((short)(v1) << 16), (long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define LTM_NXT_DRX_IND(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x0E11 | ((unsigned short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_EPSB_INIT(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x0F11 | ((short)(v1) << 16), (kal_uint32)((char)(v4)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define LTM_IDLE_ENTER(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1211 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_IDLE_ENTER_CHECK(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_2_word(0x1311 | ((short)(v1) << 16), (long)(v2));\
	} while(0)
#else
	...
	#define LTM_IDLE_LEAVE(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x10)!=0 )\
			l2trc_send_3_word(0x1411 | ((short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v2));\
	} while(0)
#else
	...
	#define LTM_IDLE_LEAVE_REJ(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1511 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_IDLE_LEAVE_REJ_DROP(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1611 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define LTM_GEMINI_RESUME(v1, v2) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_2_word(0x1A11 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
...
#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define LTM_QUERY_UL_DATA_STATUS(v1, v2, v3) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x1B11 | ((short)(v1) << 16), (unsigned long)(v2), (long)(v3));\
	} while(0)
#else
	#define LTM_QUERY_UL_DATA_STATUS(v1, v2, v3)
#endif

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define LTM_IDLE_LEAVE_BY_QUERY(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x1C11 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	#define LTM_IDLE_LEAVE_BY_QUERY(v1)
#endif
	...
	#define ETMR_Resume(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_4_word(0x1E11 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_Stop(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_4_word(0x1F11 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v2), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_Init(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x2011 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)((short)(v3))) << 16), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_SetAttri(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x2111 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)((short)(v3))) << 16), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_Set(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x2211 | ((short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)((char)(v2))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v4));\
	} while(0)
#else
	...
	#define ETMR_TickByTicks(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_1_word(0x2411 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ETMR_GetLatestExpire(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_1_word(0x2511 | ((unsigned short)(v1) << 16));\
	} while(0)
#else
	...
	#define ETMR_ExpireEnd(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x2611 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v2)) | (((kal_uint32)((char)(v4))) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define ETMR_InitMayFail(v1, v2, v3, v4) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x20)!=0 )\
			l2trc_send_3_word(0x2711 | ((unsigned short)(v1) << 16), (kal_uint32)((short)(v3)) | (((kal_uint32)((short)(v4))) << 16), (unsigned long)(v2));\
	} while(0)
#else
	...
	#define L2COPRO_STATE_ON_TO_WAIT_OFF(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_1_word(0x2A11 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2COPRO_STATE_WAIT_OFF_TO_OFF(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_1_word(0x2B11 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define L2COPRO_STATE_WAIT_OFF_TO_ON(v1) do {\
		if(EDATA_PATH_Trace_Filter[0]==1 && (EDATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_1_word(0x2C11 | ((short)(v1) << 16));\
	} while(0)
#else
...
void L1TRC_Send_LTM_QUERY_UL_DATA_STATUS(short v1, unsigned long v2, long v3);
void L1TRC_Send_LTM_IDLE_LEAVE_BY_QUERY(unsigned short v1);
...
#define ChkL1MsgFltr_LTM_QUERY_UL_DATA_STATUS()	ChkL1ClsFltr_EDATA_PATH_LTM_INFO()
#define ChkL1MsgFltr_LTM_IDLE_LEAVE_BY_QUERY()	ChkL1ClsFltr_EDATA_PATH_LTM_INFO()
