...
#include "L1Trc.h"
	...
	#define UPCM_TestLoopAct(v1, v2, v3) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_2_word(0x1A13 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)((char)(v3))) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24));\
	} while(0)
#else
	...
	#define UPCM_SetEPSB_IMS_Type(v1, v2, v3) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_3_word(0x1B13 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define UPCM_ClrEPSB_IMS_Type(v1, v2, v3) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x02)!=0 )\
			l2trc_send_3_word(0x1C13 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (unsigned long)(v3));\
	} while(0)
#else
	...
	#define TFTPF_AddPFLink(v1, v2, v3) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x1D13 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define TFTPF_RemovePFLink(v1, v2, v3) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x1E13 | ((short)(v1) << 16), (long)(v2), (long)(v3));\
	} while(0)
#else
	...
	#define TFTPF_GetNoPF_EBI(v1) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_1_word(0x1F13 | ((short)(v1) << 16));\
	} while(0)
#else
	...
	#define TFTPF_ActvEPSB(v1, v2, v3) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x2013 | ((short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v2));\
	} while(0)
#else
	...
	#define TFTPF_DeactEPSB(v1, v2, v3) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x2113 | ((short)(v1) << 16), (kal_uint32)((char)(v3)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v2));\
	} while(0)
#else
	...
	#define TFTPF_AddPF(v1, v2, v3, v4) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_4_word(0x2213 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v3), (long)(v4));\
	} while(0)
#else
	...
	#define TFTPF_ReplacePF(v1, v2, v3) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x2313 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v3));\
	} while(0)
#else
	...
	#define TFTPF_DelPF(v1, v2, v3) do {\
		if(NAS_DATA_PATH_Trace_Filter[0]==1 && (NAS_DATA_PATH_Trace_Filter[1]&0x08)!=0 )\
			l2trc_send_3_word(0x2413 | ((short)(v1) << 16), (kal_uint32)((char)(v2)) | (((kal_uint32)TRC_L2_PAD) << 8) | (((kal_uint32)TRC_L2_PAD) << 16) | (((kal_uint32)TRC_L2_PAD) << 24), (long)(v3));\
	} while(0)
#else
