...
#include "L1Trc.h"
	...
	#define MD_TOPSM_TRC_CALIBRATION(v1, v2, v3) do {\
		if(MD_TOPSM_1_Trace_Filter[0]==1 && (MD_TOPSM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0047, (unsigned short)(v1)), (long)(v2), (long)(v3));\
	} while(0)
#else
	#define MD_TOPSM_TRC_CALIBRATION(v1, v2, v3)
#endif
#define MD_TOPSM_TRC_CALIBRATION_NOFLTR(v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0047, (unsigned short)(v1)), (long)(v2), (long)(v3))

#if defined(L1_CATCHER)
	#define MD_TOPSM_TRC_RESOURCE_SET(v1, v2) do {\
		if(MD_TOPSM_1_Trace_Filter[0]==1 && (MD_TOPSM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0147, (unsigned short)(v1)), (long)(v2));\
	} while(0)
#else
	#define MD_TOPSM_TRC_RESOURCE_SET(v1, v2)
#endif
#define MD_TOPSM_TRC_RESOURCE_SET_NOFLTR(v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0147, (unsigned short)(v1)), (long)(v2))

#if defined(L1_CATCHER)
	#define MD_TOPSM_TRC_POLLING(v1, v2, v3, v4, v5) do {\
		if(MD_TOPSM_1_Trace_Filter[0]==1 && (MD_TOPSM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_6_DATA(TRC_MERGE_1S2C(0x0247, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5));\
	} while(0)
#else
	#define MD_TOPSM_TRC_POLLING(v1, v2, v3, v4, v5)
#endif
#define MD_TOPSM_TRC_POLLING_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_6_DATA(TRC_MERGE_1S2C(0x0247, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5))

#if defined(L1_CATCHER)
	#define MD_TOPSM_TRC_BIG_DAC_CALIBRATION(v1, v2, v3, v4, v5) do {\
		if(MD_TOPSM_1_Trace_Filter[0]==1 && (MD_TOPSM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0347, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), (long)(v2), (long)(v5));\
	} while(0)
#else
	#define MD_TOPSM_TRC_BIG_DAC_CALIBRATION(v1, v2, v3, v4, v5)
#endif
#define MD_TOPSM_TRC_BIG_DAC_CALIBRATION_NOFLTR(v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0347, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), (long)(v2), (long)(v5))
