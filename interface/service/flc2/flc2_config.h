 ...
 *============================================================================
 ****************************************************************************/
#ifndef _FLC2_CONFIG_H
#define _FLC2_CONFIG_H
...
#define FLC2_NOT_USED(x)        (void)(x)

/*************************************************************************
 * Macros of Pool
 *************************************************************************/
#define FLC2_POOL_IDX_INFO(_pool_id_, _field_) \
    (flc2_pool_index_g[_pool_id_]._field_)

#define FLC2_POOL_INFO(_pool_id_, _field_) \
    (flc2_pool_g[flc2_pool_index_g[_pool_id_].pool_entity_idx]._field_)

#define FLC2_PROFILE_INFO(_pool_id_, _field_) \
    ((flc2_profile_g[flc2_pool_profile_g[_pool_id_]])._field_)

#define FLC2_POOL_STATISTIC(_pool_id_, _field_) \
    (flc2_pool_statistics[_pool_id_]._field_)

#define FLC2_INIT_POOL_PROTECT(_pool_id_) \
    kal_create_enh_mutex("P_M ## _pool_id_ ##");

#define FLC2_DELETE_POOL_PROTECT(_pool_id_) // Ref by TDD
...
#define FLC2_MB_ADM_CTRL_HEADER(_mb_index_) \
    ((flc2_mb_adm_ctrl_header_struct *) \
     (flc2_mem_block_g[_mb_index_].ctrl_header_ptr))

#define FLC2_MB_FIX_SIZE_CTRL_HEADER(_mb_index_, _field_) \
    (((flc2_mb_fix_size_ctrl_header_struct *) \
      (flc2_mem_block_g[_mb_index_].ctrl_header_ptr))->_field_)
...
#define FLC2_MB_MULTI_SIZE_CTRL_HEADER(_mb_index_) \
    ((flc2_mb_multi_size_ctrl_header_struct *) \
     (flc2_mem_block_g[_mb_index_].ctrl_header_ptr))

#define FLC2_INIT_MB_PROTECT(_mb_index_) { \
    if (FLC2_MB_COMMON_CTRL_HEADER(_mb_index_)->mb_mutex == NULL) { \
        FLC2_MB_COMMON_CTRL_HEADER(_mb_index_)->mb_mutex = \
        kal_create_enh_mutex("F_MB_ ## _mb_index_ ##"); \
    } \
}

#define FLC2_BEGIN_POOL_PROTECT(_pool_id_) { \
    kal_take_enh_mutex(FLC2_MB_COMMON_CTRL_HEADER( \
        FLC2_PROFILE_INFO(_pool_id_, mb_index))->mb_mutex); \
}

#define FLC2_END_POOL_PROTECT(_pool_id_) { \
    kal_give_enh_mutex(FLC2_MB_COMMON_CTRL_HEADER( \
        FLC2_PROFILE_INFO(_pool_id_, mb_index))->mb_mutex); \
}

#define FLC2_DELETE_MB_PROTECT(_mb_index_)  // Ref by TDD
#define FLC2_BEGIN_MB_PROTECT(_mb_index_)   // Ref by TDD
#define FLC2_END_MB_PROTECT(_mb_index_)     // Ref by TDD
 ...
 *************************************************************************/
  ...
  * remember to modify the content of flc2_pool_id_name to keep both sync.
  */
typedef enum {
    ...
    FLC2_POOL_ID_NPDU_UL_03,
    FLC2_POOL_ID_NPDU_UL_04,
    FLC2_POOL_ID_NPDU_UL_05,

    FLC2_POOL_ID_NPDU_DL,               /* 10 */
    FLC2_POOL_ID_PSPDU_ACK_SAPI3_UL,
    FLC2_POOL_ID_PSPDU_ACK_SAPI5_UL,
    FLC2_POOL_ID_PSPDU_ACK_SAPI9_UL,
    FLC2_POOL_ID_PSPDU_ACK_SAPI11_UL,
    FLC2_POOL_ID_PSPDU_ACK_SAPI3_DL,    /* 15 */
    FLC2_POOL_ID_PSPDU_ACK_SAPI5_DL,
    FLC2_POOL_ID_PSPDU_ACK_SAPI9_DL,
    FLC2_POOL_ID_PSPDU_ACK_SAPI11_DL,

    FLC2_POOL_ID_PSPDU_UNACK_PDP0_UL,
    FLC2_POOL_ID_PSPDU_UNACK_PDP1_UL,   /* 20 */
    FLC2_POOL_ID_PSPDU_UNACK_PDP2_UL,
    FLC2_POOL_ID_PSPDU_UNACK_PDP3_UL,
    FLC2_POOL_ID_PSPDU_UNACK_PDP4_UL,
    FLC2_POOL_ID_PSPDU_UNACK_PDP5_UL,
    FLC2_POOL_ID_PSPDU_UNACK_PDP6_UL,   /* 25 */
    FLC2_POOL_ID_PSPDU_UNACK_PDP7_UL,
    FLC2_POOL_ID_PSPDU_UNACK_PDP8_UL,
    FLC2_POOL_ID_PSPDU_UNACK_PDP9_UL,
    FLC2_POOL_ID_PSPDU_UNACK_PDP10_UL,

    FLC2_POOL_ID_PSPDU_UNACK_DL,        /* 30 */
    FLC2_POOL_ID_CIPHER,

    FLC2_POOL_ID_SPDU_UL_0,
    FLC2_POOL_ID_SPDU_UL_1,
    FLC2_POOL_ID_SPDU_UL_2,
    FLC2_POOL_ID_SPDU_UL_3,             /* 35 */
    FLC2_POOL_ID_SPDU_UL_4,
    FLC2_POOL_ID_SPDU_UL_5,
    FLC2_POOL_ID_SPDU_UL_6,
    FLC2_POOL_ID_SPDU_UL_7,
    FLC2_POOL_ID_SPDU_UL_8,             /* 40 */
    FLC2_POOL_ID_SPDU_UL_9,
    FLC2_POOL_ID_SPDU_UL_10,
    FLC2_POOL_ID_SPDU_UL_11,
    FLC2_POOL_ID_SPDU_UL_12,
    FLC2_POOL_ID_SPDU_UL_13,            /* 45 */
    FLC2_POOL_ID_SPDU_UL_14,
    FLC2_POOL_ID_SPDU_UL_15,
    FLC2_POOL_ID_SPDU_UL_16,
    FLC2_POOL_ID_SPDU_UL_17,
    FLC2_POOL_ID_SPDU_UL_18,            /* 50 */
    FLC2_POOL_ID_SPDU_UL_19,
    FLC2_POOL_ID_SPDU_UL_20,
    FLC2_POOL_ID_SPDU_UL_21,
    FLC2_POOL_ID_SPDU_UL_22,
    FLC2_POOL_ID_SPDU_UL_23,            /* 55 */
    FLC2_POOL_ID_SPDU_UL_24,
    FLC2_POOL_ID_SPDU_DL,
    FLC2_POOL_ID_HS,                    // Pool used for hot spot feature
    FLC2_POOL_ID_TPDU,

    FLC2_POOL_ID_IRDA_UL,               /* 60 */
    FLC2_POOL_ID_IRDA_DL,
    FLC2_POOL_ID_MAC_DL,

    FLC2_POOL_ID_NPDU_UL_FWD,
    FLC2_POOL_ID_NPDU_UL_FWD_01,        // For MBIM/ECM DHCP
    FLC2_POOL_ID_NPDU_UL_FWD_02,        /* 65 */

    FLC2_POOL_ID_LLC_SUPERVISORY_DL,

    FLC2_POOL_ID_INTERNAL_UL,           // For LTE internal UL data
    FLC2_POOL_ID_NET_UL_SHARED,         // For LTE NET_UL_SHRD (VoLTE data)
    FLC2_POOL_ID_HIFSMALL_UL,           // For LTE UL ACK
    FLC2_POOL_ID_HIF_UL_02,             // For LTE HIF_UL_02 pool
...
typedef enum {
    ...
    FLC2_PROFILE_INDEX_MAC_DL,
    FLC2_PROFILE_INDEX_NPDU_UL_FWD,
    FLC2_PROFILE_INDEX_LLC_SUPERVISORY_DL,
    FLC2_PROFILE_INDEX_INTERNAL_UL,
    FLC2_PROFILE_INDEX_NET_UL_SHARED,
    FLC2_PROFILE_INDEX_HIFSMALL_UL,
    FLC2_PROFILE_INDEX_HIF_UL_02,
...
typedef enum {
    FLC2_MB_INDEX_0,    /* for APPDU UL/DL */
    FLC2_MB_INDEX_1,    /* for CSPDU UL/DL */
    FLC2_MB_INDEX_3,    /* for NPDU DL, PSPDU DL (GPRS) */
    FLC2_MB_INDEX_4,    /* for IRDA UL/DL*/
    FLC2_MB_INDEX_6,    /* for MAC DL */
    FLC2_MB_INDEX_10,   /* for NPDU UL, PSPDU UL, Cipher (GPRS) */
    FLC2_MB_INDEX_11,   /* for SPDU UL, TPDU */
    FLC2_MB_INDEX_12,   /* for SPDU DL */
    FLC2_MB_INTERNAL_UL,/* for LTE INTERNAL_UL pool */
    FLC2_MB_HIFSMALL_UL,/* for LTE HIF SMALL UL pool */
    FLC2_MB_HIF_UL_02,  /* for LTE HIF_UL_02 pool */
    FLC2_MB_INDEX_MDI,  /* for MDI, FLC2 internal use */
...
typedef struct {
    ...
    /* All the control information will be maintained in the header,
     * different mm_types have differ control header
     */
    void *                    ctrl_header_ptr;
    kal_uint32                *subblock;
#if !defined(__UMTS_TDD128_MODE__) || defined(__3G_NEW_DATA_PLANE_ARCH__)
 ...
 *************************************************************************/
typedef void (*flc2_reg_callback_func_ptr)(flc2_thres_hit_enent_enum,
    flc2_pool_id_enum, void *);

typedef void (*flc2_pool_status_func_ptr)(flc2_pool_status_enum status);

typedef struct {
    kal_uint32  size;
#if !defined(__UMTS_TDD128_MODE__) || defined(__3G_NEW_DATA_PLANE_ARCH__)
    kal_uint32  private_size;
#endif
...
typedef struct {
    ...
    // 0xF0 means pkt_no_upper_thres to be reported
    // 0x0F means size upper thres to be reported
    kal_uint8   thres_reported;
#if !defined(__UMTS_TDD128_MODE__) || defined(__3G_NEW_DATA_PLANE_ARCH__)
    kal_bool    resume_related_pools;
#else
...
typedef struct {
    ...
    flc2_pool_status_enum pool_status;
...
typedef struct {
    ...
    flc2_pool_status_func_ptr       pool_status_fptr;
} flc2_context_info_struct;

/*************************************************************************
 * Macros of Callback functionality
 *************************************************************************/
extern void flc2_npdu_ul_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_npdu_dl_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_appdu_ul_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_appdu_dl_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_cspdu_ul_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_cspdu_dl_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_pspdu_ul_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_pspdu_dl_ack_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_pspdu_dl_unack_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_spdu_ul_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_spdu_dl_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_tpdu_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_irda_ul_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_cipher_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_npdu_dl_callback_ratdm(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_sdu_dl_callback_ratdm(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
extern void flc2_spdu_hs_callback(flc2_thres_hit_enent_enum event,
    flc2_pool_id_enum pool_id, void *user_info_ptr);
...
#define FLC2_MAC_DL_SUB_POOL_MAX_SIZE  5400

#endif /* _FLC2_CONFIG_H */
