...
#define TASK_PRIORITY_DHL_MON          (KAL_PRIORITY_CLASS24 + 8)
#endif
...
/*************************Task CFG Begin******************/
#if defined(__DHL_MODULE__) && defined(__MTK_TARGET__) && !defined(L1_SIM) && defined(__DHL_MONITOR_MODE_SUPPORT__)
/*task_indx_type*/
