...
BUFFER_WHITELIST_DECLARE("mrs_gas_capability.c", "MRS", MOD_MRS_2, 1)
#if (GEMINI_PLUS >= 3)
BUFFER_WHITELIST_DECLARE("mrs_gas_capability.c", "MRS", MOD_MRS_3, 1)
#if (GEMINI_PLUS >= 4)
BUFFER_WHITELIST_DECLARE("mrs_gas_capability.c", "MRS", MOD_MRS_4, 1)
#endif /* GEMINI_PLUS >= 4 */
#endif /* GEMINI_PLUS >= 3 */
#endif /* __GEMINI__ */
...
#ifdef  __UMTS_RAT__
BUFFER_WHITELIST_DECLARE("mac_cfg_ciphering.c", "UL2", MOD_UMAC, 3)
#endif

#ifdef __CDMA2000_RAT__
BUFFER_WHITELIST_DECLARE("gmss_sim_access.c", "NWSEL", MOD_GMSS, 4)
#endif
BUFFER_WHITELIST_DECLARE("nwsel_ctrl_ilm_com.c", "NWSEL", MOD_NWSEL , 1) 
#if defined(__GEMINI__) || defined(__SGLTE__)
BUFFER_WHITELIST_DECLARE("gmss_sim_access.c", "NWSEL", MOD_GMSS_2, 4)
BUFFER_WHITELIST_DECLARE("nwsel_ctrl_ilm_com.c", "NWSEL", MOD_NWSEL_2 , 1) 
#if (GEMINI_PLUS >= 3)
BUFFER_WHITELIST_DECLARE("gmss_sim_access.c", "NWSEL", MOD_GMSS_3, 4)
BUFFER_WHITELIST_DECLARE("nwsel_ctrl_ilm_com.c", "NWSEL", MOD_NWSEL_3 , 1) 
#if (GEMINI_PLUS >= 4)
BUFFER_WHITELIST_DECLARE("gmss_sim_access.c", "NWSEL", MOD_GMSS_4, 4)
BUFFER_WHITELIST_DECLARE("nwsel_ctrl_ilm_com.c", "NWSEL", MOD_NWSEL_4 , 1) 
#endif /* GEMINI_PLUS >= 4 */
#endif /* GEMINI_PLUS >= 3 */
#endif /* __GEMINI__ */
