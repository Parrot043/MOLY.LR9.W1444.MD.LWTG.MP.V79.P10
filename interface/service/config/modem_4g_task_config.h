...
#define TASK_PRIORITY_ERT          (KAL_PRIORITY_CLASS0 + 9)
 /* IT task priority */
#define TASK_PRIORITY_EL1TX_IT     (KAL_PRIORITY_CLASS2 + 4)
#define TASK_PRIORITY_ETEST        (KAL_PRIORITY_CLASS2 + 5)
/* multi mode LL1*/
#define TASK_PRIORITY_MLL1         (KAL_PRIORITY_CLASS2 + 7)
#define TASK_PRIORITY_EL1          (KAL_PRIORITY_CLASS3 + 4)
#define TASK_PRIORITY_EL1IT        (KAL_PRIORITY_CLASS3 + 6)
#define TASK_PRIORITY_EL2          (KAL_PRIORITY_CLASS5 + 4)
#define TASK_PRIORITY_EL2IT        (KAL_PRIORITY_CLASS5 + 6)
...
#define TASK_PRIORITY_ERRC         (KAL_PRIORITY_CLASS6 + 5)
#define TASK_PRIORITY_D_ERRC       (KAL_PRIORITY_CLASS6 + 6)
#define TASK_PRIORITY_EMM          (KAL_PRIORITY_CLASS8 + 3)
#define TASK_PRIORITY_ESM          (KAL_PRIORITY_CLASS8 + 4)
#define TASK_PRIORITY_EVAL         (KAL_PRIORITY_CLASS10+ 3)
#define TASK_PRIORITY_ETC          (KAL_PRIORITY_CLASS10+ 7)
#if defined(__TFTLIB_UT__)
#define TASK_PRIORITY_TFTLIB       (KAL_PRIORITY_CLASS17+ 5)
#endif
#define TASK_PRIORITY_VMMI         (KAL_PRIORITY_CLASS21+ 9)
#if defined(__LTE_RAT__) && defined(__LPP_SUPPORT__)
#define TASK_PRIORITY_LPP          (KAL_PRIORITY_CLASS15+ 1)
#endif /* #if defined(__LTE_RAT__) && defined(__LPP_SUPPORT__) */
#define TASK_PRIORITY_EDSP         (KAL_PRIORITY_CLASS24+ 1)
 ...
 */
#define TASK_PRIORITY_EUTEST (TASK_PRIORITY_DHL - 1)
#else
...
#define TASK_PRIORITY_IMC           (KAL_PRIORITY_CLASS17 + 2)
#define TASK_PRIORITY_SDM           (KAL_PRIORITY_CLASS17 + 3)
#define TASK_PRIORITY_VDM           (KAL_PRIORITY_CLASS17 + 4)
#define TASK_PRIORITY_IMS_PROXY     (KAL_PRIORITY_CLASS17 + 1)
...
#if !defined(__L1EDPS_ENABLE__) && !defined(__EL1_IT__) && !defined(__LPP_SUPPORT__)
task_module_map(INDX_ETSTM, MOD_LPP)
#endif
//task's parameters
...
#if defined(__EDYN_ENABLE__) && !defined(__EDYN_TASK_DISABLE__)
...
task_stack_size(4096)
#if defined(__LTE_RAT__) && defined(__EDYN_ENABLE__) && !defined(EL1_NOT_PRESENT) && !defined(__EL1_TASK_DISABLE__)
...
#endif /* GEMINI_PLUS >= 4 */
#endif /* GEMINI_PLUS >= 3 */
#endif /* defined(__GEMINI__) || defined(__SGLTE__) */
...
task_module_map(INDX_DUMMY_ERRC, MOD_LPP) 
#endif
...
task_index(INDX_ESM) 
/*module_type and mod_task_g*/
task_module_map(INDX_ESM, MOD_ESM)

/*task's parameters*/
task_name("ESM")
task_queue_name("ESM Q")
task_priority(TASK_PRIORITY_ESM, KAL_TASK_INITIAL_PRIORITY)
task_stack_size(4096)

#if defined (__ESM_ENABLE__) && !defined(__ESM_TASK_DISABLE__)
    task_create_function(esm_create)                
#else
    null_task_create_entry(NULL)
#endif
...
#if defined (__EVAL_ENABLE__) && !defined(__EVAL_TASK_DISABLE__)
...
task_module_map(INDX_TFTLIB, MOD_TFTLIB_2)
...
#if defined(__EL2_IT__) || defined(__EL2_FPGA_IT__) || defined(__L2TPS_TEST__)
/*************************Task CFG Begin******************/
/*task_indx_type*/
...
#ifdef __EL1_IT__
#ifndef __EL1_EL2_ERRC_IT__
/*************************Task CFG Begin******************/
/*task_indx_type*/
task_index(INDX_EL1IT) 
/*module_type and mod_task_g*/

task_module_map(INDX_EL1IT, MOD_EL1IT)
task_module_map(INDX_EL1IT, MOD_LPP) 
...
/*************************Task CFG Begin******************/
/*task_indx_type*/
task_index(INDX_EL1TX_IT) 
/*module_type and mod_task_g*/

task_module_map(INDX_EL1TX_IT, MOD_EL1TX_IT)

//task's parameters
task_name("EL1TX_IT")
task_queue_name("EL1TX_IT Q")
task_priority(TASK_PRIORITY_EL1TX_IT, KAL_TASK_INITIAL_PRIORITY)
task_stack_size(2048)
task_create_function(el1tx_it_task_create)
task_stack_internalRAM(KAL_FALSE)
task_external_queue_size(20)
task_internal_queue_size(10)
task_boot_mode(NORMAL_M)
...
/*task_indx_type*/
task_index(INDX_EDSP)

/*module_type and mod_task_g*/  
task_module_map(INDX_EDSP, MOD_DUMMY_EDSP)                           
task_module_map(INDX_EDSP, MOD_EDSP)

//task's parameters                                        
task_name("EDSP")                                         
task_queue_name("EDSP Q")                                 
task_priority(TASK_PRIORITY_EDSP, KAL_TASK_INITIAL_PRIORITY)                         
task_stack_size(1664)
#if defined(ATEST_DRV_ENVIRON)
null_task_create_entry(NULL)
#else
task_create_function(edsp_create) 
#endif
task_stack_internalRAM(KAL_FALSE)                          
task_external_queue_size(0)                               
task_internal_queue_size(0)
