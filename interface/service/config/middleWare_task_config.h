...
#define TASK_PRIORITY_SIM60QBIT    (KAL_PRIORITY_CLASS0 + 7)
#endif  /* __RTL_SIMULATION_FOR_60QBIT__ */
#define TASK_PRIORITY_SSDEBUG      (KAL_PRIORITY_CLASS0 + 8)
#define TASK_PRIORITY_FT           (KAL_PRIORITY_CLASS2 + 6)

/* higher than UL2D */
#define TASK_PRIORITY_LTECSR       (KAL_PRIORITY_CLASS5 + 2)

#ifdef MTK_SYSSERV_DEBUG
#define TASK_PRIORITY_SSDBG1       (KAL_PRIORITY_CLASS11 + 4)
#define TASK_PRIORITY_SSDBG2       (KAL_PRIORITY_CLASS11 + 5)
#endif /* MTK_SYSSERV_DEBUG */

#define TASK_PRIORITY_USBCORE      (KAL_PRIORITY_CLASS12 + 7)
#define TASK_PRIORITY_CLDMACORE    (KAL_PRIORITY_CLASS13 + 3)
#define TASK_PRIORITY_CCIFCORE     (KAL_PRIORITY_CLASS13 + 5)
#define TASK_PRIORITY_UARTCORE     (KAL_PRIORITY_CLASS13 + 6)

#if !defined(__VT_TRANSPORT_SUPPORT__)
#define TASK_PRIORITY_VT           (KAL_PRIORITY_CLASS15 + 4)
#else
#define TASK_PRIORITY_VT           (KAL_PRIORITY_CLASS15 + 9)
#endif

#define TASK_PRIORITY_FTA          (KAL_PRIORITY_CLASS16 + 6)
#define TASK_PRIORITY_FTC          (KAL_PRIORITY_CLASS16 + 8)
/* L4 & FTC run in different boot mode */
#define TASK_PRIORITY_LBS          (KAL_PRIORITY_CLASS17 + 8)
#define TASK_PRIORITY_ETHERCORE    (KAL_PRIORITY_CLASS17 + 9)

#define TASK_PRIORITY_NMU          (KAL_PRIORITY_CLASS18 + 5)
#define TASK_PRIORITY_AOMGR	       (KAL_PRIORITY_CLASS18 + 6)

#define TASK_PRIORITY_SLT_NL_00    (KAL_PRIORITY_CLASS20 + 0)
#define TASK_PRIORITY_PPP          (KAL_PRIORITY_CLASS20 + 6)
#ifdef ATEST_SYS_PFC_SW
#define TASK_PRIORITY_PFC_SW       (KAL_PRIORITY_CLASS9)
#else
#define TASK_PRIORITY_PFC_SW       (KAL_PRIORITY_CLASS20 + 7)//(TASK_PRIORITY_PPP+1)
#endif
#define TASK_PRIORITY_PPP_GPRS      TASK_PRIORITY_PPP
#define TASK_PRIORITY_USBCLASS     (KAL_PRIORITY_CLASS20 + 8)
#define TASK_PRIORITY_CCCIDEV      (KAL_PRIORITY_CLASS20 + 9)

#define TASK_PRIORITY_IPCORE       (KAL_PRIORITY_CLASS21 + 1)

#define TASK_PRIORITY_UPS          (KAL_PRIORITY_CLASS21 + 5)
#define TASK_PRIORITY_USBMSD       (KAL_PRIORITY_CLASS21 + 6)

#define TASK_PRIORITY_BTT          (KAL_PRIORITY_CLASS22 + 5)
#define TASK_PRIORITY_CCCIITDEV1   (KAL_PRIORITY_CLASS22 + 6)
#define TASK_PRIORITY_CCCIITDEV2   (KAL_PRIORITY_CLASS22 + 7)
#define TASK_PRIORITY_CCCIITDEV3   (KAL_PRIORITY_CLASS22 + 8)
#define TASK_PRIORITY_CCCIITDEV4   (KAL_PRIORITY_CLASS22 + 9)

#define TASK_PRIORITY_TTY_UT       (KAL_PRIORITY_CLASS23 + 5) // tty unit test1
#define TASK_PRIORITY_TTY_UT2      (KAL_PRIORITY_CLASS23 + 6) // tty unit test2
#define TASK_PRIORITY_TTY_UT3      (KAL_PRIORITY_CLASS23 + 7) // tty unit test3
#define TASK_PRIORITY_EXCP_TTYUT   (KAL_PRIORITY_CLASS23 + 8) // exception tty ut
#define TASK_PRIORITY_CCCIITFS     (KAL_PRIORITY_CLASS23 + 9)
#define TASK_PRIORITY_SYS_TEST     (KAL_PRIORITY_CLASS24 + 3)

#define TASK_PRIORITY_USBIDLE      (KAL_PRIORITY_CLASS25 + 3) // USB idle task
...
#endif
#if !defined(PPP_NOT_PRESENT) && !defined(__PPP_TASK_DISABLE__)
...
/*************************Task CFG Begin****************/
/*task_indx_type*/
task_index(INDX_PFC_SW) 
/*dummy mod is specified to get task id by mod id, use mod_task_g*/
task_module_map(INDX_PFC_SW,MOD_DUMMY_PFC_SW)
/*module_type and mod_task_g*/
task_module_map(INDX_PFC_SW, MOD_PFC_SW)

/*task's parameters*/
task_name("PFC_SW")
task_queue_name("PFC SW Q")
task_priority(TASK_PRIORITY_PFC_SW , KAL_TASK_INITIAL_PRIORITY )
task_stack_size(1340)
#if !defined(PPP_NOT_PRESENT) && !defined(__PPP_SW_PFC_TASK_DISABLE__)
task_create_function(ppp_sw_pfc_create)
#else
null_task_create_entry(NULL)    
#endif
task_stack_internalRAM(KAL_FALSE)
...
#if defined(__UPS_SUPPORT__) && !defined(__UPS_TASK_DISABLE__)
...
task_stack_size(3072)
#if defined(__MTK_TARGET__) && !defined(__FTA_TASK_DISABLE__)
...
task_module_map(INDX_IPCORE, MOD_LTM)
...
task_stack_size(4096)
#if defined(__MTK_TARGET__) && defined(__CLDMACORE_SUPPORT__) && !defined(CLDMACORE_NOT_PRESENT) && !defined(__CLDMACORE_TASK_DISABLE__)
...
/*************************Task CFG Begin******************/
#if defined (__BTT_AGENT_ENABLE__)
/*task_indx_type*/
task_index(INDX_BTT)
/*module_type and mod_task_g*/
...
task_stack_size(4096)
#if defined(__MTK_TARGET__) && defined(__VOLTE_SUPPORT__)
