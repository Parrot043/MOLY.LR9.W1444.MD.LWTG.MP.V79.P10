...
#define HISR_PRIORITY_BUS_MONITOR           (KAL_PRIORITY_CLASS0 + 3)
...
#if defined (__MTK_TARGET__) //#if defined (__MTK_TARGET__) && defined (__CVSD_CODEC_SUPPORT__) 
...
#if defined (__MTK_TARGET__) && ((defined(MT6595))  || (defined(MT6752) && defined(__MD1__)) || (defined(MT6735))) 
X_HISR_CONST_WITH_INTID((HISR_ID_LISR2HISR_CODE_BEGIN + 58), BUS_MONITOR_MDPERI_HISR , "BUS_MONITOR_MDPERI_HISR", HISR_PRIORITY_BUS_MONITOR, 512, drv_mdperi_busmon_lisr, KAL_FALSE, KAL_INTID_105)
X_HISR_MOD((HISR_ID_DRV_CODE_BEGIN + 58), MOD_LISR2HISR_BUS_MONITOR_MDPERI)
#endif

#if defined (__MTK_TARGET__) && ((defined(MT6595))  || (defined(MT6752) && defined(__MD1__)) || (defined(MT6735)))
X_HISR_CONST_WITH_INTID((HISR_ID_LISR2HISR_CODE_BEGIN + 59), BUS_MONITOR_MDMCU_HISR , "BUS_MONITOR_MDMCU_HISR", HISR_PRIORITY_BUS_MONITOR, 512, drv_mdmcu_busmon_lisr, KAL_FALSE, KAL_INTID_108)
X_HISR_MOD((HISR_ID_DRV_CODE_BEGIN + 59), MOD_LISR2HISR_BUS_MONITOR_MDMCU)
#endif
