...
#define TASK_PRIORITY_XSIM         (KAL_PRIORITY_CLASS0 + 0)
#define TASK_PRIORITY_PROCCPU      (KAL_PRIORITY_CLASS0 + 5)

#define TASK_PRIORITY_L1           (KAL_PRIORITY_CLASS1 + 4)
#define TASK_PRIORITY_L1_2         (KAL_PRIORITY_CLASS1 + 5)
#define TASK_PRIORITY_L1_3         (KAL_PRIORITY_CLASS1 + 6)
#define TASK_PRIORITY_L1_4         (KAL_PRIORITY_CLASS1 + 7)

/* L1 & FT run in different boot mode */
#ifdef  __UMTS_RAT__
#define TASK_PRIORITY_UL1DATA      (KAL_PRIORITY_CLASS2 + 7)
#define TASK_PRIORITY_TL1DATA      (KAL_PRIORITY_CLASS0 + 3)

#define TASK_PRIORITY_UL1C         (KAL_PRIORITY_CLASS3 + 5)
#define TASK_PRIORITY_UL1          (KAL_PRIORITY_CLASS3 + 7)
#define TASK_PRIORITY_TL1          (KAL_PRIORITY_CLASS4 + 4)
#define TASK_PRIORITY_UL2          (KAL_PRIORITY_CLASS4 + 6)
#endif

#ifdef __MTK_UL1_FDD__
#define TASK_PRIORITY_UL1TST       (KAL_PRIORITY_CLASS4 + 3)
#endif

#ifdef  __UMTS_RAT__
#define TASK_PRIORITY_UL2D         (KAL_PRIORITY_CLASS5 + 3)
#endif /* __UMTS_RAT__ */

#if defined(__GEMINI__)
#define TASK_PRIORITY_RSVA         (KAL_PRIORITY_CLASS5 + 5)
#endif

#if (!defined(__LTE_RAT__)) && (!defined(DUMMY_PROTOCOL))
#define TASK_PRIORITY_MRS          (KAL_PRIORITY_CLASS5 + 7)
#endif /* (!defined(__LTE_RAT__)) && (!defined(DUMMY_PROTOCOL)) */

#ifdef  __LTE_RAT__
#define TASK_PRIORITY_EAS          (KAL_PRIORITY_CLASS1 + 9)
#endif

#ifdef __UE_SIMULATOR__
#define TASK_PRIORITY_L2ACCSIM     (KAL_PRIORITY_CLASS4 + 5)  
#define TASK_PRIORITY_L2HWREASMSIM (KAL_PRIORITY_CLASS4 + 7)  
#endif /*__UE_SIMULATOR__*/

#ifdef  __UMTS_RAT__
#define TASK_PRIORITY_URR          (KAL_PRIORITY_CLASS6 + 7)
#define TASK_PRIORITY_D_URR        (KAL_PRIORITY_CLASS6 + 8)
#define TASK_PRIORITY_UL2D_2ND     (KAL_PRIORITY_CLASS6 + 9)//(TASK_PRIORITY_URR + 1)
#endif

#define TASK_PRIORITY_DUMMYMPAL    (KAL_PRIORITY_CLASS7 + 4)

#define TASK_PRIORITY_RR           (KAL_PRIORITY_CLASS7 + 5)
#define TASK_PRIORITY_DUMMYRR      (KAL_PRIORITY_CLASS7 + 6)

#define TASK_PRIORITY_ULCS         (KAL_PRIORITY_CLASS8 + 2)
#define TASK_PRIORITY_REASM        (KAL_PRIORITY_CLASS8 + 5)
#define TASK_PRIORITY_RRLP         (KAL_PRIORITY_CLASS8 + 6)
#define TASK_PRIORITY_RATCM        (KAL_PRIORITY_CLASS8 + 7)
#define TASK_PRIORITY_MM           (KAL_PRIORITY_CLASS9 + 3)
#define TASK_PRIORITY_SIM          (KAL_PRIORITY_CLASS9 + 4)
#define TASK_PRIORITY_SIM2         (KAL_PRIORITY_CLASS9 + 5)
#define TASK_PRIORITY_SIM3         (KAL_PRIORITY_CLASS9 + 6)
#define TASK_PRIORITY_SIM4         (KAL_PRIORITY_CLASS9 + 7)
#define TASK_PRIORITY_CC           (KAL_PRIORITY_CLASS10+ 5)
#define TASK_PRIORITY_NWSEL        (KAL_PRIORITY_CLASS10+ 4)
#define TASK_PRIORITY_SM           (KAL_PRIORITY_CLASS10+ 6)
#ifdef __MMI_FMI__
#define TASK_PRIORITY_DATA         (KAL_PRIORITY_CLASS11+ 3)
#else
#define TASK_PRIORITY_DATA         (KAL_PRIORITY_CLASS16)
#endif
#define TASK_PRIORITY_LLC          (KAL_PRIORITY_CLASS11+ 7)

#define TASK_PRIORITY_CISS         (KAL_PRIORITY_CLASS15+ 5)

#define TASK_PRIORITY_SMS          (KAL_PRIORITY_CLASS15+ 6)
#define TASK_PRIORITY_SNDCP        (KAL_PRIORITY_CLASS15+ 7)

/* GSM+CDMA external modem Project */
#define TASK_PRIORITY_EXT_MODEM    (KAL_PRIORITY_CLASS16+ 5)
#define TASK_PRIORITY_L4           (KAL_PRIORITY_CLASS16+ 7)

#ifdef __DT_SUPPORT__
#define TASK_PRIORITY_DT           (KAL_PRIORITY_CLASS21 + 8)
...
/*********************    Modem Start    ********************/
/*************************Task CFG Begin****************/
#if defined(__RRLP_SUPPORT__) && !defined(__RRLP_TASK_DISABLE__)
/*task_indx_type*/
...
/*************************Task CFG Begin****************/
#if defined(__DT_SUPPORT__) && !defined(__DT_TASK_DISABLE__)
...
/*************************Task CFG Begin******************/
#if 0 // RATDM merged into IPCORE task for LTE multi-mode
/* under construction !*/
/* under construction !*/
/* under construction !*/
/* under construction !*/
...
task_name("L2REASMSIM")
task_queue_name("L2REASMSIM Q")
...
task_stack_size(1500)
#if defined(MRS_NOT_PRESENT) || defined(__MRS_TASK_DISABLE__)
null_task_create_entry(NULL)
#else
...
task_module_map(INDX_URR, MOD_MEME_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_MEME_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_MEME_4)
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_URR, MOD_CSE_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_CSE_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_CSE_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_URR, MOD_CSCE_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_CSCE_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_CSCE_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_URR, MOD_SIBE_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_SIBE_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_SIBE_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_URR, MOD_USIME_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_USIME_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_USIME_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_URR, MOD_RRCE_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_RRCE_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_RRCE_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_URR, MOD_SLCE_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_SLCE_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_SLCE_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_URR, MOD_ADR_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_ADR_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_ADR_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_URR, MOD_URR_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_URR_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_URR_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_URR, MOD_DB_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_URR, MOD_DB_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_URR, MOD_DB_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_MEME_2)
compatible_code(MOD_DUMMYMEME_2=MOD_MEME_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_MEME_3)
compatible_code(MOD_DUMMYMEME_3=MOD_MEME_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_MEME_4)
compatible_code(MOD_DUMMYMEME_4=MOD_MEME_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_CSE_2)
compatible_code(MOD_DUMMYCSE_2=MOD_CSE_2 )
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_CSE_3)
compatible_code(MOD_DUMMYCSE_3=MOD_CSE_3 )
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_CSE_4)
compatible_code(MOD_DUMMYCSE_4=MOD_CSE_4 )
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_CSCE_2)
compatible_code(MOD_DUMMYCSCE_2=MOD_CSCE_2 )
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_CSCE_3)
compatible_code(MOD_DUMMYCSCE_3=MOD_CSCE_3 )
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_CSCE_4)
compatible_code(MOD_DUMMYCSCE_4=MOD_CSCE_4 )
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_SIBE_2)
compatible_code(MOD_DUMMYSIBE_2=MOD_SIBE_2 )
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_SIBE_3)
compatible_code(MOD_DUMMYSIBE_3=MOD_SIBE_3 )
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_SIBE_4)
compatible_code(MOD_DUMMYSIBE_4=MOD_SIBE_4 )
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_USIME_2)
compatible_code(MOD_DUMMYUSIME_2=MOD_USIME_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_USIME_3)
compatible_code(MOD_DUMMYUSIME_3=MOD_USIME_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_USIME_4)
compatible_code(MOD_DUMMYUSIME_4=MOD_USIME_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_RRCE_2)
compatible_code(MOD_DUMMYRRCE_2=MOD_RRCE_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_RRCE_3)
compatible_code(MOD_DUMMYRRCE_3=MOD_RRCE_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_RRCE_4)
compatible_code(MOD_DUMMYRRCE_4=MOD_RRCE_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_SLCE_2)
compatible_code(MOD_DUMMYSLCE_2=MOD_SLCE_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_SLCE_3)
compatible_code(MOD_DUMMYSLCE_3=MOD_SLCE_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_SLCE_4)
compatible_code(MOD_DUMMYSLCE_4=MOD_SLCE_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_ADR_2)
compatible_code(MOD_DUMMYADR_2=MOD_ADR_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_ADR_3)
compatible_code(MOD_DUMMYADR_3=MOD_ADR_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_ADR_4)
compatible_code(MOD_DUMMYADR_4=MOD_ADR_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_URR_2)
compatible_code(MOD_DUMMYURR_2=MOD_URR_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_URR_3)
compatible_code(MOD_DUMMYURR_3=MOD_URR_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_URR_4)
compatible_code(MOD_DUMMYURR_4=MOD_URR_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_DB_2)
compatible_code(MOD_DUMMYDB_2=MOD_DB_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_DB_3)
compatible_code(MOD_DUMMYDB_3=MOD_DB_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_DB_4)
compatible_code(MOD_DUMMYDB_4=MOD_DB_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_UL2, MOD_URLC_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_UL2, MOD_URLC_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_UL2, MOD_URLC_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_UL2, MOD_UMAC_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_UL2, MOD_UMAC_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_UL2, MOD_UMAC_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_UL2, MOD_UL2_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_UL2, MOD_UL2_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_UL2, MOD_UL2_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_URLC_2)
compatible_code(MOD_DUMMYURLC_2=MOD_URLC_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_URLC_3)
compatible_code(MOD_DUMMYURLC_3=MOD_URLC_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_URLC_4)
compatible_code(MOD_DUMMYURLC_4=MOD_URLC_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_UMAC_2)
compatible_code(MOD_DUMMYUMAC_2=MOD_UMAC_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_UMAC_3)
compatible_code(MOD_DUMMYUMAC_3=MOD_UMAC_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_UMAC_4)
compatible_code(MOD_DUMMYUMAC_4=MOD_UMAC_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_DUMMYURR, MOD_UL2_2)
compatible_code(MOD_DUMMYUL2_2=MOD_UL2_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_DUMMYURR, MOD_UL2_3)
compatible_code(MOD_DUMMYUL2_3=MOD_UL2_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_DUMMYURR, MOD_UL2_4)
compatible_code(MOD_DUMMYUL2_4=MOD_UL2_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
/*************************Task CFG END******************/
/*************************Task CFG Begin****************/
#if defined(__UMTS_RAT__) && defined(DUMMY_PROTOCOL) && !defined(__DUMMYURR_TASK_DISABLE__)
/*task_indx_type*/
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_UL2D, MOD_DRLC_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_UL2D, MOD_DRLC_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_UL2D, MOD_DRLC_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_UL2D, MOD_BMC_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_UL2D, MOD_BMC_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_UL2D, MOD_BMC_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#ifdef __GEMINI_WCDMA__
task_module_map(INDX_UL2D, MOD_UL2D_2)
#if (GEMINI_PLUS_WCDMA >= 3)
task_module_map(INDX_UL2D, MOD_UL2D_3)
#if (GEMINI_PLUS_WCDMA >= 4)
task_module_map(INDX_UL2D, MOD_UL2D_4)
#endif /* GEMINI_PLUS_WCDMA >= 4 */
#endif /* GEMINI_PLUS_WCDMA >= 3 */
#endif /* __GEMINI_WCDMA__ */
...
#if defined(__TL1_TASK_DISABLE__)
null_task_create_entry(NULL)
...
task_stack_size(2500)
#if defined(__UL1DATA_TASK_DISABLE__)
null_task_create_entry(NULL)
#elif defined(__DUMMY_TL1__)
...
#if defined(__RSVA_NOT_PRESENT__) || defined(__RSVA_TASK_DISABLE__)
null_task_create_entry(NULL)
#else
...
task_stack_size(3024)
#if ((defined(__GEMINI__) && !defined(__LOWCOST_MERGE_TASK__))||(defined( __SGLTE__))) \
...
#if defined(__GEMINI__) || defined(__SGLTE__) || defined(__SGLTE_DSDS__)
...
#endif /* GEMINI_PLUS >= 4 */
#endif /* __GEMINI__ || __SGLTE__ || __SGLTE_DSDS__ */
...
task_stack_size(1472)
#if defined(SM_NOT_PRESENT) || defined(__SM_TASK_DISABLE__)
null_task_create_entry(NULL)
#else
...
/*************************Task CFG Begin****************/
/*task_indx_type*/
#if  defined(DUMMYL1) && (defined(__GEMINI_GSM__) || defined(__SGLTE__))
...
task_stack_size(1024)
#if defined(__EXT_MODEM__) && !defined(__EXT_MODEM_TASK_DISABLE__)
...
#if defined(__MTK_TARGET__) && !defined(__UL1TST_TASK_DISABLE__)
...
task_stack_size(1024)
#else
task_stack_size(4*1024) //Elly, set size to R&S VTS PHY original design
#endif
...
#if defined(__MT6280_UE_SIMULATOR__)
/*************************Task CFG Begin****************/
#if defined(__MTK_UL1_FDD__)
/*task_indx_type*/
...
task_priority(TASK_PRIORITY_PROCCPU , KAL_TASK_INITIAL_PRIORITY )  /* check !!!! */
task_stack_size(1024)
#if defined(__PROCCPU_TASK_DISABLE__)
null_task_create_entry(NULL)
#else /* __PROCCPU_TASK_DISABLE__ */
task_create_function(ProcCPU_Task_create)
#endif/* __PROCCPU_TASK_DISABLE__ */ 
task_stack_internalRAM(KAL_FALSE)
task_external_queue_size(20)
task_internal_queue_size(0)
task_boot_mode(NORMAL_M)
