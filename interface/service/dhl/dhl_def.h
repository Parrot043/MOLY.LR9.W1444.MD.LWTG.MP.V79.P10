 ...
 * 01 28 2016 hk.yang
 * removed!
 * [mp7 patch back] dhl monitor service.
 *
 * 06 15 2015 hk.yang
 * removed!
 * reserve share memory for log buffer.
 *
 * 03 24 2015 hk.yang
 * removed!
 * [MP7]suspend dhl task when most buffer is sent to channel.
 *
 * removed!
 * removed!
 *      change DHL_SET_LOG_BUF_SIZ unit to KB and reserve DSP log space for PLS mode
 *
 * 11 17 2014 hk.yang
 * removed!
 * [MP7] overwrite mode and pls
 *
 * removed!
 * removed!
 * fixed typo
 ...
 * removed!
 * removed!
 * [DHL]  logging buffer size config option
 *
 * removed!
 * removed!
 * 	.
...
#define DHL_EVENT_TX_BUF_RELEASED   (0x80)
#define DHL_EVENT_MON_TX_BUF_RELEASED (0x100)
#define DHL_EVENT_MON_DATA_READY      (0x200)
#define DHL_EVENT_MON_TX_IOR_READY    (0x400)
#define DHL_EVENT_MON_TOOL_CONNECT    (0x800)
...
#if defined (__DHL_MONITOR_MODE_SUPPORT__)
  //Min : 256 * 1024
  #define DHL_MON_LOG_BUFFER_SIZE (2 * 1024 * 1024)
#endif 
...
#if defined(__LOG_BUF_IN_SHM_SUPPORT__) && defined(__MTK_TARGET__)
