...
#define dhl_enable_customized_SD_wakeup_time(...)
#define dhl_disable_customized_SD_wakeup_time(...)
...
/*!
* 	@function	dhl_enable_customized_SD_wakeup_time
*     @brief           this function is resvered for low power testing only
*	@brief		this function can change logging flush time out in SD mode
*	@param		c_sec		flush time from 1 to 180 sec
*	@result		KAL_TRUE	Setting time out success
*	@result		KAL_FALSE	Setting time out fail
*/
extern kal_bool dhl_enable_customized_SD_wakeup_time(kal_uint8 c_sec);
/*!
* 	@function	dhl_disable_customized_SD_wakeup_time
*     @brief           this function is resvered for DHL internal testing only
*/
