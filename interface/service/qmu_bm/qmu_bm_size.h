 ...
 * removed!
 * removed!
 * Change UL SRB large GPD size when L2S test.
 *
 * removed!
 * removed!
 * 1. Total size of HIF_DL/NET_DL GPD: 2048 bytes -> 1760 bytes
 * 2. Ext. size of HIFDL/NET_DL GPD: 211 bytes -> 224 bytes
 *
 * removed!
 * removed!
 * CCCI common GPD memory shrink as requested by I-Wei Tasi
 *
 * removed!
 * removed!
 * Modify SRB UL GPD:
 * 1. Remove ESRB_UL
 * 2. Add ESRB_UL_M, data length=512 byte
 * 3. Add ESRB_UL_L, data length=2048 byte
 *
 * removed!
 * removed!
 * Set  QBM_IMS_DL_DATA_LEN from 1600 to 4096
 *
 * removed!
 * removed!
 * Change GPD format for IMS_DL and NET_UL_SHRD
 *
 * removed!
 * removed!
...
#define QBM_HIF_DL_DATA_LEN  (1760 - QBM_HIF_DL_EXT_LEN)
