...
/*****************************************************************************
* Constant    : EL1_CUSTOM_MAX_RF_BPI_EVENT_TIMING_NUM
* Group       : Real target, Internal, EL1D common operation
* Description : Constant to be used for record the maximum 4G BPI event timing
*               support numbers currently in use
*****************************************************************************/
#define EL1_CUSTOM_MAX_RF_BPI_EVENT_TIMING_NUM      (12)
...
*****************************************************************************/
#define EL1_CUSTOM_GPIO_MAX_NUM_OF_DEFINED_DETECT_PIN_NAME   MML1_RF_DRDI_GPIO_MAX_DETECT_PIN_NUM
...
{
   /* ASM Timing */
   kal_int16 BPI_Timing[EL1_CUSTOM_MAX_RF_BPI_EVENT_TIMING_NUM];
