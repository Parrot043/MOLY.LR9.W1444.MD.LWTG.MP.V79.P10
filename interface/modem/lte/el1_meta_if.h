 ...
 * removed!
 * removed!
 * [MP7] force TAS by meta tool command.
 *
 * removed!
 * removed!
 * .
 ...
 * removed!
 * removed!
 * [ET] ET patch in MCU side SW domain.
 *
 * removed!
 * removed!
 * Perform CSR and MIB receiving to improve the AFC convergency.
 *
 * removed!
 * removed!
 * Header file definition for NVRAM update feature.
 *
 * removed!
 * removed!
 * .
...
typedef struct
{
   kal_uint8 tas_idx;            /*0: default Tx antenna from NVRAM setting,
                                                       1: force Tx antenna 0
                                                       2: force Tx antenna 1*/
}ERfTestCmdTasCfg;
