...
#define IS_4G_TAS_FOR_C2K_ONOFF_SUPPORT               1  /* To support LTE-C2K antenna switch     */
#else
#define IS_4G_TAS_FOR_C2K_ONOFF_SUPPORT               0  /* NOT To support LTE-C2K antenna switch */
#endif

/************************************************************
 * 4G reuse 2G PA feature support: Only enable after Denali *
 ************************************************************/
#if defined (MT6735)
#define IS_4G_REUSE_2G_PA_SUPPORT                     1  /* Enable APC control for 4G to re-use 2G PA */
#else
#define IS_4G_REUSE_2G_PA_SUPPORT                     0  /* Disable APC control for 4G to re-use 2G PA */
#endif

#if defined(__CDMA2000_RAT__)
#define IS_4G_SVLTE_BAND_SUPPORT                      1  /* To support the SVLTE band indicator     */
#else
#define IS_4G_SVLTE_BAND_SUPPORT                      0  /* NOT to support the SVLTE band indicator */
#endif
