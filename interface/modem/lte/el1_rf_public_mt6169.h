...
/*--------------------------------------------------------*/
/*  TPC Event Timing for APC                              */
/*--------------------------------------------------------*/
#define APC_SETTLING_TIME     11             //we need to advance 11 us for APC setting time

/* For APC, config time is transferred in ACount (52MHz) */
#define TC_APC_ON      MICROSECOND_TO_52M(26 + APC_SETTLING_TIME)  //PAVCC ON for APC
#define TC_APC_OFF     MICROSECOND_TO_52M(0)                       //PAVCC OFF for APC
