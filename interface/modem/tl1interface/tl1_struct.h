 ...
 * removed!
 * 	.
 * 	Add TDS list mode feature for folder midddleware/interface part
 *
 * 03 27 2015 jt.tan
 * removed!
 * 	add TAS feature for MT6795
 *
 * 03 25 2015 jt.tan
 * removed!
 * add TDS TAS feature.
...
/*******************************************************************************
                                rx data struct begin
*******************************************************************************/
#define  DCH_BUF_COUNT      6
//#define  DCH_BUF_SIZE       1200    //8960/8+32*2=1184
#define  DCH_BUF_SIZE       1472    //10240/8+32*2+32*4=1472
#define  HSDSCH_BUF_COUNT   10
#define  HSDSCH_BUF_SIZE    1860    //14043/8+45*2=1846
typedef struct _tl1_mac_rx_data_T
{
    kal_uint8        data_read_index;       //UMAC write it
    kal_uint8        data_write_index;      //LISR write it
    kal_uint8        left_data_count;
    kal_uint8        min_left_data_count;
    kal_uint8        *data_buffer[DCH_BUF_COUNT];       //LISR write it, UMAC read it

    kal_uint8        hsdsch_read_index;     //UMAC write it
    kal_uint8        hsdsch_write_index;    //LISR write it
    kal_uint8        left_hsdsch_count;
    kal_uint8        min_left_hsdsch_count;
    kal_uint8        *hsdsch_buffer[HSDSCH_BUF_COUNT];    //LISR write it, UMAC read it
}tl1_mac_rx_data_T;
