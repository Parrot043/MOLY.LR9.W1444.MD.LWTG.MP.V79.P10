...
/* GPS Frequency Aiding support */
#if defined(__L1_GPS_FREQ_AIDING_SUPPORT__)
#define MD_DRV_IS_GPS_FREQ_AIDING_SUPPORT                    1
#else
#define MD_DRV_IS_GPS_FREQ_AIDING_SUPPORT                    0
#endif
