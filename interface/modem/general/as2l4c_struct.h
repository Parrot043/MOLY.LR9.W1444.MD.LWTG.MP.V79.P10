...
{
    LOCAL_PARA_HDR
    kal_bool is_call_exist;
    rat_enum rat;
} l4cas_call_status_notify_req_struct;
...
typedef struct {
    ...
    kal_uint16 msg_len;
    kal_uint32 src_id;
    kal_bool is_disable_integrity_check;      // KAL_TRUE: bypass AS integrity check     KAL_FALSE: follow spec
} l4cas_set_save_rac_preference_req_struct;
...
typedef struct {
    ...
    kal_bool   result;
} l4cas_set_save_rac_preference_cnf_struct;
