...
} l4csm_rat_change_rsp_struct; // 23G4 finish
...
typedef struct {
    ...
    // check L4_NAS_RAT_CHANGE_SAP.docx for detail
} l4csm_rat_change_req_struct; // 4G23 start

#ifdef __SGLTE__
/*Huifeng: PS Swtich Struct  REQ/RSP*/
typedef struct {
    LOCAL_PARA_HDR
...
} l4c_sm_ps_switch_context_transfer_rsp_struct; 
...
} l4c_sm_ps_switch_context_transfer_req_struct; 

typedef l4c_sm_ps_switch_context_transfer_req_struct l4c_ps_switch_context_transfer_req_struct;
#endif
