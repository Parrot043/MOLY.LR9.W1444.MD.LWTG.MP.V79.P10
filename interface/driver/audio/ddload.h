...
#define DPCHIP_DATACARD_DSP         (defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6290) || defined(MT6592) || defined(MT6571) || defined(MT6595) || defined(MT6752) || defined(MT6735))
...
#define DPCHIP_NO_DDL_AUDIO (defined(MT6595) || defined(MT6752) || defined(MT6735))
#define SPH_ENH_DDLOAD_TWO_PARTS      (defined(MT6290) || defined(MT6592) || defined(MT6595) || defined(MT6752) || defined(MT6735))
