 ...
 * Description:
 * ------------
 *   This header file export the data synchronization API.
 *
 * Author:
 * -------
 * -------
...
#if (defined(__ARM11_MMU__) || defined(__CR4__)) && defined(__MTK_TARGET__)
#define Data_Sync_Barrier() cp15_drain_write_buffer()
#else /* (__ARM11_MMU__ || __CR4__) && __MTK_TARGET__ */
#define Data_Sync_Barrier() do{}while(0)
#endif /* (__ARM11_MMU__ || __CR4__) && __MTK_TARGET__ */
...
#if (defined(__ARM11_MMU__) || defined(__CR4__)) && defined(__MTK_TARGET__)
#define Inst_Sync_Barrier() cp15_inst_synchronization_barrier()
#else /* (__ARM11_MMU__ || __CR4__) && __MTK_TARGET__ */
