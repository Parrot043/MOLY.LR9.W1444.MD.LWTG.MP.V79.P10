...
//MODULE_ID_GLOBAL_MD2(MOD_XXX)
//MOD_XXX must be defined in local module if using this MARCO
//this MARCO will be used to create a mapping array {MOD_XXX, MOD_XXX_MD2}
//where MOD_XXX_MD2 is visible to all MDs with same value.
