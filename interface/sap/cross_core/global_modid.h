...
MODULE_MOD_END( MOD_ID_GLOBAL_NIL_CHECK_TAIL )
...
#define IS_GLOBAL_MD1_MOD(global_module) \
((global_module>MOD_ID_GLOBAL_MD1_BEGIN)&&(global_module<MODULE_TAG_MOD_ID_GLOBAL_MD1_TAIL))
#define IS_GLOBAL_MD2_MOD(global_module) \
((global_module>MOD_ID_GLOBAL_MD2_BEGIN)&&(global_module<MODULE_TAG_MOD_ID_GLOBAL_MD2_TAIL))
#define IS_GLOBAL_MD3_MOD(global_module) \
((global_module>MOD_ID_GLOBAL_MD3_BEGIN)&&(global_module<MODULE_TAG_MOD_ID_GLOBAL_MD3_TAIL))
