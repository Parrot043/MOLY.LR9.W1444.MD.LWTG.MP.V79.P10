...
#ifdef __LTE_RAT__
    MSG_ID_MPAL_RR_STANDBY_GSM_REPORT_SRVCC_BSIC_IND,
    MSG_ID_RRM_MPAL_MM_TDD_CODE_END = MSG_ID_MPAL_RR_STANDBY_GSM_REPORT_SRVCC_BSIC_IND,
#else
...
#ifdef __LTE_RAT__
    MSG_ID_RR_MPAL_STANDBY_GSM_REPORT_SRVCC_BSIC_START_REQ,
    MSG_ID_RR_MPAL_STANDBY_GSM_REPORT_SRVCC_BSIC_STOP_REQ,	
#endif    
