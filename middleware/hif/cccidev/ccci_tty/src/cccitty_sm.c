 ...
 * removed!
 * removed!
 * 	Add cccitty sequence check support (Merging from MP5 CL:641385)
 *
 * removed!
 * removed!
...
static ccci_ch_id_t g_cccitty_ccci_ch_mappping[CCCI_TTY_DEV_CNT] = {
    ...
    {CCCI_MD_LOG2_RX,     CCCI_MD_LOG2_TX,      CCCITTY_INVALID_CH,      CCCITTY_INVALID_CH,  CCCI_TTY_DHL2_TTL_RGPD_CNT},     /*uart_port_dhl_ccci*/
