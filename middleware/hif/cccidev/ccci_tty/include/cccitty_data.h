 ...
 * removed!
 * removed!
 * 	reduce default GPD reload number of cccitty
 *
 * removed!
 * removed!
...
#define CCCI_TTY_UL_BUF_CNT             1                         /* Default: Reload 1 RGPDs for each CCCI TTY device. */
                                                                  /* we reduced the default value from 16 to 1 to meet the requirement of low memroy usuage*/
...
#define CCCI_TTY_DHL2_TTL_RGPD_CNT      CCCI_TTY_UL_BUF_CNT_1ST_RELOAD  //17
