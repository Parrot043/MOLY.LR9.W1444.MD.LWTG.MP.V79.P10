 ...
 * Public fucntions.
 *----------------------------------------------------------------------------*/
void lms_on_downlink(qbm_gpd* p_head, qbm_gpd* p_tail);

void lms_rcv_ul_sdu(ip_type_e ip_type, kal_uint32 pdn_id, qbm_gpd *p_head, qbm_gpd *p_tail);

void lms_rcv_ul_sdu_by_ebi(kal_uint32 ebi, qbm_gpd *p_head, qbm_gpd *p_tail);

void lms_reg_cbk_notify_tick_source(upcm_nofify_lte_tick_f pf_notify);

void lms_reg_cbk_dlvr_dl_sdu(upcm_dlvr_dl_sdu_f pf_dlvr_sdu);
