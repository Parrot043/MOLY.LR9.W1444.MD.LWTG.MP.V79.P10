    ...
    if (IPC_HDR_IS_V4(p_packet)){
        ...
        if ((p_info->protocol == IPC_HDR_PROT_UDP) 
            ...
            if (p_info->protocol == IPC_HDR_PROT_UDP) {
                ...
                p_info->info_valid_fields |= IPC_FILTER_BY_TCP_FLAGS;
                    ...
                    /* --------- Forward "curr_gpd" to callback function --------- */
                    {
                        ...
                        if (callback_gpd_p)
                        {
                            ...
                            if (KAL_TRUE == filter->callback_with_info)
                            {
                                 ...
                                 */
                                callback_context = filter->callback_context;
                                callback_filter_id = filter->filter_id;
                            ...
                            } else
                            {
                                ...
                                callback_func(      callback_context,
                                                    callback_filter_id,
                                                    callback_gpd_p,
                                                    callback_gpd_p,
                                                    (kal_uint32)callback_gpd_data_len   );
