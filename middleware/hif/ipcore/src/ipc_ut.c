...
void ipc_ut_install_ul_filters(kal_bool callback_with_info, kal_bool with_callback, kal_uint32 ipv4_filter_cnt, kal_uint32 ipv6_filter_cnt, kal_bool with_wildcard, kal_bool with_bwm, kal_uint8 matched_filter_idx_v4, kal_uint8 matched_filter_idx_v6);
...
kal_int32 ipc_ut_check_session(ipc_session_t *session, ipc_ut_netif_t *net)
{
    ...
    if (session) {
        do {
            ...
            if (tmp_session) {
                if (ip_id != tmp_session->ip_id) {
                    error_code = -7;
                    IPC_R_UNLOCK_OBJECT(tmp_session, mask);
                    break;
                }
        ...
        IPC_R_UNLOCK_OBJECT(session, mask);
    } else {
        error_code = -1;
    }
...
kal_bool ipc_ut_uplink_filter(void *p_param, kal_char *p_ret_err_str, kal_uint32 *p_ret_err_str_sz)
{
    ...
    for (matched_filter_idx_v6 = 0; matched_filter_idx_v6 < ipv6_filter_cnt; matched_filter_idx_v6++) {
        ...
        ipc_ut_printf(  "ifo(%d) v4Cnt(%d) v6Cnt(%d) v4FltCnt(%d) v6FltCnt(%d) withWC(%d) withBWM(%d) IPType(%d) v4Idx(%d) v6Idx(%d)\r\n",
        ...
        ipc_ut_install_ul_filters(callback_with_info, KAL_TRUE, ipv4_filter_cnt, ipv6_filter_cnt, with_wildcard, with_bwm, matched_filter_idx_v4, matched_filter_idx_v6);
...
{    
    ...
    /*
         ...
         */
        kal_sleep_task(IPC_UT_MSG_LATENCY);
        IPC_R_LOCK_OBJECT(session, mask);
...
kal_bool ipc_ut_ul_filter_ipv4(void *p_param, kal_char *p_ret_err_str, kal_uint32 *p_ret_err_str_sz)
{
    ...
    for (matched_filter_idx_v4 = 0; matched_filter_idx_v4 < filter_cnt; matched_filter_idx_v4++) {
        ...
        ipc_ut_install_ul_filters(callback_with_info, KAL_TRUE, filter_cnt, 0, KAL_FALSE, KAL_FALSE, matched_filter_idx_v4, 0);
...
kal_bool ipc_ut_ul_filter_ipv6(void *p_param, kal_char *p_ret_err_str, kal_uint32 *p_ret_err_str_sz)
{
    ...
    for (matched_filter_idx_v6 = 0; matched_filter_idx_v6 < filter_cnt; matched_filter_idx_v6++) {
        ...
        ipc_ut_printf(  "if(%d) 4Ct(%d) 6Ct(%d) fCt(%d) fIdx(%d)\r\n",
                        callback_with_info, ipv4_cnt, ipv6_cnt, filter_cnt, matched_filter_idx_v6); 

        ipc_ut_install_ul_filters(callback_with_info, KAL_TRUE, 0, filter_cnt, KAL_FALSE, KAL_FALSE, 0, matched_filter_idx_v6);
...
kal_bool ipc_ut_dl_filter_ipv6(void *p_param, kal_char *p_ret_err_str, kal_uint32 *p_ret_err_str_sz)
{
    ...
    for (matched_filter_idx_v6 = 0; matched_filter_idx_v6 < filter_cnt; matched_filter_idx_v6++) {
        ...
        ipc_ut_printf(  "un(%d) al(%d) if(%d) 4Ct(%d) 6Ct(%d) fCt(%d) fIdx(%d)\r\n",
...
kal_bool ipc_ut_ul_filter_and_forward_msg(void *p_param, kal_char *p_ret_err_str, kal_uint32 *p_ret_err_str_sz)
{
    ...
    for (matched_filter_idx_v4 = 0; matched_filter_idx_v4 < filter_cnt; matched_filter_idx_v4++) {
        ...
        ipc_ut_printf(  "if(%d) 4Cnt(%d) 6Cnt(%d) fCnt(%d) fIdx(%d)\r\n",
                        callback_with_info, ipv4_cnt, ipv6_cnt, filter_cnt, matched_filter_idx_v4); 


        ipc_ut_install_ul_filters(callback_with_info, KAL_FALSE, filter_cnt, 0, KAL_FALSE, KAL_FALSE, matched_filter_idx_v4, 0);
...
kal_bool ipc_ut_dl_filter_and_forward_msg(void *p_param, kal_char *p_ret_err_str, kal_uint32 *p_ret_err_str_sz)
{
    ...
    for (matched_filter_idx_v4 = 0; matched_filter_idx_v4 < filter_cnt; matched_filter_idx_v4++) {
        ...
        ipc_ut_printf(  "ui(%d) if(%d) ai(%d) 4Cnt(%d) 6Cnt(%d) fCnt(%d) fIdx(%d)\r\n",
...
kal_bool ipc_ut_garbage_filter(void *p_param, kal_char *p_ret_err_str, kal_uint32 *p_ret_err_str_sz)
{
    ...
    for (synv6_idx = 0; synv6_idx < ipv6_cnt; synv6_idx++) {
        ...
        if (NULL == head_gpd ||
            ...
            ipc_ut_format_err_str("Not trap Garbage packets!\r\n");
            return KAL_FALSE;
        }
        ...
        if (ipc_ut_garbage_filter_expect_tcp_rst_gpd_cnt > 0 &&
            ...
            ipc_ut_format_err_str("Responsing TCP RST packets has something wrong!!\r\n");
            return KAL_FALSE;
        }
