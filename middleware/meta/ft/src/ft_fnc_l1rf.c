            ...
            for(i = 0; i < req->param.List_Mode_NSFT_start.cmd_count; i++)
            {
                ...
                switch(ptr->cmd_type)
                {
...
#if defined(__MTK_INTERNAL__) && defined(_DEBUG)
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode sync] command id = %d", lm_cmd_ptr->sync.command_id);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode sync] band = %d", lm_cmd_ptr->sync.RF_band);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode sync] arfcn = %d", lm_cmd_ptr->sync.ARFCN);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode sync] sync_power = %d", lm_cmd_ptr->sync.sync_power);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode sync] sync_slot_offset = %d", lm_cmd_ptr->sync.sync_slot_offset);
                        tst_sys_trace(g_FT_debug_buf);
#endif // #if defined(__MTK_INTERNAL__) && defined(_DEBUG)
                        break;
                    }
                    ...
                    {                        
                        ...
                        L1TST_NsftList_message_handler(&nsft_lm_req);
#if defined(__MTK_INTERNAL__) && defined(_DEBUG)
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode trigger] command id = %d", lm_cmd_ptr->trigger.command_id);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode trigger] band = %d", lm_cmd_ptr->trigger.RF_band);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode trigger] arfcn = %d", lm_cmd_ptr->trigger.ARFCN);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode trigger] tsc = %d", lm_cmd_ptr->trigger.TSC);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode measure] trx_type = %d", lm_cmd_ptr->trigger.RTX_types);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode trigger] tx_power = %d", lm_cmd_ptr->trigger.TX_power);
                        tst_sys_trace(g_FT_debug_buf);
#endif // #if defined(__MTK_INTERNAL__) && defined(_DEBUG)
                        break;
                    }
                    case NSFT_LM_CMD_CHMEAS:
                    {
                        ...
                        L1TST_NsftList_message_handler(&nsft_lm_req);
#if defined(__MTK_INTERNAL__) && defined(_DEBUG)
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode measure] command id =  %d", lm_cmd_ptr->test.command_id);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode measure] band = %d", lm_cmd_ptr->test.RF_band);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode measure] arfcn = %d", lm_cmd_ptr->test.ARFCN);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode measure] tsc = %d", lm_cmd_ptr->test.TSC);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode measure] trx_type = %d", lm_cmd_ptr->test.RTX_types);
                        tst_sys_trace(g_FT_debug_buf);
                        sprintf((kal_char *)g_FT_debug_buf, "[list mode measure] rx_power = %d", lm_cmd_ptr->test.RX_power);
                        tst_sys_trace(g_FT_debug_buf);
                               
                        for(j = 0; j < 8 ; j++)
                        {
                            sprintf((kal_char *)g_FT_debug_buf, "[list mode measure] tx_pcl[%d] %d", j, lm_cmd_ptr->test.TX_power[j]);
                            tst_sys_trace(g_FT_debug_buf);
                            sprintf((kal_char *)g_FT_debug_buf, "[list mode measure] repeat_count[%d] %d", j, lm_cmd_ptr->test.repeat_count[j]);
                            tst_sys_trace(g_FT_debug_buf);
                        }    
#endif // #if defined(__MTK_INTERNAL__) && defined(_DEBUG)
                        break;
