...
//#endif
        ...
        0x0014,  //hsr_inactive_timer_val(seconds)
        0x02,   //hsr_on_thrs
        0x03,   //hsr_off_thrs
...
// #endif
    ...
    0x08 |
#endif
#if defined(__RPLMN_HPLMN_COMBINED_SEARCH__) || (defined(__UMTS_TDD128_MODE__))
    0x10 |
#endif
...
//#endif
    ...
    /* 22nd byte */
#if defined(__IGNORE_INT_CHECK_FOR_NAS_MSG__)
    0x01 |
#endif
...
/* 23rd byte */
  ...
  //0x20 |  //SBP_CUSTOM_FPLMN_USED
    ...
    0x08 |
#endif
#if defined(__SBP_AVOID_INTRA_LTE_PINGPONG_RESEL__)
    0x10 |  //SBP_AVOID_INTRA_LTE_PINGPONG_RESEL
#endif
#if defined(__STAY_ON_23G_FOR_LIMITED_WHEN_NO_IMS__)
    0x20 |
#endif

#if defined(__DISABLE_ISR_SUPPORT__)
    0x40 | /* SBP_DISABLE_ISR_SUPPORT: To Enable ISR Support Set :0x00 */
#endif
    ...
    /* 25th byte */
#if defined(__CMCC_SRVCC_CDRX_EHEN__)
    0x01 |
#endif
#if defined(__SRVCC_STOP_UAS_MEAS__)
    0x02 |
#endif
#if defined(__SRVCC_STOP_EAS_MEAS__)
    0x04 |
#endif
#if defined(__SBP_SRVCC_DRX_INC_GAP__)
    0x08 |
#endif
    ...
    0x20 |
#endif
#if defined(__SBP_HSR_ENHANCE__)
    0x40 |
#endif
    ...
    0x04 | //SBP_CB_CHANNEL_ONLY_STORED_IN_NVRAM
#endif
#if defined(__SIM_RETRY_WHEN_CDMA_DETECTION_RESET_ERROR__)
	0x08 | //SBP_SIM_RETRY_WHEN_CDMA_DETECTION_RESET_ERROR
#endif
#ifdef __SCA_CONFIGURED_BY_CUSTOMER__
    0x10 |
#endif
    0x00
    }
...
static nvram_ef_sbp_modem_data_config_struct NVRAM_EF_SBP_MODEM_DATA_CONFIG_DEFAULT[] = {
{
   ...
   /*11th Byte  SS_DISABLE_AFR_TIMER_PERIOD*/
    ...
    0x04,
#endif
    //12th byte SIM_MAX_RETRY_WHEN_CDMA_DETECTION_RESET_ERROR
    0x03
    }
}
};
