...
kal_bool mm_custom_registration_related_setting(mm_setting_enum setting)
{
  ...
  { 
   ...
   case MM_ENABLE_HPPLMN_SEARCH_FORCE_RELEASE_PCH_CONNECTION:
    ...
    case MM_ECC_NOT_PREEMPT_SEARCH:
        {
          return sbp_query_md_feature(SBP_ECC_NOT_PREEMPT_SEARCH);
        break;
        }  
   default:
        break;
...
/*****************************************************************************
* FUNCTION
*  mm_custom_use_minimum_T3212
* DESCRIPTION
*  This function is used to query SBP feature.
*
* PARAMETERS
*  NONE
* RETURNS
...
*  None
*****************************************************************************/
kal_bool mm_custom_use_minimum_T3212(void)
{
   return sbp_query_md_feature(SBP_MM_T3212_OPTION); 
}
