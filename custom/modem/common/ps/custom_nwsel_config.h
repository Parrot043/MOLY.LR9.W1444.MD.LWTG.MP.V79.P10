...
extern const nwsel_rat_enum CUSTOM_FROM_RAT[];

extern const nwsel_rat_enum CUSTOM_CORRECT_RAT[];

extern const kal_uint32 CUSTOM_CORRECT_PLMN_NUM;

extern const char *CUSTOM_HK_PLMN[];
extern const kal_uint32 CUSTOM_HK_PLMN_NUM;
extern const char *CUSTOM_FR_BL_PLMN[];

extern const nwsel_rat_enum CUSTOM_FR_BL_RAT[];
...
#define ME_STORED_HPLMNWACT_LEN  (ME_STORED_HPLMNWACT_NUM * 5) 
...
extern const nwsel_rat_enum custom_roaming_fullband_rat[NWSEL_RAT_ENTRY_NUM];
extern const nwsel_rat_enum* custom_irrdt_failure_rat_order[NWSEL_IRRDT_MAX_TYPE];
...
extern void nwsel_init_sbp_config(kal_bool is_cdma2000_supported);
