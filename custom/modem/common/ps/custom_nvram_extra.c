...
#ifdef __VSIM__ 
/*35+256 = 291*/
const kal_uint8 DF_GSM_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
...
const kal_uint8 EF_ICCID_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_LP_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_SST_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_PHASE_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_IMSI_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_AD_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_ACC_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_KC_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_LOCI_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_HPPLMN_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_BCCH_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
const kal_uint8 EF_FPLMN_data[EF_META_SIZE + EF_DATA_SIZE] = 
{
/* The first 32 is meta data : start*/
...
/***************************************************************************** 
* FUNCTION
*  custom_chv2_specific_cards
*DESCRIPTION
*  This function is used for specific cards whose chv2 count may be greater than 3
*  KAL_TRUE: get chv2 count before sending to SMU.
*  KAL_FALSE: neednt get chv2 count.
*PARAMETERS
* N/A
*RETURNS
* KAL_TRUE or KAL_FALSE
*****************************************************************************/
kal_bool custom_chv2_specific_cards(void)
{
    return KAL_FALSE;
}
