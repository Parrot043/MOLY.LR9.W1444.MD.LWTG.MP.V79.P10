...
extern void l4c_nw_attach_lind (l4c_rac_response_enum status,
                                kal_uint8 *plmn,
                                kal_uint8 gsm_state,
                                kal_uint8 gprs_state,
                                l4c_gprs_status_enum gprs_status,
...
extern void l4a_ps_gprs_status_update_lind(l4c_gprs_status_enum status, kal_uint8 cell_support_egprs, kal_uint16 data_speed_support, l4c_data_bearer_capablility_enum data_bearer_capability);//mtk02285, hspa_mmi_h2
extern void l4c_ps_gprs_status_update_lind(l4c_gprs_status_enum status, kal_uint8 cell_support_egprs, kal_uint16 data_speed_support, l4c_data_bearer_capablility_enum data_bearer_capability);//mtk02285, hspa_mmi_h2
#endif
