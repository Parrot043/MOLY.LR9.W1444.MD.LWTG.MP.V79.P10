...
#define CMUX_URC_2_CHANNEL      0x40    // indication channel (unsolicited code)
...
{
	if( (channel >= g_channel_num) || ( g_dlc_pn_config[channel].dlci > MAX_DCLI_NUM )) 
	{
		ASSERT(0);
	}
