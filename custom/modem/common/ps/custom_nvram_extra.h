...
extern const kal_uint8 DF_GSM_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_ICCID_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_LP_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_SST_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_PHASE_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_IMSI_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_AD_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_ACC_data[EF_META_SIZE + EF_DATA_SIZE] ;
extern const kal_uint8 EF_KC_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_LOCI_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_HPPLMN_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_BCCH_data[EF_META_SIZE + EF_DATA_SIZE];
extern const kal_uint8 EF_FPLMN_data[EF_META_SIZE + EF_DATA_SIZE];
#endif /* __VSIM__ */
