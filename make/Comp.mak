...
# $Log:$
#
# 06 19 2014 xenia.tsou
# [MOLY00007565] [Target] enhance the PCIBT mechanism and fix PCIBT error
# .
#
# 06 19 2014 xenia.tsou
# [MOLY00007565] [Target] enhance the PCIBT mechanism and fix PCIBT error
# add pcibt to check if non-4g module use 4g src code.
#
# 12 24 2013 amber.su
...
ifeq ($(filter $(COMPONENT),$(LTE_SEC_COMP)),)
  ifneq ($(filter modem/lte_sec%, $(SRC_LIST) $(INC_DIR)),)
    $(error Error: Can not use modem/lte_sec in $(COMPONENT) module's SRC_LIST/INC_DIR, please check !!)
  endif
endif
