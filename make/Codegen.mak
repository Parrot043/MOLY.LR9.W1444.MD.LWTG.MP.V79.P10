...
ifneq ($(strip $(MODIS_CONFIG)),TRUE)
	@$(ECHO) -n $(CGEN) -em_filter_gen $(CODEGEN_DATABASE_IN) $(strip $(TSTDIR))/database/EM_INFO.csv $(MODISBUILD_TST_DB)/em_filter.bin >>$(CGEN_CFG_MODEM)
	@echo $(CGEN) -extract_ota_em_info $(CODEGEN_DATABASE_IN) $(MODISBUILD_TST_DB)/mdm_layout_desc.dat >>$(CGEN_CFG_MODEM)
