...
SRC_LIST += $(strip $(AUDFOLDER))/am.c \
            ...
            $(strip $(AUDFOLDER))/bt_sco_drv.c \
            driver/audio/src/audio_create.c


# AFE part
AFE_SPLIT_DRIVER_PLATFORM  = MT6280 MT6589 MT6572 MT6582 MT6290 MT6592 MT6571 MT6595 MT6752 MT6795 MT6735
ifneq ($(filter $(strip $(MODULE_DEFS)), $(AFE_SPLIT_DRIVER_PLATFORM)),)
   ...
   ifeq ($(strip $(PLATFORM)),MT6735)
     SRC_LIST += $(strip $(AUDFOLDER))/afes/afe_6735.c
   endif
else
