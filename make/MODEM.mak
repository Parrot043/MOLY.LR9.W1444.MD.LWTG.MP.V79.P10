...
ifeq ($(strip $(L1S_BASIC)),TRUE)
  ...
  COMPLIST       += nvram nvram_sec l4misc sim nwsel gmss
  ifneq ($(strip $(GERAN_MODE_SUPPORT)),NONE)
...
UL1_HS_PLUS_PLATFORM = TK6280 MT6280 MT6752 MT6290 MT6595 MT6735 MT6795
ifneq ($(strip $(UTRAN_MODE_SUPPORT)),NONE)
  UL1_SUPPORT = TRUE
else
  ifneq ($(strip $(GERAN_MODE_SUPPORT)),NONE)
...
ifeq ($(strip $(L1S_BASIC)),TRUE)
  ...
  COMP_TRACE_DEFS_MODEM    += service/nvram/include/nvram_trc.h \
                       ...
                       $(strip $(MODEM_FOLDER))/nwsel/nwsel/include/nwsel_trc.h \
                       interface/modem/upcm/upcm_trc.h \
                       ...
                       $(strip $(MODEM_FOLDER))/nwsel/gmss/include/gmss_trc.h
...
COMP_TRACE_DEFS_MODEM += driver/devdrv/mdipc/inc/mdipc_trace.h
