...
ifneq ($(filter MT6735 MT6795,$(PLATFORM)),)
CUS_REL_BASE_COMP += custom/modem/el1_rf/$(PLATFORM)_LTE_MT6169_DRDI_CUSTOM
CUS_REL_BASE_COMP += custom/modem/l1_rf/$(PLATFORM)_2G_MT6169_DRDI_CUSTOM
CUS_REL_BASE_COMP += custom/modem/mml1_rf/$(PLATFORM)_MMRF_DRDI_CUSTOM
ifneq ($(filter MT6795,$(PLATFORM)),)
CUS_REL_BASE_COMP += custom/modem/tl1_rf/$(PLATFORM)_K95_MT6169_UMTS_TDD_DRDI_CUSTOM
else
CUS_REL_BASE_COMP += custom/modem/tl1_rf/$(PLATFORM)_MT6169_UMTS_TDD_DRDI_CUSTOM
endif
CUS_REL_BASE_COMP += custom/modem/ul1_rf/$(PLATFORM)_UMTS_FDD_MT6169_DRDI_CUSTOM
endif

ifneq ($(filter MT6752,$(PLATFORM)),)
CUS_REL_BASE_COMP += custom/modem/el1_rf/K52_COMBO_LTE_MT6169_CUSTOM
CUS_REL_BASE_COMP += custom/modem/l1_rf/K52_COMBO_2G_MT6169_CUSTOM
CUS_REL_BASE_COMP += custom/modem/mml1_rf/K52_COMBO_MMRF_CUSTOM
CUS_REL_BASE_COMP += custom/modem/tl1_rf/MT6752_K52_COMBO_MT6169_UMTS_TDD_CUSTOM
CUS_REL_BASE_COMP += custom/modem/ul1_rf/K52_COMBO_UMTS_FDD_MT6169_CUSTOM
endif
