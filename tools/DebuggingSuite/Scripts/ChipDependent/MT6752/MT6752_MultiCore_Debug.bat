...
ECHO [MT6752 Multi-Core Debugging]
...
ECHO Starting AP ^(CA53^) debugger...
START CVD64.exe -Multi -Master -CORE=1 MT6752_MultiCore_AP.csf

:: ping 3 s
ping 127.0.0.1 -n 3 -w 1000 > nul

ECHO [Step 1] Press any key to start MD1 ^(Cortex-R4^) debugger...
START C:\JnDTech\CVI\CVD\Bin\_CVD.exe -Multi -Slave -CORE=2 MT6752_MultiCore_MD.csf
...
ECHO Starting AP ^(CA53^) debugger...
START CVD64.exe -Multi -Master -CORE=1 MT6752_MultiCore_AP_Attach.csf

:: ping 3 s
PING 127.0.0.1 -n 3 -w 1000 > nul

ECHO Start MD ^(Cortex-R4^) debugger...
START C:\JnDTech\CVI\CVD\Bin\_CVD.exe -Multi -Slave -CORE=3 MT6752_MultiCore_MD_Attach.csf
...
:LOAD_TINYBL
ECHO Load TinyBL
START CVD64.exe -Multi -Master -CORE=1 MT6752_Load_TinyBL.csf

:: ping 3 s
PING 127.0.0.1 -n 3 -w 1000 > nul

ECHO Start MD ^(Cortex-R4^) debugger...
START C:\JnDTech\CVI\CVD\Bin\_CVD.exe -Multi -Slave -CORE=3 MT6752_MDOnly.csf
...
ECHO start MD ^(Cortex-R4^) debugger...
START C:\JnDTech\CVI\CVD\Bin\_CVD.exe MT6752_MultiCore_MD.cmm
