...
#* Description:
#* ------------
#*   This perl is used to parsing map file
#*       
#*
#* Author:
#* -------
...
my $nVerion = "v1.11";
             # v1.11 , 20141029 , Carl , Fix isRW()
             # v1.10 , 20141022 , Carl , TX/RX section is ZI section since CL 826349
             # v1.09 , 20140829 , Carl , Fix parent symbol
             #
             # ...
             #
             # v1.00 , 20120725 , BMl , Init version
...
{
    my ($strRegionName) = @_;
    my $bRet = ($strRegionName =~ /ZI|\.bss|TX|RX/);
    return $bRet;
}
sub isRW
{
