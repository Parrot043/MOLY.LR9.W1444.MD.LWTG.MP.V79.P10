...
static ccci_ch_handle ccci_ch_info[CCCI_PEER_ID_MAX][CCCI_MAX_CHANNEL] = {
	// CCCI_PEER_ID_AP_MD
	{
        ...
        /*DHL 2nd channel*/
        {SDIOC_TXQ_Q1, CCCI_CH_USER_GPD,    CCCI_TYPE_TX, ccci_dlior_cb,  NULL, CCCI_TYPE_SDIO }, // [94] CCCI_MD_LOG2_RX       
        {SDIOC_RXQ_Q1, CCCI_CH_USER_GPD,    CCCI_TYPE_RX, ccci_ulior_cb,  NULL, CCCI_TYPE_SDIO }, // [95] CCCI_MD_LOG2_TX       
    }
...
static ccci_ch_handle ccci_ch_info[CCCI_PEER_ID_MAX][CCCI_MAX_CHANNEL] = {
	...
	/*************************ARM7*********************************************/ 
        ...
        /*DHL 2nd channel*/
        {CLDMAC_TXQ_Q1, CCCI_CH_USER_GPD,    CCCI_TYPE_TX, ccci_dlior_cb,  NULL, CCCI_TYPE_CLDMA }, // [94] CCCI_MD_LOG2_RX       
        {CLDMAC_RXQ_Q1, CCCI_CH_USER_GPD,    CCCI_TYPE_RX, ccci_ulior_cb,  NULL, CCCI_TYPE_CLDMA }, // [95] CCCI_MD_LOG2_TX   
    }
	/*CCCI_FORCE_RESET_MODEM_CHANNEL  = 20090215*/                                                   
    /*Special condition: AP request MD to assert*/
};
...
static ccci_ch_handle ccci_ch_info[CCCI_PEER_ID_MAX][CCCI_MAX_CHANNEL] = {
	// CCCI_PEER_ID_AP_MD
	{
        ...
        /*DHL 2nd channel*/
        {CCIFC_TXQ_Q1, CCCI_CH_USER_GPD,    CCCI_TYPE_TX, ccci_dlior_cb,  NULL, CCCI_TYPE_CCIF_GPD_AP }, // [94] CCCI_MD_LOG2_RX       
        {CCIFC_RXQ_Q1, CCCI_CH_USER_GPD,    CCCI_TYPE_RX, ccci_ulior_cb,  NULL, CCCI_TYPE_CCIF_GPD_AP }, // [95] CCCI_MD_LOG2_TX   
    },
