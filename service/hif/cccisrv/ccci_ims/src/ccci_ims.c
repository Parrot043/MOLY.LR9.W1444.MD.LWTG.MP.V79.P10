...
#if defined(__MTK_TARGET__) && defined(CCCI_IMS_LATENCY_MEASUREMENT)
#include "us_timer.h"
ccci_ims_latency_t ccci_ims_latency = {0};
#define CCCI_IMS_DUMP_INTERVAL (10)
#define CCCI_IMS_DUMP_THRESHOLD (500)
static kal_uint32 ccci_ims_ul_latency_arr[CCCI_IMS_DUMP_INTERVAL]={0};
static kal_uint32 ccci_ims_dl_latency_arr[CCCI_IMS_DUMP_INTERVAL]={0};
static kal_uint32 ccci_ims_ul_latency_arr_index = 0;
static kal_uint32 ccci_ims_dl_latency_arr_index = 0;
#endif
...
void ccci_ims_ccci_ul_cb(CCCI_CHANNEL_T channel, ccci_io_request_t* io_request)
{
    ...
    if (first_gpd) {
        ...
        // Calculate UL latency
        ccci_ims_latency.ccci_ims_hif_to_mdims_end = ust_get_current_time();
        ccci_ims_latency.ccci_ims_hif_to_mdims_diff = ust_get_duration(ccci_ims_latency.ccci_ims_hif_to_mdims_start, ccci_ims_latency.ccci_ims_hif_to_mdims_end);
        if(ccci_ims_latency.ccci_ims_hif_to_mdims_diff) {
			
			if(ccci_ims_latency.ccci_ims_hif_to_mdims_count+1 < ccci_ims_latency.ccci_ims_hif_to_mdims_count){	// detect overflow
				//reset 
				ccci_ims_latency.ccci_ims_hif_to_mdims_count = 0;
				ccci_ims_ul_latency_arr_index = 0;
				kal_mem_set((void*)ccci_ims_ul_latency_arr,0,sizeof(ccci_ims_ul_latency_arr));				
			}
			ccci_ims_latency.ccci_ims_hif_to_mdims_count ++;					
			ccci_ims_ul_latency_arr[ccci_ims_ul_latency_arr_index] = ccci_ims_latency.ccci_ims_hif_to_mdims_diff;
			ccci_ims_ul_latency_arr_index = ccci_ims_ul_latency_arr_index +1 >= CCCI_IMS_DUMP_INTERVAL ? 0 : ccci_ims_ul_latency_arr_index +1;	
			
			if(ccci_ims_latency.ccci_ims_hif_to_mdims_diff >= CCCI_IMS_DUMP_THRESHOLD){
				kal_uint32 ccci_ims_ul_max = 0;
				kal_uint32 ccci_ims_ul_min = 0xFFFFFFFF;
				kal_uint32 array_count = ccci_ims_latency.ccci_ims_hif_to_mdims_count < CCCI_IMS_DUMP_INTERVAL ? ccci_ims_latency.ccci_ims_hif_to_mdims_count : CCCI_IMS_DUMP_INTERVAL;
				kal_uint32 ccci_ims_ul_avg;
				kal_uint32 ccci_ims_ul_sum = 0;
				kal_uint32 i;
				
				for(i=0;i<array_count;i++){
					ccci_ims_ul_max = ccci_ims_ul_latency_arr[i] > ccci_ims_ul_max ? ccci_ims_ul_latency_arr[i] : ccci_ims_ul_max;
					ccci_ims_ul_min = ccci_ims_ul_latency_arr[i] < ccci_ims_ul_min ? ccci_ims_ul_latency_arr[i] : ccci_ims_ul_min;
					ccci_ims_ul_sum += ccci_ims_ul_latency_arr[i];
				}
				ccci_ims_ul_avg = array_count != 0 ? (ccci_ims_ul_sum/array_count) : 0;
				
				ccci_ims_data_trace(CCCI_IMS_UL_LATENCY,CCCI_IMS_DUMP_INTERVAL,ccci_ims_ul_avg,ccci_ims_ul_max,ccci_ims_ul_min, ccci_ims_latency.ccci_ims_hif_to_mdims_diff, ccci_ims_latency.ccci_ims_hif_task_interval);
...
kal_bool ccci_ims_dl_req (kal_uint32 ims_ch, ccci_io_request_t *p_ior)
{
...
#if defined(__MTK_TARGET__)&& defined(CCCI_IMS_LATENCY_MEASUREMENT)
    ccci_ims_latency.ccci_ims_mdims_to_hif_start = ust_get_current_time();
#endif
    if(NULL == p_ior){
    ...
    ccci_ims_latency.ccci_ims_mdims_to_hif_end = ust_get_current_time();
    ccci_ims_latency.ccci_ims_mdims_to_hif_diff = ust_get_duration(ccci_ims_latency.ccci_ims_mdims_to_hif_start, ccci_ims_latency.ccci_ims_mdims_to_hif_end);
	// Calculate DL latency     
    if(ccci_ims_latency.ccci_ims_mdims_to_hif_diff){

		if(ccci_ims_latency.ccci_ims_mdims_to_hif_count+1 < ccci_ims_latency.ccci_ims_mdims_to_hif_count){	// detect overflow
			//reset 				
			ccci_ims_latency.ccci_ims_mdims_to_hif_count = 0;							
			ccci_ims_dl_latency_arr_index = 0;				
			kal_mem_set((void*)ccci_ims_dl_latency_arr,0,sizeof(ccci_ims_dl_latency_arr));
		}
        ccci_ims_latency.ccci_ims_mdims_to_hif_count ++;														
		ccci_ims_dl_latency_arr[ccci_ims_dl_latency_arr_index] = ccci_ims_latency.ccci_ims_mdims_to_hif_diff;				
		ccci_ims_dl_latency_arr_index = ccci_ims_dl_latency_arr_index +1 >= CCCI_IMS_DUMP_INTERVAL ? 0 : ccci_ims_dl_latency_arr_index +1;
		
		
		if(ccci_ims_latency.ccci_ims_mdims_to_hif_diff >= CCCI_IMS_DUMP_THRESHOLD){		
			
			kal_uint32 ccci_ims_dl_max = 0;				
			kal_uint32 ccci_ims_dl_min = 0xFFFFFFFF;				
			kal_uint32 array_count = ccci_ims_latency.ccci_ims_mdims_to_hif_count < CCCI_IMS_DUMP_INTERVAL ? ccci_ims_latency.ccci_ims_mdims_to_hif_count : CCCI_IMS_DUMP_INTERVAL;				
			kal_uint32 ccci_ims_dl_avg;
			kal_uint32 ccci_ims_dl_sum = 0;
			kal_uint32 i;								

			for(i=0;i<array_count;i++){					
				ccci_ims_dl_max = ccci_ims_dl_latency_arr[i] > ccci_ims_dl_max ? ccci_ims_dl_latency_arr[i] : ccci_ims_dl_max;					
				ccci_ims_dl_min = ccci_ims_dl_latency_arr[i] < ccci_ims_dl_min ? ccci_ims_dl_latency_arr[i] : ccci_ims_dl_min;	
				ccci_ims_dl_sum += ccci_ims_dl_latency_arr[i];
			}
			ccci_ims_dl_avg = array_count != 0 ? (ccci_ims_dl_sum/array_count) : 0;
			ccci_ims_data_trace(CCCI_IMS_DL_LATENCY, CCCI_IMS_DUMP_INTERVAL, ccci_ims_dl_avg,ccci_ims_dl_max,ccci_ims_dl_min, ccci_ims_latency.ccci_ims_mdims_to_hif_diff);
...
kal_bool ccci_ims_svc_init (void)
{
	...
	//ccci_ims_latency.ccci_ims_hif_to_mdims_total = 0;
    ccci_ims_latency.ccci_ims_hif_to_mdims_count = 0;
	ccci_ims_ul_latency_arr_index = 0;
	kal_mem_set((void*)ccci_ims_ul_latency_arr,0,sizeof(ccci_ims_ul_latency_arr));		
	
    //ccci_ims_latency.ccci_ims_mdims_to_hif_total = 0;
	ccci_ims_latency.ccci_ims_mdims_to_hif_count = 0;
	ccci_ims_dl_latency_arr_index = 0;				
	kal_mem_set((void*)ccci_ims_dl_latency_arr,0,sizeof(ccci_ims_dl_latency_arr));
