...
typedef struct BM_LOG_T
{
    ...
    kal_uint32 emi_md_mcu_wcnt;
    kal_uint32 emi_md_hw_wcnt;
    #if defined(__SWLA_ADDON_EBM_OCCUPIED_BW__)
    kal_uint32 emi_bcnt;
    kal_uint32 emi_bact;
    kal_uint32 emi_bsct;
    #endif /* __SWLA_ADDON_EBM_OCCUPIED_BW__ */
    #endif /* __SWLA_ADDON_EBM__ */
...
#if defined(MT6280) || defined(MT6572) || defined(MT6582) || defined(MT6290) || defined(MT6595) || defined(MT6752) || defined(MT6735)
