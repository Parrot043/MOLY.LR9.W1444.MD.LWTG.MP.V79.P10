 ...
 ****************************************************************************/
   ...
   /* KAL_ERROR_ADM_CHECK_FAILED */
   TRC_MSG(SST_PHASE1_1790_01, "In adm_mb_check(), first block is corrupt because its state is not ADM_INUSE or previous block is not NULL.")
   TRC_MSG(SST_PHASE1_1790_02, "In adm_mb_check(), check failed because prev or next pointers of the memory block to be freed is invalid; corruption may occurs.")
   TRC_MSG(SST_PHASE1_1790_03, "In adm_mb_check(), last block is corrupt because its state is not ADM_INUSE or next block is not NULL.")
