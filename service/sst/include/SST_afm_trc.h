 ...
 ****************************************************************************/
   ...
   TRC_MSG(SST_PHASE1_1850_00, "In AFM function,the given AFM control block pointer is NULL.")
   ...
   /* KAL_ERROR_AFM_BADID */
   TRC_MSG(SST_PHASE1_1860_ID, "In AFM function, the AFM ID of the given AFM control block is not valid (0x20100104).")
   ...
   /* KAL_ERROR_AFM_NILPTR */
   TRC_MSG(SST_PHASE3_1850_00, "You past a NULL AFM ID to AFM function, Please check your input.")
   ...
   /* KAL_ERROR_AFM_BADID */
   TRC_MSG(SST_PHASE3_1860_ID_P1, "No valid signature is found in AFM funciton; the first word pointed by AFM ID should be 0x20100104, ")
   TRC_MSG(SST_PHASE3_1860_ID_P2, "but now it is 0x%X, Please check the pointer is valid or corrupted.")
