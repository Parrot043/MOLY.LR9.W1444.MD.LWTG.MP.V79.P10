 ...
 ****************************************************************************/
	...
	TRC_MSG(SST_PHASE1_307_0, "In kal_enque_msg(), queue ID should not be NULL.")	
	TRC_MSG(SST_PHASE1_307_1, "In kal_enque_msg(), destination buffer pointer should not be NULL.")	
