...
#define PLT_ID_LEN              11    //MTXXXX_SXX
...
static dspfm_fileinfo_t g_dsp_fileinfo = {KAL_FALSE, 0, 0, 0, 0, 0, {0}, {0}};
...
static kal_bool dspfm_dsp_ver_check(void *dsp_gfh_ptr)
{
    ...
    kal_uint8 maui_plt_id[PLT_ID_LEN] = {0};
    kal_uint8 maui_proj_id[PROJ_ID_LEN] = {0};
    kal_uint8 dsp_plt_id[PLT_ID_LEN] = {0};
    kal_uint8 dsp_proj_id[PROJ_ID_LEN] = {0};
    ...
    if(0==memcmp("MT6753", bb_chip, CHIP_ID_LEN))
    {
        strcpy(bb_chip, "MT6735");
    }
    ...
    snprintf(maui_plt_id, sizeof(maui_plt_id), "%.6s_%.3s", chip_id, bb_sw_ver);
